...
module remui
  ...
  join_type #(.SIZE(2))
      join_inputs(.ins_valid({rhs_valid, lhs_valid}),
                  .outs_ready(oehb_ready),
                  .ins_ready({rhs_ready, lhs_ready}),
                  .outs_valid(join_valid));

  remui_vitis_hls_wrapper #(.DATA_TYPE(DATA_TYPE))
      ip(.clk(clk),
         .reset(rst),
         .din0(lhs),
         .din1(rhs),
  ...
  oehb_dataless oehb_inst(.clk(clk),
                          .rst(rst),
...
module remui_vitis_hls_wrapper
  ...
  dynamatic_units_urem_32ns_32ns_32_36_1_div #(.in0_WIDTH(DATA_TYPE),
                                               .in1_WIDTH(DATA_TYPE),
                                               .out_WIDTH(DATA_TYPE))
      u_urem(.clk(clk),
             .reset(reset),
...
module dynamatic_units_urem_32ns_32ns_32_36_1_div
  ...
  dynamatic_units_urem_32ns_32ns_32_36_1_div_u #(.in0_WIDTH(in0_WIDTH),
                                                 .in1_WIDTH(in1_WIDTH),
                                                 .out_WIDTH(out_WIDTH))
      u_urem_div(.clk(clk),
                 .reset(reset),
...
module dynamatic_units_urem_32ns_32ns_32_36_1_div_u
  ...
  generate
    for (i = 0; i < in0_WIDTH; i = i + 1) begin : run_proc
      ...
      assign comb_tmp[i] = {remd_tmp[i][in0_WIDTH - 2 : 0],
                            dividend_tmp[i][in0_WIDTH - 1]};
