...
handshake.func @muxWithExtraSignal(
  ...
  %data = mux %sel [%data1, %data2, %data3, %data4] : <i2>, [<i32, [spec: i1, tag: i2]>, <i32, [spec: i1, tag: i2]>, <i32, [spec: i1, tag: i2]>, <i32, [spec: i1, tag: i2]>] to <i32, [spec: i1, tag: i2]>
  end %ctrl : !handshake.control<>
}
...
handshake.func @cmergeWithExtraSignal(
  ...
  %data, %idx = control_merge [%data1, %data2, %data3, %data4] : [<[spec: i1]>, <[spec: i1]>, <[spec: i1]>, <[spec: i1]>] to <[spec: i1]>, <i2>
  end %ctrl : !handshake.control<>
}
