...
// CHECK:           %[[VAL_10:.*]] = merge %[[VAL_1]], %[[VAL_6]]#2 {bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.bb = 1 : ui32} : none
// CHECK:           %[[VAL_4]]:4 = lazy_fork [4] %[[VAL_10]] {bufProps = #handshake<bufProps{"0": [1,inf], [0,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.bb = 1 : ui32} : none
...
// CHECK:           %[[VAL_14:.*]], %[[VAL_15:.*]] = cond_br %[[VAL_11]], %[[VAL_4]]#3 {bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.bb = 1 : ui32} : none
// CHECK:           sink %[[VAL_13]] : i32
// CHECK:           %[[VAL_6]]:3 = lazy_fork [3] %[[VAL_14]] {handshake.bb = 2 : ui32} : none
...
// CHECK:           %[[VAL_8]]:2 = lazy_fork [2] %[[VAL_15]] {handshake.bb = 3 : ui32} : none
...
// CHECK:           end {bufProps = #handshake<bufProps{"1": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.bb = 3 : ui32} %[[VAL_20]], %[[VAL_3]] : i32, none
// CHECK:         }
...
// ^^bb1 (from ^^bb0, ^bb2, to ^bb2, ^bb3):
  %ctrl1 = merge %start#0, %lazyForkCtrl2#2 {handshake.bb = 1 : ui32} : none
  %lazyForkCtrl1:4 = lazy_fork [4] %ctrl1 {handshake.bb = 1 : ui32} : none
  ...
  %ctrl1To2, %ctrl1To3 = cond_br %cond, %lazyForkCtrl1#3 {handshake.bb = 1 : ui32} : none
  sink %ldDataToSucc1 : i32
// ^^bb2 (from ^^bb1, to ^^bb1):
  %lazyForkCtrl2:3 = lazy_fork [3] %ctrl1To2 {handshake.bb = 2 : ui32} : none
...
// ^^bb3:
  %lazyForkCtrl3:2 = lazy_fork [2] %ctrl1To3 {handshake.bb = 3 : ui32} : none
