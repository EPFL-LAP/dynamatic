...
// CHECK:           %[[VAL_7]], %[[VAL_12:.*]] = lsq_load{{\[}}%[[VAL_11]]] %[[VAL_2]]#1 : <i32>, <i32>
...
// CHECK:           %[[VAL_5]], %[[VAL_13:.*]] = lsq_load{{\[}}%[[VAL_12]]] %[[VAL_2]]#0 {handshake.bb = 1 : ui32} : <i32>, <i32>
...
// CHECK:           %[[VAL_7]], %[[VAL_18:.*]] = lsq_load{{\[}}%[[VAL_17]]] %[[VAL_2]]#1 {handshake.bb = 2 : ui32} : <i32>, <i32>
...
// CHECK:           %[[VAL_9]], %[[VAL_20:.*]] = lsq_load{{\[}}%[[VAL_19]]] %[[VAL_2]]#2 {handshake.bb = 3 : ui32} : <i32>, <i32>
...
// CHECK:           %[[VAL_5]], %[[VAL_17:.*]] = lsq_load{{\[}}%[[VAL_14]]#1] %[[VAL_4]]#0 {handshake.bb = 0 : ui32} : <i32>, <i32>
// CHECK:           %[[VAL_10]], %[[VAL_18:.*]] = lsq_load{{\[}}%[[VAL_16]]#1] %[[VAL_9]]#0 {handshake.bb = 0 : ui32} : <i32>, <i32>
// CHECK:           %[[VAL_19:.*]] = br %[[VAL_2]]#0 : <>
// CHECK:           %[[VAL_6]]:5 = fork [5] %[[VAL_19]] : <>
// CHECK:           %[[VAL_7]], %[[VAL_8]] = lsq_store{{\[}}%[[VAL_14]]#0] %[[VAL_17]] {handshake.bb = 1 : ui32} : <i32>, <i32>
// CHECK:           %[[VAL_11]], %[[VAL_12]] = lsq_store{{\[}}%[[VAL_16]]#0] %[[VAL_18]] {handshake.bb = 1 : ui32} : <i32>, <i32>
...
// ^^bb0
  ...
  %ldAddrToMem1, %ldDataToSucc1 = lsq_load [%addr1] %ldData1 {handshake.bb = 0 : ui32} : <i32>, <i32>
  %ldAddrToMem2, %ldDataToSucc2 = lsq_load [%addr2] %ldData2 {handshake.bb = 0 : ui32} : <i32>, <i32>
  %ctrlTo1 = br %start : <>
// ^^bb1
  %stAddrToMem1, %stDataToMem1 = lsq_store [%addr1] %ldDataToSucc1 {handshake.bb = 1 : ui32} : <i32>, <i32>
  %stAddrToMem2, %stDataToMem2 = lsq_store [%addr2] %ldDataToSucc2 {handshake.bb = 1 : ui32} : <i32>, <i32>
