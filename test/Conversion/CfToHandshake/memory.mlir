...
// CHECK:           %[[VAL_4:.*]]:2, %[[VAL_5:.*]] = mem_controller{{\[}}%[[VAL_1]] : memref<4xi32>] %[[VAL_2]] (%[[VAL_6:.*]], %[[VAL_7:.*]], %[[VAL_8:.*]], %[[VAL_9:.*]]) %[[VAL_3]] {connectedBlocks = [0 : i32]} :    (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.control<>, !handshake.channel<i32>)
...
// CHECK:           %[[VAL_7]], %[[VAL_8]], %[[VAL_11:.*]] = store{{\[}}%[[VAL_0]]] %[[VAL_10]] %[[VAL_4]]#0 {handshake.bb = 0 : ui32} : <i32>, <i32>, <>, <i32>, <i32>, <>
// CHECK:           %[[VAL_9]], %[[VAL_12:.*]] = load{{\[}}%[[VAL_0]]] %[[VAL_4]]#1 {handshake.bb = 0 : ui32} : <i32>, <i32>, <i32>, <i32>
...
// CHECK:           %[[VAL_5:.*]]:2, %[[VAL_6:.*]] = mem_controller{{\[}}%[[VAL_2]] : memref<4xi32>] %[[VAL_3]] (%[[VAL_7:.*]], %[[VAL_8:.*]], %[[VAL_9:.*]], %[[VAL_10:.*]], %[[VAL_11:.*]], %[[VAL_12:.*]]) %[[VAL_13:.*]] {connectedBlocks = [1 : i32, 2 : i32]} :    (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.control<>, !handshake.control<>)
// CHECK:           %[[VAL_14:.*]], %[[VAL_15:.*]] = cond_br %[[VAL_0]], %[[VAL_1]] {handshake.bb = 0 : ui32} : <i1>, <i32>
// CHECK:           %[[VAL_16:.*]], %[[VAL_17:.*]] = cond_br %[[VAL_0]], %[[VAL_4]] {handshake.bb = 0 : ui32} : <i1>, <>
// CHECK:           %[[VAL_7]] = constant %[[VAL_18:.*]] {handshake.bb = 1 : ui32, value = 1 : i32} : <>, <i32>
// CHECK:           %[[VAL_19:.*]] = merge %[[VAL_14]] {handshake.bb = 1 : ui32} : <i32>
// CHECK:           %[[VAL_18]], %[[VAL_20:.*]] = control_merge {{\[}}%[[VAL_16]]]  {handshake.bb = 1 : ui32} : [<>] to <>, <i1>
// CHECK:           %[[VAL_21:.*]] = constant %[[VAL_18]] {handshake.bb = 1 : ui32, value = 1 : i32} : <>, <i32>
// CHECK:           %[[VAL_8]], %[[VAL_9]], %[[VAL_22:.*]] = store{{\[}}%[[VAL_19]]] %[[VAL_21]] %[[VAL_5]]#0 {handshake.bb = 1 : ui32} : <i32>, <i32>, <>, <i32>, <i32>, <>
// CHECK:           %[[VAL_23:.*]] = br %[[VAL_18]] {handshake.bb = 1 : ui32} : <>
// CHECK:           %[[VAL_10]] = constant %[[VAL_24:.*]] {handshake.bb = 2 : ui32, value = 1 : i32} : <>, <i32>
// CHECK:           %[[VAL_25:.*]] = merge %[[VAL_15]] {handshake.bb = 2 : ui32} : <i32>
// CHECK:           %[[VAL_24]], %[[VAL_26:.*]] = control_merge {{\[}}%[[VAL_17]]]  {handshake.bb = 2 : ui32} : [<>] to <>, <i1>
// CHECK:           %[[VAL_27:.*]] = constant %[[VAL_24]] {handshake.bb = 2 : ui32, value = 2 : i32} : <>, <i32>
// CHECK:           %[[VAL_11]], %[[VAL_12]], %[[VAL_28:.*]] = store{{\[}}%[[VAL_25]]] %[[VAL_27]] %[[VAL_5]]#1 {handshake.bb = 2 : ui32} : <i32>, <i32>, <>, <i32>, <i32>, <>
// CHECK:           %[[VAL_29:.*]] = br %[[VAL_24]] {handshake.bb = 2 : ui32} : <>
// CHECK:           %[[VAL_13]], %[[VAL_30:.*]] = control_merge {{\[}}%[[VAL_23]], %[[VAL_29]]]  {handshake.bb = 3 : ui32} : [<>, <>] to <>, <i1>
// CHECK:           end {handshake.bb = 3 : ui32} %[[VAL_6]], %[[VAL_4]] : <>, <>
// CHECK:         }
...
// CHECK:           %[[VAL_7]], %[[VAL_9:.*]] = load{{\[}}%[[VAL_1]]] %[[VAL_5]] {handshake.bb = 0 : ui32} : <i32>, <i32>, <i32>, <i32>
...
// CHECK:           %[[VAL_15:.*]], %[[VAL_16:.*]] = control_merge {{\[}}%[[VAL_12]]]  {handshake.bb = 1 : ui32} : [<>] to <>, <i1>
...
// CHECK:           %[[VAL_8]], %[[VAL_21:.*]] = control_merge {{\[}}%[[VAL_13]], %[[VAL_20]]]  {handshake.bb = 2 : ui32} : [<>, <>] to <>, <i1>
...
// CHECK:           %[[VAL_6:.*]]:2, %[[VAL_7:.*]] = mem_controller{{\[}}%[[VAL_2]] : memref<4xi32>] %[[VAL_4]] (%[[VAL_8:.*]], %[[VAL_9:.*]], %[[VAL_10:.*]], %[[VAL_11:.*]]) %[[VAL_12:.*]] {connectedBlocks = [1 : i32, 2 : i32]} :    (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.channel<i32>, !handshake.control<>)
// CHECK:           %[[VAL_13:.*]]:2, %[[VAL_14:.*]] = mem_controller{{\[}}%[[VAL_1]] : memref<4xi32>] %[[VAL_3]] (%[[VAL_15:.*]], %[[VAL_16:.*]], %[[VAL_17:.*]], %[[VAL_18:.*]]) %[[VAL_12]] {connectedBlocks = [1 : i32, 2 : i32]} :    (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.control<>, !handshake.channel<i32>)
...
// CHECK:           %[[VAL_27]], %[[VAL_29:.*]] = control_merge {{\[}}%[[VAL_23]]]  {handshake.bb = 1 : ui32} : [<>] to <>, <i1>
// CHECK:           %[[VAL_8]], %[[VAL_30:.*]] = load{{\[}}%[[VAL_28]]] %[[VAL_6]]#0 {handshake.bb = 1 : ui32} : <i32>, <i32>, <i32>, <i32>
// CHECK:           %[[VAL_16]], %[[VAL_17]], %[[VAL_31:.*]] = store{{\[}}%[[VAL_28]]] %[[VAL_30]] %[[VAL_13]]#0 {handshake.bb = 1 : ui32} : <i32>, <i32>, <>, <i32>, <i32>, <>
// CHECK:           %[[VAL_9]] = constant %[[VAL_32:.*]] {handshake.bb = 2 : ui32, value = 1 : i32} : <>, <i32>
// CHECK:           %[[VAL_12]] = merge %[[VAL_27]], %[[VAL_32]] {handshake.bb = 2 : ui32} : <>
// CHECK:           %[[VAL_33:.*]] = merge %[[VAL_26]] {handshake.bb = 2 : ui32} : <i32>
// CHECK:           %[[VAL_32]], %[[VAL_34:.*]] = control_merge {{\[}}%[[VAL_24]]]  {handshake.bb = 2 : ui32} : [<>] to <>, <i1>
// CHECK:           %[[VAL_18]], %[[VAL_35:.*]] = load{{\[}}%[[VAL_33]]] %[[VAL_13]]#1 {handshake.bb = 2 : ui32} : <i32>, <i32>, <i32>, <i32>
// CHECK:           %[[VAL_10]], %[[VAL_11]], %[[VAL_36:.*]] = store{{\[}}%[[VAL_33]]] %[[VAL_35]] %[[VAL_6]]#1 {handshake.bb = 2 : ui32} : <i32>, <i32>, <>, <i32>, <i32>, <>
