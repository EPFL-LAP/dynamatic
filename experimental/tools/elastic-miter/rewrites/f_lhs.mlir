module {
  handshake.func @f_lhs(%d: !handshake.channel<i1>, %m: !handshake.channel<i1>, %n: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>) attributes {argNames = ["D_in", "M_in", "N_in"], resNames = ["A_out"]} {
    %mux_0 = mux %m_init [%d, %loop_out_0] {handshake.bb = 1 : ui32, handshake.name = "mux_0"}  : <i1>, [<i1>, <i1>] to <i1>
    %mux0_forked:2 = fork [2] %mux_0 {handshake.bb = 1 : ui32, handshake.name = "fork_mux0"} : <i1>
    %t_0, %f_0 = cond_br %m_not, %mux0_forked#1 {handshake.bb = 1 : ui32, handshake.name = "supp_br_0"} : <i1>, <i1>
    ...
    %mux_1 = mux %n_init [%mux0_forked#0, %loop_out_1] {handshake.bb = 1 : ui32, handshake.name = "mux_1"}  : <i1>, [<i1>, <i1>] to <i1>
    %mux1_forked:2 = fork [2] %mux_1 {handshake.bb = 1 : ui32, handshake.name = "fork_mux1"} : <i1>
    %t_1, %f_1 = cond_br %n_not, %mux1_forked#1 {handshake.bb = 1 : ui32, handshake.name = "supp_br_1"} : <i1>, <i1>
    ...
    end {handshake.bb = 1 : ui32, handshake.name = "end0"} %mux1_forked#0 : <i1>
  }
}
