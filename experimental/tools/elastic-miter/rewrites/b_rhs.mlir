module {
  handshake.func @b_rhs(%x: !handshake.channel<i1>, %y: !handshake.channel<i1>, %d: !handshake.control<>, %c: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.control<>) attributes {argNames = ["Xd", "Yd","Dd", "Cd"], resNames = ["A_out", "B_out"]} {
