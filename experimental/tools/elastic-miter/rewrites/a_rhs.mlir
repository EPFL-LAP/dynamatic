module {
  handshake.func @a_rhs(%d: !handshake.channel<i32>, %c: !handshake.channel<i1>, ...) -> (!handshake.channel<i32>, !handshake.channel<i32>) attributes {argNames = ["D_out", "C_out"], resNames = ["T_out", "F_out"]} {
