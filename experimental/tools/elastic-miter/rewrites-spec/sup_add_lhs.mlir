module {
  handshake.func @sup_add_lhs(%a: !handshake.channel<i1>, %b: !handshake.channel<i1>, %cond: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>) attributes {argNames = ["A_in", "B_in", "Cond"], resNames = ["C_out"]} {
    ...
    %c = addi %a_passer, %b_passer {handshake.bb = 1 : ui32, handshake.name = "addi"} : <i1>
