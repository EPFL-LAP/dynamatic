module {
  handshake.func @sup_mul_lhs(%a: !handshake.channel<i1>, %b: !handshake.channel<i1>, %cond: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>) attributes {argNames = ["A_in", "B_in", "Cond"], resNames = ["C_out"]} {
    ...
    %c = muli %a_passer, %b_passer {handshake.bb = 1 : ui32, handshake.name = "muli"} : <i1>
