...
run sup_mux --seq_length="1=2" --seq_length_enhanced="{in:1}={out:0}" --loop_strict=0,1 --disable_ndwire --disable_decoupling --allow_nonacceptance
# run swap/ri_fork --allow_nonacceptance --seq_length_enhanced="{out:0}-{out:1}<=1&{out:1}-{out:0}<=1" --disable_ndwire --disable_decoupling
