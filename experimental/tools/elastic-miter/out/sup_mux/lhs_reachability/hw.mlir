module {
  hw.module @sup_mux_lhs(in %In1 : !handshake.channel<i1>, in %In2 : !handshake.channel<i1>, in %Ctrl : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out Out1 : !handshake.channel<i1>) {
    ...
    %ndw_out_Out1.outs = hw.instance "ndw_out_Out1" @handshake_ndwire_0(ins: %data_mux.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %fork_data_mux.outs_0, %fork_data_mux.outs_1 = hw.instance "fork_data_mux" @handshake_fork_0(ins: %ndw_in_Ctrl.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>)
    ...
    %passer.result = hw.instance "passer" @handshake_passer_0(data: %ndw_in_In1.outs: !handshake.channel<i1>, ctrl: %fork_data_mux.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %data_mux.outs = hw.instance "data_mux" @handshake_mux_0(index: %init_buffer_ctrl.outs: !handshake.channel<i1>, ins_0: %ndw_in_In2.outs: !handshake.channel<i1>, ins_1: %passer.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
  ...
  hw.module @sup_mux_lhs_wrapper(in %In1 : !handshake.channel<i1>, in %In2 : !handshake.channel<i1>, in %Ctrl : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out Out1 : !handshake.channel<i1>) {
    %sup_mux_lhs_wrapped.Out1 = hw.instance "sup_mux_lhs_wrapped" @sup_mux_lhs(In1: %In1: !handshake.channel<i1>, In2: %In2: !handshake.channel<i1>, Ctrl: %Ctrl: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (Out1: !handshake.channel<i1>)
    hw.output %sup_mux_lhs_wrapped.Out1 : !handshake.channel<i1>
  }
}
