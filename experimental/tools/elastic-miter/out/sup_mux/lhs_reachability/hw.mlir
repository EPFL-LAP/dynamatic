module {
  hw.module @sup_mux_lhs(in %loopLiveIn : !handshake.channel<i1>, in %iterLiveOut : !handshake.channel<i1>, in %oldContinue : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out iterLiveIn : !handshake.channel<i1>) {
    ...
    %vm_fork_2.outs_0, %vm_fork_2.outs_1 = hw.instance "vm_fork_2" @handshake_fork_0(ins: %ndw_in_oldContinue.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>)
    %passer.result = hw.instance "passer" @handshake_passer_0(data: %ndw_in_iterLiveOut.outs: !handshake.channel<i1>, ctrl: %vm_fork_2.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %oldInit.outs = hw.instance "oldInit" @handshake_init_0(ins: %vm_fork_2.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
