module {
  hw.module @sup_mux_rhs(in %loopLiveIn : !handshake.channel<i1>, in %oldContinue : !handshake.channel<i1>, in %iterLiveOut : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out iterLiveIn : !handshake.channel<i1>) {
    ...
    %buffer1.outs = hw.instance "buffer1" @handshake_buffer_0(ins: %vm_fork_1.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %buffer2.outs = hw.instance "buffer2" @handshake_buffer_0(ins: %vm_fork_1.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
