module {
  hw.module @sup_mux_rhs(in %loopLiveIn : !handshake.channel<i1>, in %iterLiveOut : !handshake.channel<i1>, in %oldContinue : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out iterLiveIn : !handshake.channel<i1>) {
    ...
    %ri1.outs = hw.instance "ri1" @handshake_spec_v2_repeating_init_0(ins: %fork_continue.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %newInit.outs = hw.instance "newInit" @handshake_init_0(ins: %buffer1.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %ri2.outs = hw.instance "ri2" @handshake_spec_v2_repeating_init_0(ins: %fork_continue.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %passer.result = hw.instance "passer" @handshake_passer_0(data: %data_mux.outs: !handshake.channel<i1>, ctrl: %buffer2.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
