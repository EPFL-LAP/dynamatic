module {
  hw.module @sup_mux_rhs(in %loopLiveIn : !handshake.channel<i1>, in %iterLiveOut : !handshake.channel<i1>, in %oldContinue : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out iterLiveIn : !handshake.channel<i1>) {
    ...
    %ri1.outs = hw.instance "ri1" @handshake_spec_v2_repeating_init_0(ins: %vm_fork_2.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %ri2.outs = hw.instance "ri2" @handshake_spec_v2_repeating_init_0(ins: %vm_fork_2.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
