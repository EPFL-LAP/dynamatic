module {
  handshake.func @elastic_miter_sup_fork_lhs_sup_fork_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["A_in", "Cond"], resNames = ["EQ_B_out", "EQ_C_out"]} {
    ...
    %16 = ndsource {handshake.bb = 3 : ui32, handshake.name = "out_nds_B_out"} : <>
    %17:2 = lazy_fork [2] %16 {handshake.bb = 3 : ui32, handshake.name = "out_lf_B_out"} : <>
    %18 = buffer %17#0 {handshake.bb = 3 : ui32, handshake.name = "out_buf_lhs_nds_B_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %19 = buffer %17#1 {handshake.bb = 3 : ui32, handshake.name = "out_buf_rhs_nds_B_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %20 = blocker %11#0[%18] {handshake.bb = 3 : ui32, handshake.name = "out_lhs_bl_B_out"} : <i1>, <>
    %21 = blocker %14[%19] {handshake.bb = 3 : ui32, handshake.name = "out_rhs_bl_B_out"} : <i1>, <>
    ...
    %27 = ndsource {handshake.bb = 3 : ui32, handshake.name = "out_nds_C_out"} : <>
    %28:2 = lazy_fork [2] %27 {handshake.bb = 3 : ui32, handshake.name = "out_lf_C_out"} : <>
    %29 = buffer %28#0 {handshake.bb = 3 : ui32, handshake.name = "out_buf_lhs_nds_C_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %30 = buffer %28#1 {handshake.bb = 3 : ui32, handshake.name = "out_buf_rhs_nds_C_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %31 = blocker %11#1[%29] {handshake.bb = 3 : ui32, handshake.name = "out_lhs_bl_C_out"} : <i1>, <>
    %32 = blocker %15[%30] {handshake.bb = 3 : ui32, handshake.name = "out_rhs_bl_C_out"} : <i1>, <>
