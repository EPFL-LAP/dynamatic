module {
  handshake.func @elastic_miter_sup_fork_lhs_sup_fork_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["A_in", "Cond"], resNames = ["EQ_B_out", "EQ_C_out"]} {
    ...
    %1 = buffer %0#0, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 0 : ui32, handshake.name = "lhs_in_buf_A_in"} : <i1>
    %2 = buffer %0#1, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 0 : ui32, handshake.name = "rhs_in_buf_A_in"} : <i1>
    ...
    %6 = buffer %5#0, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 0 : ui32, handshake.name = "lhs_in_buf_Cond"} : <i1>
    %7 = buffer %5#1, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 0 : ui32, handshake.name = "rhs_in_buf_Cond"} : <i1>
    ...
    %12 = buffer %11#0, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "out_buf_lhs_nds_B_out"} : <>
    %13 = buffer %11#1, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "out_buf_rhs_nds_B_out"} : <>
    ...
    %18 = buffer %16, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "lhs_out_buf_B_out"} : <i1>
    %19 = buffer %17, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "rhs_out_buf_B_out"} : <i1>
    ...
    %23 = buffer %22#0, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "out_buf_lhs_nds_C_out"} : <>
    %24 = buffer %22#1, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "out_buf_rhs_nds_C_out"} : <>
    ...
    %29 = buffer %27, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "lhs_out_buf_C_out"} : <i1>
    %30 = buffer %28, bufferType = FIFO_BREAK_DV, numSlots = 31 {handshake.bb = 5 : ui32, handshake.name = "rhs_out_buf_C_out"} : <i1>
