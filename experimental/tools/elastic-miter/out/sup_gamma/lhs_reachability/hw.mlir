module {
  hw.module @sup_gamma_lhs(in %a1 : !handshake.channel<i1>, in %a2 : !handshake.channel<i1>, in %c1 : !handshake.channel<i1>, in %c2 : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out b : !handshake.channel<i1>) {
    ...
    %passer1.result = hw.instance "passer1" @handshake_passer_0(data: %c1_fork.outs_0: !handshake.channel<i1>, ctrl: %c2_fork.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    ...
    %passer2.result = hw.instance "passer2" @handshake_passer_0(data: %c1_fork.outs_1: !handshake.channel<i1>, ctrl: %not.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %passer3.result = hw.instance "passer3" @handshake_passer_0(data: %c2_fork.outs_2: !handshake.channel<i1>, ctrl: %c1_fork.outs_2: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %passer_a1.result = hw.instance "passer_a1" @handshake_passer_0(data: %a1: !handshake.channel<i1>, ctrl: %passer1.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %passer_a2.result = hw.instance "passer_a2" @handshake_passer_0(data: %a2: !handshake.channel<i1>, ctrl: %passer2.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
