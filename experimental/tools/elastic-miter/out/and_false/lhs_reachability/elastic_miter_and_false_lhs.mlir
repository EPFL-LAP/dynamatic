module {
  handshake.func @and_false_lhs(%arg0: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["ins"], resNames = ["out"]} {
    %0 = ndwire %arg0 {handshake.bb = 0 : ui32, handshake.name = "ndw_in_ins"} : <i1>
    %1 = ndwire %4 {handshake.bb = 2 : ui32, handshake.name = "ndw_out_out"} : <i1>
    ...
    %4 = andi %0, %3 {handshake.bb = 1 : ui32, handshake.name = "and"} : <i1>
