module {
  hw.module @interpolatorForkSwap_lhs(in %short : !handshake.channel<i1>, in %long : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out out1 : !handshake.channel<i1>, out out2 : !handshake.channel<i1>) {
  ...
  hw.module @interpolatorForkSwap_lhs_wrapper(in %short : !handshake.channel<i1>, in %long : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out out1 : !handshake.channel<i1>, out out2 : !handshake.channel<i1>) {
    %interpolatorForkSwap_lhs_wrapped.out1, %interpolatorForkSwap_lhs_wrapped.out2 = hw.instance "interpolatorForkSwap_lhs_wrapped" @interpolatorForkSwap_lhs(short: %short: !handshake.channel<i1>, long: %long: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (out1: !handshake.channel<i1>, out2: !handshake.channel<i1>)
