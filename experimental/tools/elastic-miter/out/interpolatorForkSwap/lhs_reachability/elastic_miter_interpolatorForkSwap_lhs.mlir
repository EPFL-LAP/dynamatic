module {
  handshake.func @interpolatorForkSwap_lhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["long", "short"], resNames = ["out1", "out2"]} {
    ...
    %4 = spec_v2_interpolator %1, %0 {handshake.bb = 1 : ui32, handshake.name = "interpolator"} : <i1>
