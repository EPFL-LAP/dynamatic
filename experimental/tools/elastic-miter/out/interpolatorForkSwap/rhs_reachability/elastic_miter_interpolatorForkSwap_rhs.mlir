module {
  handshake.func @interpolatorForkSwap_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["short", "long"], resNames = ["out1", "out2"]} {
    ...
    %4:2 = fork [2] %0 {handshake.bb = 1 : ui32, handshake.name = "fork_short"} : <i1>
    %5:2 = fork [2] %1 {handshake.bb = 1 : ui32, handshake.name = "fork_long"} : <i1>
