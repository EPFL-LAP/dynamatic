module {
  handshake.func @unify_sup_lhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, %arg2: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["A_in", "Cond1", "Cond2"], resNames = ["B_out"]} {
    ...
    %4:2 = fork [2] %2 {handshake.bb = 1 : ui32, handshake.name = "fork_cond2"} : <i1>
    %5 = passer %1[%4#0] {handshake.bb = 1 : ui32, handshake.name = "passer1"} : <i1>, <i1>
    %6 = passer %0[%4#1] {handshake.bb = 1 : ui32, handshake.name = "passer2"} : <i1>, <i1>
    %7 = passer %6[%5] {handshake.bb = 1 : ui32, handshake.name = "passer3"} : <i1>, <i1>
