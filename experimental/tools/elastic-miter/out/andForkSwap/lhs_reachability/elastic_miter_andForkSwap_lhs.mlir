module {
  handshake.func @andForkSwap_lhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["in1", "in2"], resNames = ["out1", "out2"]} {
    ...
    %4 = andi %0, %1 {handshake.bb = 1 : ui32, handshake.name = "and"} : <i1>
