module {
  hw.module @andForkSwap_lhs(in %in1 : !handshake.channel<i1>, in %in2 : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out out1 : !handshake.channel<i1>, out out2 : !handshake.channel<i1>) {
  ...
  hw.module @andForkSwap_lhs_wrapper(in %in1 : !handshake.channel<i1>, in %in2 : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out out1 : !handshake.channel<i1>, out out2 : !handshake.channel<i1>) {
    %andForkSwap_lhs_wrapped.out1, %andForkSwap_lhs_wrapped.out2 = hw.instance "andForkSwap_lhs_wrapped" @andForkSwap_lhs(in1: %in1: !handshake.channel<i1>, in2: %in2: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (out1: !handshake.channel<i1>, out2: !handshake.channel<i1>)
