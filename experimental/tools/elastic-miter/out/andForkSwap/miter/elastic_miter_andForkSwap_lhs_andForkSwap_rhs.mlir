module {
  handshake.func @elastic_miter_andForkSwap_lhs_andForkSwap_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["in2", "in1"], resNames = ["EQ_out1", "EQ_out2"]} {
    %0:2 = lazy_fork [2] %arg0 {handshake.bb = 0 : ui32, handshake.name = "in_fork_in2"} : <i1>
    %1 = buffer %0#0, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 0 : ui32, handshake.name = "lhs_in_buf_in2"} : <i1>
    %2 = buffer %0#1, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 0 : ui32, handshake.name = "rhs_in_buf_in2"} : <i1>
    %3:2 = lazy_fork [2] %arg1 {handshake.bb = 0 : ui32, handshake.name = "in_fork_in1"} : <i1>
    %4 = buffer %3#0, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 0 : ui32, handshake.name = "lhs_in_buf_in1"} : <i1>
    %5 = buffer %3#1, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 0 : ui32, handshake.name = "rhs_in_buf_in1"} : <i1>
    ...
    %20 = andi %4, %1 {handshake.bb = 1 : ui32, handshake.name = "lhs_and"} : <i1>
    %21:2 = fork [2] %20 {handshake.bb = 1 : ui32, handshake.name = "lhs_fork"} : <i1>
    %22:2 = fork [2] %5 {handshake.bb = 2 : ui32, handshake.name = "rhs_fork1"} : <i1>
    %23:2 = fork [2] %2 {handshake.bb = 2 : ui32, handshake.name = "rhs_fork2"} : <i1>
