module {
  hw.module @extension2_rhs(in %arg : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    ...
    %arg_buff.outs = hw.instance "arg_buff" @handshake_buffer_0(ins: %arg_fork.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %ri_mux.outs = hw.instance "ri_mux" @handshake_mux_0(index: %initop.outs: !handshake.channel<i1>, ins_0: %constant1.outs: !handshake.channel<i1>, ins_1: %arg_buff.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %mux.outs = hw.instance "mux" @handshake_mux_0(index: %ri_fork.outs_1: !handshake.channel<i1>, ins_0: %constant2.outs: !handshake.channel<i1>, ins_1: %arg_fork.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
  ...
  hw.module @extension2_rhs_wrapper(in %arg : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    %extension2_rhs_wrapped.res = hw.instance "extension2_rhs_wrapped" @extension2_rhs(arg: %arg: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (res: !handshake.channel<i1>)
    hw.output %extension2_rhs_wrapped.res : !handshake.channel<i1>
  }
}
