module {
  hw.module @sup_eager_gamma_mux_rhs(in %A_in : !handshake.channel<i1>, in %B_in : !handshake.channel<i1>, in %ctrl : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    ...
    %ctrl_fork.outs_0, %ctrl_fork.outs_1 = hw.instance "ctrl_fork" @handshake_fork_1(ins: %ctrl: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>)
    %ctrl_mux.outs = hw.instance "ctrl_mux" @handshake_mux_0(index: %cst_dup_fork.outs_1: !handshake.channel<i1>, ins_0: %ctrl_fork.outs_1: !handshake.channel<i1>, ins_1: %ctrl_fork.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %mux.outs = hw.instance "mux" @handshake_mux_0(index: %cst_dup_fork.outs_2: !handshake.channel<i1>, ins_0: %B_in: !handshake.channel<i1>, ins_1: %A_in: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %res_passer.result = hw.instance "res_passer" @handshake_passer_0(data: %mux.outs: !handshake.channel<i1>, ctrl: %ctrl_mux.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    hw.output %res_passer.result : !handshake.channel<i1>
  }
  ...
  hw.module @sup_eager_gamma_mux_rhs_wrapper(in %A_in : !handshake.channel<i1>, in %B_in : !handshake.channel<i1>, in %ctrl : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    %sup_eager_gamma_mux_rhs_wrapped.res = hw.instance "sup_eager_gamma_mux_rhs_wrapped" @sup_eager_gamma_mux_rhs(A_in: %A_in: !handshake.channel<i1>, B_in: %B_in: !handshake.channel<i1>, ctrl: %ctrl: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (res: !handshake.channel<i1>)
    hw.output %sup_eager_gamma_mux_rhs_wrapped.res : !handshake.channel<i1>
  }
}
