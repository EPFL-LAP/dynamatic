module {
  handshake.func @elastic_miter_sup_gamma_mux2_lhs_sup_gamma_mux2_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, %arg2: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["cond", "dataT", "dataF"], resNames = ["EQ_res"]} {
    ...
    %14 = blocker %35[%12] {handshake.bb = 3 : ui32, handshake.name = "rhs_out_bl_res"} : <i1>, <>
    ...
    %21:3 = fork [3] %2 {handshake.bb = 2 : ui32, handshake.name = "rhs_cond_fork"} : <i1>
    %22 = init %28 {handshake.bb = 2 : ui32, handshake.name = "rhs_initop", initToken = 0 : ui1} : <i1>
    ...
    %25 = buffer %21#0, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "rhs_ri_buff"} : <i1>
    %26 = mux %22 [%24, %25] {handshake.bb = 2 : ui32, handshake.name = "rhs_ri"} : <i1>, [<i1>, <i1>] to <i1>
    %27:3 = fork [3] %26 {handshake.bb = 2 : ui32, handshake.name = "rhs_ri_fork"} : <i1>
    %28 = buffer %27#0, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "rhs_buff"} : <i1>
    %29 = source {handshake.bb = 2 : ui32, handshake.name = "rhs_source2"} : <>
    %30 = constant %29 {handshake.bb = 2 : ui32, handshake.name = "rhs_constant2", value = true} : <>, <i1>
    %31 = mux %27#1 [%30, %21#1] {handshake.bb = 2 : ui32, handshake.name = "rhs_cond_mux"} : <i1>, [<i1>, <i1>] to <i1>
    %32 = not %21#2 {handshake.bb = 2 : ui32, handshake.name = "rhs_not"} : <i1>
    %33 = passer %8[%32] {handshake.bb = 2 : ui32, handshake.name = "rhs_dataF_passer"} : <i1>, <i1>
    %34 = mux %27#2 [%33, %5] {handshake.bb = 2 : ui32, handshake.name = "rhs_data_mux"} : <i1>, [<i1>, <i1>] to <i1>
    %35 = passer %34[%31] {handshake.bb = 2 : ui32, handshake.name = "rhs_passer"} : <i1>, <i1>
