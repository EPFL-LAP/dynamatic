module {
  hw.module @test_rhs(in %A_in : !handshake.control<>, in %clk : i1, in %rst : i1) {
  ...
  hw.module @test_rhs_wrapper(in %A_in : !handshake.control<>, in %clk : i1, in %rst : i1) {
    hw.instance "test_rhs_wrapped" @test_rhs(A_in: %A_in: !handshake.control<>, clk: %clk: i1, rst: %rst: i1) -> ()
    hw.output
  }
}
