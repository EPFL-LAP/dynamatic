module {
  hw.module @extension4_rhs(in %arg : !handshake.channel<i1>, in %ctrl : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    ...
    %and_buff.outs = hw.instance "and_buff" @handshake_buffer_0(ins: %andi.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %buff.outs = hw.instance "buff" @handshake_buffer_1(ins: %ri_mux.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %ri_fork.outs_0, %ri_fork.outs_1, %ri_fork.outs_2 = hw.instance "ri_fork" @handshake_fork_1(ins: %initop.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>, outs_2: !handshake.channel<i1>)
    ...
    %ri_mux.outs = hw.instance "ri_mux" @handshake_mux_0(index: %ri_fork.outs_0: !handshake.channel<i1>, ins_0: %constant1.outs: !handshake.channel<i1>, ins_1: %ori.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %mux.outs = hw.instance "mux" @handshake_mux_0(index: %ri_fork.outs_1: !handshake.channel<i1>, ins_0: %constant2.outs: !handshake.channel<i1>, ins_1: %and_buff.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %p_buff.outs = hw.instance "p_buff" @handshake_buffer_0(ins: %passer.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    hw.output %p_buff.outs : !handshake.channel<i1>
  }
  ...
  hw.module @extension4_rhs_wrapper(in %arg : !handshake.channel<i1>, in %ctrl : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    %extension4_rhs_wrapped.res = hw.instance "extension4_rhs_wrapped" @extension4_rhs(arg: %arg: !handshake.channel<i1>, ctrl: %ctrl: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (res: !handshake.channel<i1>)
    hw.output %extension4_rhs_wrapped.res : !handshake.channel<i1>
  }
}
