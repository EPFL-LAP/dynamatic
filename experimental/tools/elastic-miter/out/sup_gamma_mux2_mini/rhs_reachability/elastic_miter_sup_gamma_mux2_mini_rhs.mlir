module {
  handshake.func @sup_gamma_mux2_mini_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, %arg2: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["cond", "dataT", "dataF"], resNames = ["res"]} {
    ...
    %11 = mux %6#2 [%arg2, %arg1] {handshake.name = "data_mux"} : <i1>, [<i1>, <i1>] to <i1>
    %12 = passer %11[%10] {handshake.name = "passer"} : <i1>, <i1>
    end {handshake.name = "end0"} %12 : <i1>
  }
}
