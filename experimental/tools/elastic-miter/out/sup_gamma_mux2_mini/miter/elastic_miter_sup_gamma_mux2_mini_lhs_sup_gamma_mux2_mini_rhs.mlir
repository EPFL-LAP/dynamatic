module {
  handshake.func @elastic_miter_sup_gamma_mux2_mini_lhs_sup_gamma_mux2_mini_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, %arg2: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["cond", "dataT", "dataF"], resNames = ["EQ_res"]} {
    ...
    %13 = blocker %18[%11] {handshake.bb = 3 : ui32, handshake.name = "lhs_out_bl_res"} : <i1>, <>
    ...
    %16:2 = fork [2] %1 {handshake.bb = 1 : ui32, handshake.name = "lhs_cond_fork"} : <i1>
    %17 = passer %4[%16#0] {handshake.bb = 1 : ui32, handshake.name = "lhs_dataT_passer"} : <i1>, <i1>
    %18 = mux %16#1 [%7, %17] {handshake.bb = 1 : ui32, handshake.name = "lhs_res_mux"} : <i1>, [<i1>, <i1>] to <i1>
    %19:2 = fork [2] %2 {handshake.bb = 2 : ui32, handshake.name = "rhs_cond_fork"} : <i1>
    %20 = init %26 {handshake.bb = 2 : ui32, handshake.name = "rhs_initop", initToken = 0 : ui1} : <i1>
    %21 = source {handshake.bb = 2 : ui32, handshake.name = "rhs_source1"} : <>
    %22 = constant %21 {handshake.bb = 2 : ui32, handshake.name = "rhs_constant1", value = true} : <>, <i1>
    %23 = buffer %19#0, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "rhs_ri_buff"} : <i1>
    %24 = mux %20 [%22, %23] {handshake.bb = 2 : ui32, handshake.name = "rhs_ri"} : <i1>, [<i1>, <i1>] to <i1>
    %25:3 = fork [3] %24 {handshake.bb = 2 : ui32, handshake.name = "rhs_ri_fork"} : <i1>
    %26 = buffer %25#0, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "rhs_buff"} : <i1>
    ...
    %29 = mux %25#1 [%28, %19#1] {handshake.bb = 2 : ui32, handshake.name = "rhs_cond_mux"} : <i1>, [<i1>, <i1>] to <i1>
    %30 = mux %25#2 [%8, %5] {handshake.bb = 2 : ui32, handshake.name = "rhs_data_mux"} : <i1>, [<i1>, <i1>] to <i1>
    %31 = passer %30[%29] {handshake.bb = 2 : ui32, handshake.name = "rhs_passer"} : <i1>, <i1>
