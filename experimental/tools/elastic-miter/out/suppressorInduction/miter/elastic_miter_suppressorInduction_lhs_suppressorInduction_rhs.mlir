module {
  handshake.func @elastic_miter_suppressorInduction_lhs_suppressorInduction_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["short", "A_in"], resNames = ["EQ_B_out"]} {
    ...
    %3 = buffer %2#0, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 1 : ui32, handshake.name = "lhs_in_buf_short"} : <i1>
    %4 = buffer %2#1, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 1 : ui32, handshake.name = "rhs_in_buf_short"} : <i1>
    %5:2 = lazy_fork [2] %1 {handshake.bb = 1 : ui32, handshake.name = "in_fork_oldLong"} : <i1>
    %6 = buffer %5#0, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 1 : ui32, handshake.name = "lhs_in_buf_oldLong"} : <i1>
    %7 = buffer %5#1, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 1 : ui32, handshake.name = "rhs_in_buf_oldLong"} : <i1>
    %8:2 = lazy_fork [2] %arg1 {handshake.bb = 1 : ui32, handshake.name = "in_fork_A_in"} : <i1>
    %9 = buffer %8#0, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 1 : ui32, handshake.name = "lhs_in_buf_A_in"} : <i1>
    %10 = buffer %8#1, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 1 : ui32, handshake.name = "rhs_in_buf_A_in"} : <i1>
    ...
    %13 = buffer %12#0, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 4 : ui32, handshake.name = "out_buf_lhs_nds_B_out"} : <>
    %14 = buffer %12#1, bufferType = FIFO_BREAK_DV, numSlots = 1 {handshake.bb = 4 : ui32, handshake.name = "out_buf_rhs_nds_B_out"} : <>
    ...
    %25 = buffer %24, bufferType = FIFO_BREAK_NONE, numSlots = 1 {handshake.bb = 3 : ui32, handshake.name = "rhs_buffer"} : <i1>
