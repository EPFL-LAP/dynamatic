module {
  hw.module @elastic_miter_fork_lhs_fork_rhs(in %A_in : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out EQ_B_out : !handshake.channel<i1>, out EQ_C_out : !handshake.channel<i1>) {
    ...
    %out_lhs_bl_B_out.outs = hw.instance "out_lhs_bl_B_out" @handshake_blocker_0(ins: %lhs_fork.outs_0: !handshake.channel<i1>, ctrl: %out_buf_lhs_nds_B_out.outs: !handshake.control<>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %out_rhs_bl_B_out.outs = hw.instance "out_rhs_bl_B_out" @handshake_blocker_0(ins: %rhs_fork.outs_0: !handshake.channel<i1>, ctrl: %out_buf_rhs_nds_B_out.outs: !handshake.control<>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %out_lhs_bl_C_out.outs = hw.instance "out_lhs_bl_C_out" @handshake_blocker_0(ins: %lhs_fork.outs_1: !handshake.channel<i1>, ctrl: %out_buf_lhs_nds_C_out.outs: !handshake.control<>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %out_rhs_bl_C_out.outs = hw.instance "out_rhs_bl_C_out" @handshake_blocker_0(ins: %rhs_fork.outs_1: !handshake.channel<i1>, ctrl: %out_buf_rhs_nds_C_out.outs: !handshake.control<>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %lhs_out_ndw_C_out.outs = hw.instance "lhs_out_ndw_C_out" @handshake_ndwire_0(ins: %out_lhs_bl_C_out.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %rhs_out_ndw_C_out.outs = hw.instance "rhs_out_ndw_C_out" @handshake_ndwire_0(ins: %out_rhs_bl_C_out.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
  ...
  hw.module.extern @handshake_buffer_1(in %ins : !handshake.control<>, in %clk : i1, in %rst : i1, out outs : !handshake.control<>) attributes {hw.name = "handshake.buffer", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", DATA_TYPE = !handshake.control<>, NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}}
