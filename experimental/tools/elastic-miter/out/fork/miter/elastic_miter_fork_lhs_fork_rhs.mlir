module {
  handshake.func @elastic_miter_fork_lhs_fork_rhs(%arg0: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["A_in"], resNames = ["EQ_B_out", "EQ_C_out"]} {
    ...
    %7 = ndsource {handshake.bb = 3 : ui32, handshake.name = "out_nds_B_out"} : <>
    %8:2 = lazy_fork [2] %7 {handshake.bb = 3 : ui32, handshake.name = "out_lf_B_out"} : <>
    %9 = buffer %8#0 {handshake.bb = 3 : ui32, handshake.name = "out_buf_lhs_nds_B_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %10 = buffer %8#1 {handshake.bb = 3 : ui32, handshake.name = "out_buf_rhs_nds_B_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %11 = blocker %5#0[%9] {handshake.bb = 3 : ui32, handshake.name = "out_lhs_bl_B_out"} : <i1>, <>
    %12 = blocker %6#0[%10] {handshake.bb = 3 : ui32, handshake.name = "out_rhs_bl_B_out"} : <i1>, <>
    ...
    %18 = ndsource {handshake.bb = 3 : ui32, handshake.name = "out_nds_C_out"} : <>
    %19:2 = lazy_fork [2] %18 {handshake.bb = 3 : ui32, handshake.name = "out_lf_C_out"} : <>
    %20 = buffer %19#0 {handshake.bb = 3 : ui32, handshake.name = "out_buf_lhs_nds_C_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %21 = buffer %19#1 {handshake.bb = 3 : ui32, handshake.name = "out_buf_rhs_nds_C_out", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    %22 = blocker %5#1[%20] {handshake.bb = 3 : ui32, handshake.name = "out_lhs_bl_C_out"} : <i1>, <>
    %23 = blocker %6#1[%21] {handshake.bb = 3 : ui32, handshake.name = "out_rhs_bl_C_out"} : <i1>, <>
