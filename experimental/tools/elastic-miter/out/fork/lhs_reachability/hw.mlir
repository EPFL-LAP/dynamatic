module {
  hw.module @fork_lhs(in %A_in : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out B_out : !handshake.channel<i1>, out C_out : !handshake.channel<i1>) {
  ...
  hw.module @fork_lhs_wrapper(in %A_in : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out B_out : !handshake.channel<i1>, out C_out : !handshake.channel<i1>) {
    %fork_lhs_wrapped.B_out, %fork_lhs_wrapped.C_out = hw.instance "fork_lhs_wrapped" @fork_lhs(A_in: %A_in: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (B_out: !handshake.channel<i1>, C_out: !handshake.channel<i1>)
    hw.output %fork_lhs_wrapped.B_out, %fork_lhs_wrapped.C_out : !handshake.channel<i1>, !handshake.channel<i1>
  }
}
