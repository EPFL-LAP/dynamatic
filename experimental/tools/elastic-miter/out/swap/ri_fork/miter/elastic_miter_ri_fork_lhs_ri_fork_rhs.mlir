module {
  handshake.func @elastic_miter_ri_fork_lhs_ri_fork_rhs(%arg0: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>, !handshake.channel<i1>) attributes {argNames = ["A_in"], resNames = ["EQ_B_out", "EQ_C_out"]} {
    ...
    %17 = buffer %1, bufferType = FIFO_BREAK_NONE, numSlots = 1 {handshake.bb = 1 : ui32, handshake.name = "lhs_buffer"} : <i1>
    %18 = spec_v2_repeating_init %17 {handshake.bb = 1 : ui32, handshake.name = "lhs_ri", initToken = 1 : ui1} : <i1>
    ...
    %23 = buffer %20#1, bufferType = FIFO_BREAK_NONE, numSlots = 1 {handshake.bb = 2 : ui32, handshake.name = "rhs_buffer2"} : <i1>
    %24 = spec_v2_repeating_init %23 {handshake.bb = 2 : ui32, handshake.name = "rhs_ri2", initToken = 1 : ui1} : <i1>
