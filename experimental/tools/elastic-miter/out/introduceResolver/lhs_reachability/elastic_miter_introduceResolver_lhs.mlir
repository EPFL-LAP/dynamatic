module {
  handshake.func @introduceResolver_lhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["loopContinue", "confirmSpec_backedge"], resNames = ["confirmSpec"]} {
    ...
    %7 = ndwire %17 {handshake.bb = 3 : ui32, handshake.name = "ndw_out_confirmSpec"} : <i1>
    ...
    %12 = spec_v2_repeating_init %11 {handshake.bb = 1 : ui32, handshake.name = "ctx_ri", initToken = 1 : ui1} : <i1>
    %13 = buffer %12, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "ctx_buffer"} : <i1>
    %14 = passer %8#1[%9#1] {handshake.bb = 2 : ui32, handshake.name = "passer"} : <i1>, <i1>
    %15 = spec_v2_repeating_init %14 {handshake.bb = 2 : ui32, handshake.name = "ri", initToken = 1 : ui1} : <i1>
    %16 = buffer %15, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer"} : <i1>
    %17 = spec_v2_interpolator %16, %13 {handshake.bb = 2 : ui32, handshake.name = "interpolate"} : <i1>
