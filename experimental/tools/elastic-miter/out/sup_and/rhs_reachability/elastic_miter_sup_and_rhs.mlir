module {
  handshake.func @sup_and_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, %arg2: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["A_in", "B_in", "Cond"], resNames = ["C_out"]} {
    ...
    %3 = ndwire %5 {handshake.bb = 3 : ui32, handshake.name = "ndw_out_C_out"} : <i1>
    %4 = andi %0, %1 {handshake.bb = 1 : ui32, handshake.name = "andi"} : <i1>
    %5 = passer %4[%2] {handshake.bb = 1 : ui32, handshake.name = "passer1"} : <i1>, <i1>
