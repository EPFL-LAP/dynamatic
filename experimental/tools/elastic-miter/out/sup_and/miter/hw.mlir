module {
  hw.module @elastic_miter_sup_and_lhs_sup_and_rhs(in %A_in : !handshake.channel<i1>, in %B_in : !handshake.channel<i1>, in %Cond : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out EQ_C_out : !handshake.channel<i1>) {
    ...
    %in_fork_B_in.outs_0, %in_fork_B_in.outs_1 = hw.instance "in_fork_B_in" @handshake_lazy_fork_0(ins: %B_in: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>)
    %lhs_in_buf_B_in.outs = hw.instance "lhs_in_buf_B_in" @handshake_buffer_0(ins: %in_fork_B_in.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %rhs_in_buf_B_in.outs = hw.instance "rhs_in_buf_B_in" @handshake_buffer_0(ins: %in_fork_B_in.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %lhs_in_ndw_B_in.outs = hw.instance "lhs_in_ndw_B_in" @handshake_ndwire_0(ins: %lhs_in_buf_B_in.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %rhs_in_ndw_B_in.outs = hw.instance "rhs_in_ndw_B_in" @handshake_ndwire_0(ins: %rhs_in_buf_B_in.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    %lhs_fork_cond.outs_0, %lhs_fork_cond.outs_1 = hw.instance "lhs_fork_cond" @handshake_fork_0(ins: %lhs_in_ndw_Cond.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>)
    %lhs_passer1.result = hw.instance "lhs_passer1" @handshake_passer_0(data: %lhs_in_ndw_A_in.outs: !handshake.channel<i1>, ctrl: %lhs_fork_cond.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %lhs_passer2.result = hw.instance "lhs_passer2" @handshake_passer_0(data: %lhs_in_ndw_B_in.outs: !handshake.channel<i1>, ctrl: %lhs_fork_cond.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %lhs_andi.result = hw.instance "lhs_andi" @handshake_andi_0(lhs: %lhs_passer1.result: !handshake.channel<i1>, rhs: %lhs_passer2.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %rhs_andi.result = hw.instance "rhs_andi" @handshake_andi_0(lhs: %rhs_in_ndw_A_in.outs: !handshake.channel<i1>, rhs: %rhs_in_ndw_B_in.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %rhs_passer1.result = hw.instance "rhs_passer1" @handshake_passer_0(data: %rhs_andi.result: !handshake.channel<i1>, ctrl: %rhs_in_ndw_Cond.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    %lhs_out_ndw_C_out.outs = hw.instance "lhs_out_ndw_C_out" @handshake_ndwire_0(ins: %lhs_andi.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %rhs_out_ndw_C_out.outs = hw.instance "rhs_out_ndw_C_out" @handshake_ndwire_0(ins: %rhs_passer1.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    ...
    hw.output %out_eq_C_out.result : !handshake.channel<i1>
  }
  ...
  hw.module @elastic_miter_sup_and_lhs_sup_and_rhs_wrapper(in %A_in : !handshake.channel<i1>, in %B_in : !handshake.channel<i1>, in %Cond : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out EQ_C_out : !handshake.channel<i1>) {
    %elastic_miter_sup_and_lhs_sup_and_rhs_wrapped.EQ_C_out = hw.instance "elastic_miter_sup_and_lhs_sup_and_rhs_wrapped" @elastic_miter_sup_and_lhs_sup_and_rhs(A_in: %A_in: !handshake.channel<i1>, B_in: %B_in: !handshake.channel<i1>, Cond: %Cond: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (EQ_C_out: !handshake.channel<i1>)
    hw.output %elastic_miter_sup_and_lhs_sup_and_rhs_wrapped.EQ_C_out : !handshake.channel<i1>
  }
}
