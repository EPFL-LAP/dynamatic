module {
  hw.module @sup_gamma_mux2_mini_rhs(in %cond : !handshake.channel<i1>, in %dataT : !handshake.channel<i1>, in %dataF : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    %cond_fork.outs_0, %cond_fork.outs_1 = hw.instance "cond_fork" @handshake_fork_0(ins: %cond: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>)
    ...
    %ri_buff.outs = hw.instance "ri_buff" @handshake_buffer_0(ins: %cond_fork.outs_0: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %ri.outs = hw.instance "ri" @handshake_mux_0(index: %initop.outs: !handshake.channel<i1>, ins_0: %constant1.outs: !handshake.channel<i1>, ins_1: %ri_buff.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %ri_fork.outs_0, %ri_fork.outs_1, %ri_fork.outs_2 = hw.instance "ri_fork" @handshake_fork_1(ins: %ri.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>, outs_2: !handshake.channel<i1>)
    ...
    %cond_mux.outs = hw.instance "cond_mux" @handshake_mux_0(index: %ri_fork.outs_1: !handshake.channel<i1>, ins_0: %constant2.outs: !handshake.channel<i1>, ins_1: %cond_fork.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %data_mux.outs = hw.instance "data_mux" @handshake_mux_0(index: %ri_fork.outs_2: !handshake.channel<i1>, ins_0: %dataF: !handshake.channel<i1>, ins_1: %dataT: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
  ...
  hw.module @sup_gamma_mux2_mini_rhs_wrapper(in %cond : !handshake.channel<i1>, in %dataT : !handshake.channel<i1>, in %dataF : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    %sup_gamma_mux2_mini_rhs_wrapped.res = hw.instance "sup_gamma_mux2_mini_rhs_wrapped" @sup_gamma_mux2_mini_rhs(cond: %cond: !handshake.channel<i1>, dataT: %dataT: !handshake.channel<i1>, dataF: %dataF: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (res: !handshake.channel<i1>)
    hw.output %sup_gamma_mux2_mini_rhs_wrapped.res : !handshake.channel<i1>
  }
}
