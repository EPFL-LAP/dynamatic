module {
  hw.module @sup_mul_lhs(in %A_in : !handshake.channel<i1>, in %B_in : !handshake.channel<i1>, in %Cond : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out C_out : !handshake.channel<i1>) {
    ...
    %muli.result = hw.instance "muli" @handshake_muli_0(lhs: %passer1.result: !handshake.channel<i1>, rhs: %passer2.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    hw.output %muli.result : !handshake.channel<i1>
  }
  ...
  hw.module @sup_mul_lhs_wrapper(in %A_in : !handshake.channel<i1>, in %B_in : !handshake.channel<i1>, in %Cond : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out C_out : !handshake.channel<i1>) {
    %sup_mul_lhs_wrapped.C_out = hw.instance "sup_mul_lhs_wrapped" @sup_mul_lhs(A_in: %A_in: !handshake.channel<i1>, B_in: %B_in: !handshake.channel<i1>, Cond: %Cond: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (C_out: !handshake.channel<i1>)
    hw.output %sup_mul_lhs_wrapped.C_out : !handshake.channel<i1>
  }
}
