module {
  handshake.func @elastic_miter_sup_mul_lhs_sup_mul_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, %arg2: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["A_in", "B_in", "Cond"], resNames = ["EQ_C_out"]} {
    ...
    %9 = source {handshake.bb = 3 : ui32, handshake.name = "out_src_C_out"} : <>
    ...
    %19 = muli %17, %18 {handshake.bb = 1 : ui32, handshake.name = "lhs_muli"} : <i1>
    %20 = muli %2, %5 {handshake.bb = 2 : ui32, handshake.name = "rhs_muli"} : <i1>
