module {
  handshake.func @elastic_miter_sup_sup_lhs_sup_sup_rhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, %arg2: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["A_in", "Cond1", "Cond2"], resNames = ["EQ_B_out"]} {
    ...
    %9 = source {handshake.bb = 3 : ui32, handshake.name = "out_src_B_out"} : <>
    ...
    %13 = blocker %19[%11] {handshake.bb = 3 : ui32, handshake.name = "lhs_out_bl_B_out"} : <i1>, <>
    %14 = blocker %23[%12] {handshake.bb = 3 : ui32, handshake.name = "rhs_out_bl_B_out"} : <i1>, <>
    %15 = cmpi eq, %13, %14 {handshake.bb = 3 : ui32, handshake.name = "out_eq_B_out"} : <i1>
    %16:2 = fork [2] %7 {handshake.bb = 1 : ui32, handshake.name = "lhs_fork_cond2"} : <i1>
    %17 = passer %4[%16#0] {handshake.bb = 1 : ui32, handshake.name = "lhs_passer1"} : <i1>, <i1>
    %18 = passer %1[%16#1] {handshake.bb = 1 : ui32, handshake.name = "lhs_passer2"} : <i1>, <i1>
    %19 = passer %18[%17] {handshake.bb = 1 : ui32, handshake.name = "lhs_passer3"} : <i1>, <i1>
    %20:2 = fork [2] %5 {handshake.bb = 2 : ui32, handshake.name = "rhs_fork_cond2"} : <i1>
    %21 = passer %8[%20#0] {handshake.bb = 2 : ui32, handshake.name = "rhs_passer1"} : <i1>, <i1>
    %22 = passer %2[%20#1] {handshake.bb = 2 : ui32, handshake.name = "rhs_passer2"} : <i1>, <i1>
    %23 = passer %22[%21] {handshake.bb = 2 : ui32, handshake.name = "rhs_passer3"} : <i1>, <i1>
