module {
  handshake.func @introduceIdentInterpolator_lhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["val", "A_in"], resNames = ["B_out"]} {
    ...
    %3 = passer %1[%0] {handshake.bb = 1 : ui32, handshake.name = "passer"} : <i1>, <i1>
