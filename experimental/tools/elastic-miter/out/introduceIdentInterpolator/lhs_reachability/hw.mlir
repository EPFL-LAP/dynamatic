module {
  hw.module @introduceIdentInterpolator_lhs(in %A_in : !handshake.channel<i1>, in %val : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out B_out : !handshake.channel<i1>) {
  ...
  hw.module @introduceIdentInterpolator_lhs_wrapper(in %A_in : !handshake.channel<i1>, in %val : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out B_out : !handshake.channel<i1>) {
    %introduceIdentInterpolator_lhs_wrapped.B_out = hw.instance "introduceIdentInterpolator_lhs_wrapped" @introduceIdentInterpolator_lhs(A_in: %A_in: !handshake.channel<i1>, val: %val: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (B_out: !handshake.channel<i1>)
