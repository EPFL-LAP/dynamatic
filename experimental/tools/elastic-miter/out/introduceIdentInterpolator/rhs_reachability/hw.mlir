module {
  hw.module @introduceIdentInterpolator_rhs(in %A_in : !handshake.channel<i1>, in %val : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out B_out : !handshake.channel<i1>) {
    ...
    %vm_fork_1.outs_0, %vm_fork_1.outs_1 = hw.instance "vm_fork_1" @handshake_fork_0(ins: %ndw_in_val.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs_0: !handshake.channel<i1>, outs_1: !handshake.channel<i1>)
    %interpolate.result = hw.instance "interpolate" @handshake_spec_v2_interpolator_0(short: %vm_fork_1.outs_0: !handshake.channel<i1>, long: %vm_fork_1.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
  ...
  hw.module @introduceIdentInterpolator_rhs_wrapper(in %A_in : !handshake.channel<i1>, in %val : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out B_out : !handshake.channel<i1>) {
    %introduceIdentInterpolator_rhs_wrapped.B_out = hw.instance "introduceIdentInterpolator_rhs_wrapped" @introduceIdentInterpolator_rhs(A_in: %A_in: !handshake.channel<i1>, val: %val: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (B_out: !handshake.channel<i1>)
