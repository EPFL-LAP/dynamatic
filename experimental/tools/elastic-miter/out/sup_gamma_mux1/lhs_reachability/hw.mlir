module {
  hw.module @sup_gamma_mux1_lhs(in %cond : !handshake.channel<i1>, in %dataT : !handshake.channel<i1>, in %dataF : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
  ...
  hw.module @sup_gamma_mux1_lhs_wrapper(in %cond : !handshake.channel<i1>, in %dataT : !handshake.channel<i1>, in %dataF : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out res : !handshake.channel<i1>) {
    %sup_gamma_mux1_lhs_wrapped.res = hw.instance "sup_gamma_mux1_lhs_wrapped" @sup_gamma_mux1_lhs(cond: %cond: !handshake.channel<i1>, dataT: %dataT: !handshake.channel<i1>, dataF: %dataF: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (res: !handshake.channel<i1>)
    hw.output %sup_gamma_mux1_lhs_wrapped.res : !handshake.channel<i1>
  }
}
