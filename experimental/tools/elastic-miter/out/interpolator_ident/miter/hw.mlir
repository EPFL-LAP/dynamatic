module {
  hw.module @elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs(in %A_in : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out EQ_B_out : !handshake.channel<i1>) {
    ...
    %out_lhs_bl_B_out.outs = hw.instance "out_lhs_bl_B_out" @handshake_blocker_0(ins: %lhs_in_ndw_A_in.outs: !handshake.channel<i1>, ctrl: %out_buf_lhs_nds_B_out.outs: !handshake.control<>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %out_rhs_bl_B_out.outs = hw.instance "out_rhs_bl_B_out" @handshake_blocker_0(ins: %rhs_interpolate.result: !handshake.channel<i1>, ctrl: %out_buf_rhs_nds_B_out.outs: !handshake.control<>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
