module {
  hw.module @elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs(in %A_in : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out EQ_B_out : !handshake.channel<i1>) {
    ...
    %rhs_interpolate.result = hw.instance "rhs_interpolate" @handshake_spec_v2_interpolator_0(short: %rhs_fork.outs_0: !handshake.channel<i1>, long: %rhs_fork.outs_1: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (result: !handshake.channel<i1>)
    ...
    %out_lhs_tc_B_out.outs = hw.instance "out_lhs_tc_B_out" @handshake_transfer_control_0(ins: %lhs_in_ndw_A_in.outs: !handshake.channel<i1>, ctrl: %out_buf_lhs_nds_B_out.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %out_rhs_tc_B_out.outs = hw.instance "out_rhs_tc_B_out" @handshake_transfer_control_0(ins: %rhs_interpolate.result: !handshake.channel<i1>, ctrl: %out_buf_rhs_nds_B_out.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
  ...
  hw.module @elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs_wrapper(in %A_in : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out EQ_B_out : !handshake.channel<i1>) {
    %elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs_wrapped.EQ_B_out = hw.instance "elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs_wrapped" @elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs(A_in: %A_in: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (EQ_B_out: !handshake.channel<i1>)
    hw.output %elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs_wrapped.EQ_B_out : !handshake.channel<i1>
  }
}
