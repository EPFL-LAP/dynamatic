module {
  hw.module @elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs(in %A_in : !handshake.channel<i1>, in %clk : i1, in %rst : i1, out EQ_B_out : !handshake.channel<i1>) {
    ...
    %lhs_out_ndw_B_out.outs = hw.instance "lhs_out_ndw_B_out" @handshake_ndwire_0(ins: %lhs_in_ndw_A_in.outs: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
    %rhs_out_ndw_B_out.outs = hw.instance "rhs_out_ndw_B_out" @handshake_ndwire_0(ins: %rhs_interpolate.result: !handshake.channel<i1>, clk: %clk: i1, rst: %rst: i1) -> (outs: !handshake.channel<i1>)
