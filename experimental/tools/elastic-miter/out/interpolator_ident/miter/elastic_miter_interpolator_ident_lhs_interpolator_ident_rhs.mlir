module {
  handshake.func @elastic_miter_interpolator_ident_lhs_interpolator_ident_rhs(%arg0: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["A_in"], resNames = ["EQ_B_out"]} {
    ...
    %11 = transfer_control %3[%9] {handshake.bb = 3 : ui32, handshake.name = "out_lhs_tc_B_out"} : <i1>, <i1>
    %12 = transfer_control %6[%10] {handshake.bb = 3 : ui32, handshake.name = "out_rhs_tc_B_out"} : <i1>, <i1>
