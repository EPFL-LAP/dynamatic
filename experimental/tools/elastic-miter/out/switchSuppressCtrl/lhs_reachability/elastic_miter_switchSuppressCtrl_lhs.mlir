module {
  handshake.func @switchSuppressCtrl_lhs(%arg0: !handshake.channel<i1>, %arg1: !handshake.channel<i1>, ...) -> !handshake.channel<i1> attributes {argNames = ["val", "A_in"], resNames = ["B_out"]} {
    ...
    sink %4 {handshake.bb = 2 : ui32, handshake.name = "vm_sink_2"} : <i1>
    %5 = passer %1[%3#2] {handshake.bb = 2 : ui32, handshake.name = "passer"} : <i1>, <i1>
