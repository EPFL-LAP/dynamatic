...
def generate_shli(name, params):
  ...
  if data_type.has_extra_signals():
    return _generate_shli_signal_manager(name, data_type)
  else:
    return _generate_shli(name, data_type.bitwidth)
...
def _generate_shli_signal_manager(name, data_type):
  return generate_binary_no_latency_signal_manager(name, data_type, _generate_shli)
