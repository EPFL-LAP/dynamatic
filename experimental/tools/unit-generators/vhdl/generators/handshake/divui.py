...
def generate_divui(name, params):
    ...
    if extra_signals:
        return _generate_divui_signal_manager(name, bitwidth, extra_signals)
    else:
        return _generate_divui(name, bitwidth)


def _generate_divui(name, bitwidth):
...
def _generate_divui_signal_manager(name, bitwidth, extra_signals):
    return generate_default_signal_manager(
        ...
        extra_signals,
        lambda name: _generate_divui(name, bitwidth))
