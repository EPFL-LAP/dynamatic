from generators.support.signal_manager import generate_entity, generate_concat_signal_decls, ConcatenationInfo
from generators.support.signal_manager.concat import generate_concat_port_assignments
