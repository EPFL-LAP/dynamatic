...
"""
    elif len(extra_signals) == 1 and "spec" in extra_signals:
        return f"""
  library ieee;
  use ieee.std_logic_1164.all;
  use ieee.numeric_std.all;
  ...
  begin
    ...
    outs_valid <= '1' when init else ins_valid;
    ins_ready <= '0' when init else outs_ready;
    outs_spec <= (others => '0') when init else ins_spec;
...
"""
        ...
        raise NotImplementedError(
            "Currently only support no extra signals or 'spec' extra signal"
        )
