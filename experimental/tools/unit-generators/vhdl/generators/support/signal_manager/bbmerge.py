...
from .concat import generate_concat_signal_decls, ConcatenationInfo, generate_concat_port_assignments, generate_concat_mappings
...
def generate_bbmerge_signal_manager(name, in_ports, out_ports, size, data_in_name, index_name, out_extra_signals, index_extra_signals, index_dir, spec_inputs, generate_inner: Callable[[str], str]):
