...
generators.add("arith", "addi")
generators.add("arith", "andi")
generators.add("arith", "ori")
generators.add("arith", "xori")
generators.add("arith", "muli")
generators.add("arith", "shli")
generators.add("arith", "shrui")
generators.add("arith", "shrsi")
generators.add("arith", "subi")
generators.add("arith", "cmpi")
generators.add("arith", "extui")
generators.add("arith", "extsi")
generators.add("arith", "trunci")
generators.add("arith", "divsi")
generators.add("arith", "remsi")
generators.add("arith", "divui")
