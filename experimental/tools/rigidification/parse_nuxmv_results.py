...
def parse_nuxmv(json_file, nuxmv_file, abort_on_unproven):
    ...
    for obj in json_data:
        ...
        for line in nuXmv_lines:
            if re.search(id_pattern, line):
                ...
                if abort_on_unproven and result != True:
                    exit(1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--abort-on-unproven", dest="abort_on_unproven",
                        action="store_true", help="Exit when a property has not been checked.")
    args = parser.parse_args()

    parse_nuxmv(args.json_file, args.nuxmv_file, args.abort_on_unproven)
