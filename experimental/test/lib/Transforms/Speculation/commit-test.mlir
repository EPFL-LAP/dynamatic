...
// RUN: dynamatic-opt %s --handshake-speculation="json-path=%S/commit-test.json"
...
// CHECK:           %[[VAL_30:.*]], %[[VAL_31:.*]] = speculating_branch{{\[}}%[[VAL_28]]] %[[VAL_21]] {bb = 0 : ui32, name = #[[?]]<"speculating_branch2">} : i1, i1
// CHECK:           %[[VAL_32:.*]], %[[VAL_33:.*]] = cond_br %[[VAL_30]], %[[VAL_26]] {bb = 0 : ui32, name = #[[?]]<"cond_br6">} : i1
// CHECK:           %[[VAL_34:.*]] = merge %[[VAL_35:.*]], %[[VAL_36:.*]] {bb = 0 : ui32, name = #[[?]]<"merge3">} : i1
// CHECK:           %[[VAL_37:.*]], %[[VAL_38:.*]] = speculating_branch{{\[}}%[[VAL_35]]] %[[VAL_20]] {bb = 0 : ui32, name = #[[?]]<"speculating_branch3">} : i1, i1
// CHECK:           %[[VAL_39:.*]], %[[VAL_40:.*]] = cond_br %[[VAL_37]], %[[VAL_25]] {bb = 0 : ui32, name = #[[?]]<"cond_br7">} : i1
...
// CHECK:           %[[VAL_35]], %[[VAL_36]] = cond_br %[[VAL_20]], %[[VAL_2]] {bb = 0 : ui32, name = #[[?]]<"cond_br3">} : i1
// CHECK:           %[[VAL_28]], %[[VAL_29]] = cond_br %[[VAL_21]], %[[VAL_2]] {bb = 0 : ui32, name = #[[?]]<"cond_br4">} : i1
// CHECK:           %[[VAL_41:.*]] = spec_commit{{\[}}%[[VAL_33]]] %[[VAL_29]] {bb = 0 : ui32, name = #[[?]]<"spec_commit0">} : i1
// CHECK:           %[[VAL_42:.*]] = spec_commit{{\[}}%[[VAL_18]]] %[[VAL_13]] {bb = 0 : ui32, name = #[[?]]<"spec_commit1">} : i1
// CHECK:           %[[VAL_43:.*]] = spec_commit{{\[}}%[[VAL_39]]] %[[VAL_35]] {bb = 0 : ui32, name = #[[?]]<"spec_commit2">} : i1
// CHECK:           %[[VAL_44:.*]] = spec_commit{{\[}}%[[VAL_32]]] %[[VAL_28]] {bb = 0 : ui32, name = #[[?]]<"spec_commit3">} : i1
// CHECK:           %[[VAL_45:.*]] = spec_commit{{\[}}%[[VAL_40]]] %[[VAL_36]] {bb = 0 : ui32, name = #[[?]]<"spec_commit4">} : i1
// CHECK:           end {bb = 0 : ui32, name = #[[?]]<"end0">} %[[VAL_42]], %[[VAL_43]], %[[VAL_44]], %[[VAL_45]], %[[VAL_41]] : i1, i1, i1, i1, i1
// CHECK:         }
