module {
  handshake.func @b_lhs(%x: !handshake.channel<i32>, %y: !handshake.channel<i32>, %d: !handshake.channel<i32>, %c: !handshake.channel<i1>, ...) -> (!handshake.channel<i32>, !handshake.channel<i32>) attributes {argNames = ["Xd", "Yd","Dd", "Cd"], resNames = ["A", "B"]} {
