...
struct PipelineDuplicationPass
  ...
  void runDynamaticPass() override {
    ...
    auto shortcutVal =
        builder.create<mlir::arith::MulIOp>(loc, load2Op->getResult(), cnst25);
    ...
    auto iCast = builder.create<mlir::arith::IndexCastOp>(
        loc, builder.getIndexType(), indexI);
    builder.create<mlir::memref::StoreOp>(loc, shortcutVal, arrayB,
                                          iCast.getResult());
