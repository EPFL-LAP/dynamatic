...
from src import config, codegen, wrapper
...
def main():
    ...
    lsq_config = config.Config()

    # STEP 1: Generate the desired core lsq logic
    codegen.codeGen(args.output_dir, lsq_config)

    # STEP 2: Generate the wrapper to be connected with circuits generated by Dynamatic
    lsq_wrapper_module = wrapper.LSQWrapper(args.output_dir, lsq_config)
