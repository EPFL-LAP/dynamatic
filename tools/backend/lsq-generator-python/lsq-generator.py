...
parser.add_argument('--config-file', '-c', required=True,
                    dest='config_files', default='', type=str)
...
class LSQWrapper:
    ...
    def genWrapperSlave(self):
        ...
        self.lsq_wrapper_str += OpTab(
            wreq_ready[0], self.tab_level, io_stAddrToMC_ready, "and", io_stDataToMC_ready)
