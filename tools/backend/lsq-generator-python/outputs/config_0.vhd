...
entity config_0 is
	port(
		reset : in std_logic;
		clock : in std_logic;
		io_storeData : out std_logic_vector(12 downto 0);
		io_storeAddr : out std_logic_vector(9 downto 0);
		io_storeEn : out std_logic;
		io_loadData : in std_logic_vector(12 downto 0);
		...
		io_ldAddr_1_bits : in std_logic_vector(9 downto 0);
		...
		io_ldData_0_bits : out std_logic_vector(12 downto 0);
		io_ldData_1_bits : out std_logic_vector(12 downto 0);
		...
		io_stAddr_1_bits : in std_logic_vector(9 downto 0);
		...
		io_stData_0_bits : in std_logic_vector(12 downto 0);
		io_stData_1_bits : in std_logic_vector(12 downto 0);
...
architecture arch of config_0 is
	signal rreq_0_ready : std_logic;
	signal rresp_0_valid : std_logic;
	signal rresp_0_id : std_logic_vector(0 downto 0);
	signal wreq_0_ready : std_logic;
	signal wresp_0_valid : std_logic;
	signal wresp_0_id : std_logic_vector(0 downto 0);
	signal rreq_0_id : std_logic_vector(0 downto 0);
	signal wreq_0_id : std_logic_vector(0 downto 0);
begin
	----------------------------------------------------------------------------
	...
	config_0_core : entity work.config_0_core
		port map(
			rst => reset,
			clk => clock,
