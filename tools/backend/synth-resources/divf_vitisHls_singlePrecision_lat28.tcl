create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name divf_vitisHls_singlePrecision_lat28
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name divf_vitisHls_singlePrecision_lat28 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips divf_vitisHls_singlePrecision_lat28] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files divf_vitisHls_singlePrecision_lat28.xci]
generate_target {synthesis simulation} [get_files divf_vitisHls_singlePrecision_lat28.xci]
