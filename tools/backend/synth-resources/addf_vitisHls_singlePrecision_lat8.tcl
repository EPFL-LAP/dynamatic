create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name addf_vitisHls_singlePrecision_lat8
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name addf_vitisHls_singlePrecision_lat8 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips addf_vitisHls_singlePrecision_lat8] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files addf_vitisHls_singlePrecision_lat8.xci]
generate_target {synthesis simulation} [get_files addf_vitisHls_singlePrecision_lat8.xci]
