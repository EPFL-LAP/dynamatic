create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name cmpf_vitisHls_singlePrecision_lat0
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name cmpf_vitisHls_singlePrecision_lat0 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips cmpf_vitisHls_singlePrecision_lat0] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files cmpf_vitisHls_singlePrecision_lat0.xci]
generate_target {synthesis simulation} [get_files cmpf_vitisHls_singlePrecision_lat0.xci]
