...
if __name__ == "__main__":
    ...
    generators.add("handshake.out_of_order_execution", "tagger")
    generators.add("handshake.out_of_order_execution", "untagger")
    generators.add("handshake.out_of_order_execution", "free_tags_fifo")
