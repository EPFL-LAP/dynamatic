...
F_CLANG_OPTIMIZED_DEPENDENCY_PARTITIONED="$COMP_DIR/clang.opt.dep.part.ll"
F_CLANG_OPTIMIZED_DEPENDENCY_PARTITIONED_CLEANED="$COMP_DIR/clang.opt.dep.part.clean.ll"
