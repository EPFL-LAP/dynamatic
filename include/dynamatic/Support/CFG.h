...
namespace dynamatic {
  ...
  /// Determines whether the edge is located between a branch-like operation and a merge-like operation
  bool isBranchToMergeLike(Value val, Operation* user);

  /// Determines whether the edge is coming from a conditional branch
  bool isComingFromConditionalBranch(Value val);
