...
#ifndef DYNAMATIC_DIALECT_HANDSHAKE_HANDSHAKETYPES_H
#define DYNAMATIC_DIALECT_HANDSHAKE_HANDSHAKETYPES_H
...
#endif // DYNAMATIC_DIALECT_HANDSHAKE_HANDSHAKETYPES_H
