//===- PortImplementation.h - Port-related data-structures ------*- C++ -*-===//
//
...
#ifndef DYNAMATIC_DIALECT_HW_PORT_IMPLEMENTATION_H
#define DYNAMATIC_DIALECT_HW_PORT_IMPLEMENTATION_H
...
#endif // DYNAMATIC_DIALECT_HW_PORTIMPLEMENTATION_H
