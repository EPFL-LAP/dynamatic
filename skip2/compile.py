...
from common import *
from change_lsq import *


def compile(test_dir: Path, basename: str, clock: float, load: int, store: int, fork_fifo_size: int, rtl_config_name, log_file: Path):
    # change LSQ size befor doing anything else
    change_lsq_size(load, store, rtl_config_name)
