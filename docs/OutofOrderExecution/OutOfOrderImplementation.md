...
<img alt="Example diagram" src="./Figures/Example.png" width="600" />

### 1.1. Identify Dirty Nodes
Identify all the nodes reachable from the out-of-order node.

<img alt="Step 1.1 diagram" src="./Figures/Step1.1.png" width="600" />
...
<img alt="Step 1.2 diagram" src="./Figures/Step1.2.png" width="600" />
...
<img alt="Step 1.3 diagram" src="./Figures/Step1.3.png" width="600" />

### 1.4. Add Taggers
For each tagged edge, add a tagger.

<img alt="Step 1.4 diagram" src="./Figures/Step1.4.png" width="600" />
