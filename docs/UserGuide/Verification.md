...
- testbench information 
    ...
    - dependency listing
- the results of the waveform transitions that occured during the simulation, stored in a `vsim.wlf` file which the interactive visualizer uses to animate the circuit using the Godot game engine.
