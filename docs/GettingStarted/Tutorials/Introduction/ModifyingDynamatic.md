...
- All resources are located in the repository's [`tutorials/Introduction/`](https://github.com/EPFL-LAP/dynamatic/tree/main/tutorials/Introduction) folder. Data exclusive to this chapter is located in the `Ch2` subfolder, but we will also reuse data from the previous chapter, `Ch1`.
...
Open the [`include/dynamatic/Transforms/Passes.td`](https://github.com/EPFL-LAP/dynamatic/blob/main/include/dynamatic/Transforms/Passes.td) file and copy-and-paste the following snippet anywhere below the include lines at the top of the file.
