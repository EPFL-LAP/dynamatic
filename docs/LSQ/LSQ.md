...
![LSQ Top-Level](./figs/lsq/LSQ_Top-level_lsq.png)
...
![LSQ High Level](./figs/lsq/LSQ_High_Level.png)
...
![LSQ Sub module Instantiation](./figs/lsq/LSQ_1.png)
...
2. **Load Queue Management Logic**
    ![LSQ Load Queue Management Logic](./figs/lsq/LSQ_2.png)
    ...
    ![LSQ Load Queue Entry Allocation Logic](./figs/lsq/LSQ_2_1.png)
    ...
    * **Output**:
    ...
    ![LSQ Load Queue Pointer Logic](./figs/lsq/LSQ_2_2.png)
    ...
    * **Output**:
    ...
    ![LSQ Load Queue Content State Logic](./figs/lsq/LSQ_2_3.png)
...
3. **Store Queue Management Logic**  
    ![LSQ Store Queue Management Logic](./figs/lsq/LSQ_3.png)  
    ...
    ![LSQ Store Queue Entry Allocation Logic](./figs/lsq/LSQ_3_1.png)  
    ...
    * **Output**:
    ...
    ![LSQ Store Queue Pointer Logic](./figs/lsq/LSQ_3_2.png)    
    ...
    * **Output**:
    ...
    ![LSQ Store Queue Content State Logic](./figs/lsq/LSQ_3_3.png)   
...
![load-store order matrix](./figs/lsq/load_store_order_matrix.png)
...
![Compare Address](./figs/lsq/LSQ_5.png)
...
![Compare Address](./figs/lsq/LSQ_6.png)
...
![Load Request Validity Logic](./figs/lsq/LSQ_7.png)
...
![Load-Store Conflict Logic](./figs/lsq/LSQ_8.png)
...
![Load-Store Bypass Logic](./figs/lsq/LSQ_9.png)
...
![Load to Memory Logic](./figs/lsq/LSQ_10.png)
...
* **Processing**:
    ...
    ![Load to Memory Logic1](./figs/lsq/LSQ_10_1.png)
    ![Load to Memory Logic2](./figs/lsq/LSQ_10_2.png)
    ![Load to Memory Logic3](./figs/lsq/LSQ_10_3.png)
* **Output**:
...
![Store-Load Conflict Logic](./figs/lsq/LSQ_11.png)
...
![Store Queue Bypass Logic](./figs/lsq/LSQ_12.png)
...
## 3. Pipelining  
![Pipelining](./figs/lsq/pipeline.png)
* **Purpose**
