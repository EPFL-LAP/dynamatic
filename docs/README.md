...
6. [Developer Guide](DeveloperGuide/)
   ...
   - [Writing Compiler Passes](DeveloperGuide/IntroductoryMaterial/Tutorials/CreatingPasses/CreatingPassesTutorial.md)
   - [MLIR Primer](DeveloperGuide/CompilerIntrinsics/MLIRPrimer.md)
   - [Adding New MLIR Operations](DeveloperGuide/CompilerIntrinsics/Tutorials/AddNewMLIROperation.md)
   - [Testing](DeveloperGuide/IntroductoryMaterial/FileCheckTesting.md)
...
8. [Other Advanced Topics](DeveloperGuide/Specs)
   ...
   - [MLIR Optimization C Level](DeveloperGuide/CompilerIntrinsics/MLIROpInstantiationCLevel.md)
