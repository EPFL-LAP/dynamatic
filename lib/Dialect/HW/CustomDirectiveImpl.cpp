...
ParseResult dynamatic::parseInputPortList(
    OpAsmParser &parser,
...
void dynamatic::printInputPortList(OpAsmPrinter &p, Operation *op,
...
ParseResult dynamatic::parseOutputPortList(OpAsmParser &parser,
...
void dynamatic::printOutputPortList(OpAsmPrinter &p, Operation *op,
...
ParseResult dynamatic::parseOptionalParameterList(OpAsmParser &parser,
...
void dynamatic::printOptionalParameterList(OpAsmPrinter &p, Operation *op,
                                           ArrayAttr parameters) {
  if (parameters.empty())
    return;
