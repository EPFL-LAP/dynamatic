module {
  handshake.func @bisection(%arg0: !handshake.channel<f32>, %arg1: !handshake.channel<f32>, %arg2: !handshake.channel<f32>, %arg3: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>) attributes {argNames = ["a", "b", "tol", "start"], handshake.cfdfcThroughput = #handshake<cfdfcThroughput {"0" = 0.076923076923076927 : f64, "1" = 0.033333333333333333 : f64}>, handshake.cfdfcToBBList = #handshake<cfdfcToBBList {"0" = [2 : ui32], "1" = [2 : ui32, 3 : ui32, 1 : ui32]}>, resNames = ["out0", "end"]} {
    ...
    %15 = mux %102#0 [%14, %134] {handshake.bb = 2 : ui32, handshake.name = "mux5"} : <i1>, [<f32>, <f32>] to <f32>
    ...
    %30 = addf %136#2, %32#2 {fastmath = #arith.fastmath<none>, handshake.bb = 2 : ui32, handshake.name = "addf1", internal_delay = "2_922000"} : <f32>
    ...
    %41 = buffer %144#3, bufferType = FIFO_BREAK_NONE, numSlots = 2 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer38"} : <f32>
    ...
    %47 = andi %132, %79#0 {handshake.bb = 2 : ui32, handshake.name = "andi1"} : <i1>
    %48 = andi %117, %60#0 {handshake.bb = 2 : ui32, handshake.name = "andi2"} : <i1>
    %49 = buffer %34#5, bufferType = FIFO_BREAK_NONE, numSlots = 2 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer18"} : <f32>
    %50 = passer %49[%116#1] {handshake.bb = 2 : ui32, handshake.name = "passer0"} : <f32>, <i1>
    %51 = passer %150#0[%116#0] {handshake.bb = 2 : ui32, handshake.name = "passer2"} : <>, <i1>
    ...
    %54 = subf %32#1, %136#1 {fastmath = #arith.fastmath<none>, handshake.bb = 2 : ui32, handshake.name = "subf0", internal_delay = "2_000000"} : <f32>
    ...
    %58 = cmpf olt, %55, %144#2 {handshake.bb = 2 : ui32, handshake.name = "cmpf1", internal_delay = "0_000000"} : <f32>
    ...
    %63 = passer %62[%114#0] {handshake.bb = 2 : ui32, handshake.name = "passer10"} : <f32>, <i1>
    %64 = passer %150#5[%114#1] {handshake.bb = 2 : ui32, handshake.name = "passer12"} : <>, <i1>
    ...
    %68 = constant %150#1 {handshake.bb = 2 : ui32, handshake.name = "constant9", value = 0.000000e+00 : f32} : <>, <f32>
    ...
    %75 = buffer %140#1, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer36"} : <f32>
    ...
    %91 = passer %92[%108#4] {handshake.bb = 2 : ui32, handshake.name = "passer46"} : <i1>, <i1>
    ...
    %104 = source {handshake.bb = 2 : ui32, handshake.name = "source6"} : <>
    %105 = constant %104 {handshake.bb = 2 : ui32, handshake.name = "constant3", value = false} : <>, <i1>
    %106 = mux %103 [%105, %96#1] {handshake.bb = 2 : ui32, handshake.name = "mux12"} : <i1>, [<i1>, <i1>] to <i1>
    %107 = buffer %106, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer34"} : <i1>
    %108:5 = fork [5] %107 {handshake.bb = 2 : ui32, handshake.name = "fork49"} : <i1>
    %109 = andi %48, %108#0 {handshake.bb = 2 : ui32, handshake.name = "andi7"} : <i1>
    %110:8 = fork [8] %109 {handshake.bb = 2 : ui32, handshake.name = "fork50"} : <i1>
    %111 = andi %47, %108#1 {handshake.bb = 2 : ui32, handshake.name = "andi8"} : <i1>
    %112:2 = fork [2] %111 {handshake.bb = 2 : ui32, handshake.name = "fork51"} : <i1>
    %113 = andi %46, %108#2 {handshake.bb = 2 : ui32, handshake.name = "andi9"} : <i1>
    %114:2 = fork [2] %113 {handshake.bb = 2 : ui32, handshake.name = "fork52"} : <i1>
    %115 = andi %43#1, %108#3 {handshake.bb = 2 : ui32, handshake.name = "andi10"} : <i1>
    %116:2 = fork [2] %115 {handshake.bb = 2 : ui32, handshake.name = "fork53"} : <i1>
    %117 = not %77#1 {handshake.bb = 2 : ui32, handshake.name = "not2"} : <i1>
    %118 = buffer %144#0, bufferType = FIFO_BREAK_NONE, numSlots = 2 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer37"} : <f32>
    %119 = passer %118[%110#5] {handshake.bb = 2 : ui32, handshake.name = "passer21"} : <f32>, <i1>
    %120 = buffer %34#2, bufferType = FIFO_BREAK_NONE, numSlots = 2 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer16"} : <f32>
    %121 = passer %120[%110#6] {handshake.bb = 2 : ui32, handshake.name = "passer25"} : <f32>, <i1>
    %122 = passer %67#1[%110#4] {handshake.bb = 2 : ui32, handshake.name = "passer27"} : <f32>, <i1>
    %123 = buffer %85#0, bufferType = FIFO_BREAK_NONE, numSlots = 2 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer23"} : <i8>
    %124 = passer %123[%110#3] {handshake.bb = 2 : ui32, handshake.name = "passer29"} : <i8>, <i1>
    %125 = passer %89#1[%110#1] {handshake.bb = 2 : ui32, handshake.name = "passer31"} : <i1>, <i1>
    %126 = passer %150#2[%110#2] {handshake.bb = 2 : ui32, handshake.name = "passer33"} : <>, <i1>
    %127 = buffer %32#0, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer14"} : <f32>
    %128 = buffer %127, bufferType = FIFO_BREAK_NONE, numSlots = 2 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer15"} : <f32>
    %129 = passer %128[%110#7] {handshake.bb = 2 : ui32, handshake.name = "passer34"} : <f32>, <i1>
    %130 = buffer %37#0, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer19"} : <f32>
    %131 = passer %130[%110#0] {handshake.bb = 2 : ui32, handshake.name = "passer35"} : <f32>, <i1>
    %132 = not %89#2 {handshake.bb = 2 : ui32, handshake.name = "not3"} : <i1>
    %133 = buffer %136#0, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer35"} : <f32>
    %134 = passer %133[%99#0] {handshake.bb = 2 : ui32, handshake.name = "passer47"} : <f32>, <i1>
    %135 = buffer %15, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer5"} : <f32>
    %136:3 = fork [3] %135 {handshake.bb = 2 : ui32, handshake.name = "fork54"} : <f32>
    %137 = passer %140#0[%99#3] {handshake.bb = 2 : ui32, handshake.name = "passer48"} : <f32>, <i1>
    %138 = buffer %21, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer8"} : <f32>
    %139 = buffer %138, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer9"} : <f32>
    %140:2 = fork [2] %139 {handshake.bb = 2 : ui32, handshake.name = "fork55"} : <f32>
    %141 = passer %144#1[%99#1] {handshake.bb = 2 : ui32, handshake.name = "passer49"} : <f32>, <i1>
    %142 = buffer %23, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer10"} : <f32>
    %143 = buffer %142, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer11"} : <f32>
    %144:4 = fork [4] %143 {handshake.bb = 2 : ui32, handshake.name = "fork56"} : <f32>
    %145 = buffer %99#5, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer29"} : <i1>
    %146 = buffer %145, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer30"} : <i1>
    %147 = passer %150#4[%146] {handshake.bb = 2 : ui32, handshake.name = "passer50"} : <>, <i1>
    %148 = buffer %25, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer12"} : <>
    %149 = buffer %148, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 2 : ui32, handshake.name = "buffer13"} : <>
    %150:6 = fork [6] %149 {handshake.bb = 2 : ui32, handshake.name = "fork57"} : <>
    %151 = passer %150#3[%112#1] {handshake.bb = 2 : ui32, handshake.name = "passer42"} : <>, <i1>
    %152 = passer %67#2[%112#0] {handshake.bb = 2 : ui32, handshake.name = "passer43"} : <f32>, <i1>
    %153:7 = fork [7] %125 {handshake.bb = 3 : ui32, handshake.name = "fork21"} : <i1>
    %trueResult, %falseResult = cond_br %153#6, %121 {handshake.bb = 3 : ui32, handshake.name = "cond_br38"} : <i1>, <f32>
    sink %falseResult {handshake.name = "sink26"} : <f32>
    %trueResult_0, %falseResult_1 = cond_br %153#5, %129 {handshake.bb = 3 : ui32, handshake.name = "cond_br39"} : <i1>, <f32>
    sink %falseResult_1 {handshake.name = "sink27"} : <f32>
    %trueResult_2, %falseResult_3 = cond_br %153#0, %124 {handshake.bb = 3 : ui32, handshake.name = "cond_br40"} : <i1>, <i8>
    sink %falseResult_3 {handshake.name = "sink28"} : <i8>
    %trueResult_4, %falseResult_5 = cond_br %153#4, %131 {handshake.bb = 3 : ui32, handshake.name = "cond_br41"} : <i1>, <f32>
    sink %falseResult_5 {handshake.name = "sink29"} : <f32>
    %trueResult_6, %falseResult_7 = cond_br %153#3, %119 {handshake.bb = 3 : ui32, handshake.name = "cond_br42"} : <i1>, <f32>
    sink %falseResult_7 {handshake.name = "sink30"} : <f32>
    %trueResult_8, %falseResult_9 = cond_br %153#2, %126 {handshake.bb = 3 : ui32, handshake.name = "cond_br43"} : <i1>, <>
    %trueResult_10, %falseResult_11 = cond_br %153#1, %122 {handshake.bb = 3 : ui32, handshake.name = "cond_br44"} : <i1>, <f32>
    sink %trueResult_10 {handshake.name = "sink31"} : <f32>
    %154 = mux %index_13 [%50, %152, %falseResult_11] {handshake.bb = 4 : ui32, handshake.name = "mux10"} : <i2>, [<f32>, <f32>, <f32>] to <f32>
    %result_12, %index_13 = control_merge [%51, %151, %falseResult_9]  {handshake.bb = 4 : ui32, handshake.name = "control_merge6"} : [<>, <>, <>] to <>, <i2>
    %155 = mux %index_15 [%63, %154] {handshake.bb = 5 : ui32, handshake.name = "mux11"} : <i1>, [<f32>, <f32>] to <f32>
    ...
    end {handshake.bb = 5 : ui32, handshake.name = "end0"} %155, %0#1 : <f32>, <>
  }
}
