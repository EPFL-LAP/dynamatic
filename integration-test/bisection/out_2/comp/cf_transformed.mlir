module {
  func.func @bisection(%arg0: f32 {handshake.arg_name = "a"}, %arg1: f32 {handshake.arg_name = "b"}, %arg2: f32 {handshake.arg_name = "tol"}) -> f32 {
    ...
    %1 = arith.addf %0, %cst_1 {handshake.name = "addf0"} : f32
  ...
  ^bb1(%2: f32, %3: f32, %4: i32, %5: f32):  // 2 preds: ^bb0, ^bb3
    ...
    %9 = arith.addf %8, %cst_1 {handshake.name = "addf2"} : f32
  ...
  ^bb3:  // pred: ^bb2
    ...
    %16 = arith.cmpf olt, %15, %cst {handshake.name = "cmpf2"} : f32
    ...
    cf.cond_br %21, ^bb1(%18, %17, %20, %19 : f32, f32, i32, f32), ^bb4(%cst : f32) {handshake.name = "cond_br2"}
