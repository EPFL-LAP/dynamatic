; ModuleID = '/home/shundroid/dynamatic/integration-test/if_float/if_float.c'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul1 = fmul float 0xBFECCCCCC0000000, %6
...
if.then:                                          ; preds = %for.body
  ...
  %mul3 = fmul float %7, 0x3FF19999A0000000
  store float %mul3, ptr %x, align 4
  br label %if.end
...
if.else:                                          ; preds = %for.body
  ...
  %div = fdiv float %11, 0x3FF19999A0000000
...
for.end:                                          ; preds = %for.cond
  %4 = load float, ptr %x0, align 4
  %arraydecay = getelementptr inbounds [100 x float], ptr %a, i64 0, i64 0
  %arraydecay3 = getelementptr inbounds [100 x float], ptr %minus_trace, i64 0, i64 0
  %call4 = call float @if_float(float noundef %4, ptr noundef %arraydecay, ptr noundef %arraydecay3)
  ret i32 0
}
