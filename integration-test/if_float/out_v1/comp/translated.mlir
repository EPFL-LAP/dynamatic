...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>} {
  ...
  llvm.func @main() -> i32 attributes {passthrough = ["noinline", "nounwind", ["uwtable", "2"], ["frame-pointer", "all"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"], ["target-features", "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87"], ["tune-cpu", "generic"]]} {
    ...
    %8 = llvm.alloca %0 x !llvm.array<100 x f32> {alignment = 16 : i64} : (i32) -> !llvm.ptr
    llvm.call @srand(%1) : (i32) -> ()
    llvm.br ^bb1(%2 : i32)
  ^bb1(%9: i32):  // 2 preds: ^bb0, ^bb1
    %10 = llvm.call @rand() : () -> i32
    %11 = llvm.srem %10, %3  : i32
    %12 = llvm.sitofp %11 : i32 to f32
    %13 = llvm.fdiv %12, %4  : f32
    %14 = llvm.zext %9 : i32 to i64
    %15 = llvm.getelementptr inbounds %7[%5, %14] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<100 x f32>
    llvm.store %13, %15 {alignment = 4 : i64} : f32, !llvm.ptr
    %16 = llvm.zext %9 : i32 to i64
    %17 = llvm.getelementptr inbounds %8[%5, %16] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<100 x f32>
    llvm.store %6, %17 {alignment = 4 : i64} : f32, !llvm.ptr
    %18 = llvm.add %9, %0  : i32
    %19 = llvm.icmp "ult" %18, %3 : i32
    llvm.cond_br %19, ^bb1(%18 : i32), ^bb2 {loop_annotation = #loop_annotation}
  ^bb2:  // pred: ^bb1
    %20 = llvm.call @if_float(%4, %7, %8) : (f32, !llvm.ptr, !llvm.ptr) -> f32
    llvm.return %2 : i32
  }
