-- handshake_spec_save_commit_0 : spec_save_commit({'fifo_depth': 30, 'bitwidth': 8, 'extra_signals': {'spec': 1}})
...
architecture arch of handshake_spec_save_commit_0 is
  ...
  type FIFO_Memory is array (0 to 30 - 1) of STD_LOGIC_VECTOR (8 - 1 downto 0);
