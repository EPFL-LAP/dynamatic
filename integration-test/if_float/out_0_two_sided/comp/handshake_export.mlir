module {
  handshake.func @if_float(%arg0: !handshake.channel<f32>, %arg1: memref<100xf32>, %arg2: memref<100xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x0", "a", "minus_trace", "a_start", "minus_trace_start", "start"], handshake.cfdfcThroughput = #handshake<cfdfcThroughput {"0" = 0.034482758620689655 : f64}>, handshake.cfdfcToBBList = #handshake<cfdfcToBBList {"0" = [1 : ui32]}>, resNames = ["out0", "a_end", "minus_trace_end", "end"]} {
    ...
    %4 = buffer %3, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer1"} : <i8>
    %5:3 = fork [3] %4 {handshake.bb = 1 : ui32, handshake.name = "fork14"} : <i8>
    %6 = buffer %5#0, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer2"} : <i8>
    ...
    %12 = buffer %result, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer5"} : <>
    ...
    %24:5 = fork [5] %23 {handshake.bb = 1 : ui32, handshake.name = "fork48"} : <i1>
    %25 = buffer %29, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer0"} : <i1>
    %26 = buffer %25, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer8"} : <i1>
    %27 = init %26 {handshake.bb = 1 : ui32, handshake.bufProps = #handshake<bufProps{"0": [0,inf], [0,inf], 1, 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "init0", initToken = 0 : ui1} : <i1>
    %28:5 = fork [5] %27 {handshake.bb = 1 : ui32, handshake.name = "fork49"} : <i1>
    %29 = not %28#4 {handshake.bb = 1 : ui32, handshake.name = "not1"} : <i1>
    %30 = mux %28#3 [%35, %24#0] {handshake.bb = 1 : ui32, handshake.name = "mux5"} : <i1>, [<i1>, <i1>] to <i1>
    %31 = buffer %30, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer9"} : <i1>
    %32:6 = fork [6] %31 {handshake.bb = 1 : ui32, handshake.name = "fork50"} : <i1>
    %33 = buffer %61, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer16"} : <>
    %34 = passer %33[%32#0] {handshake.bb = 1 : ui32, handshake.name = "passer6"} : <>, <i1>
    %35 = not %24#4 {handshake.bb = 1 : ui32, handshake.name = "not0"} : <i1>
    ...
    %39 = buffer %38, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer11"} : <f32>
    %40:2 = fork [2] %41 {handshake.bb = 1 : ui32, handshake.name = "fork43"} : <i8>
    %41 = buffer %5#2, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer3"} : <i8>
    %42 = passer %43[%24#3] {handshake.bb = 1 : ui32, handshake.name = "passer7"} : <i7>, <i1>
    %43 = trunci %40#0 {handshake.bb = 1 : ui32, handshake.name = "trunci1"} : <i8> to <i7>
    %44 = buffer %46#0, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer13"} : <f32>
    %45 = passer %44[%24#2] {handshake.bb = 1 : ui32, handshake.name = "passer8"} : <f32>, <i1>
    %46:2 = fork [2] %11#3 {handshake.bb = 1 : ui32, handshake.name = "fork44"} : <f32>
    %47:2 = fork [2] %13#1 {handshake.bb = 1 : ui32, handshake.name = "fork45"} : <>
    %48 = constant %47#0 {handshake.bb = 1 : ui32, handshake.name = "constant3", value = 1 : i2} : <>, <i2>
    %49 = passer %50[%24#1] {handshake.bb = 1 : ui32, handshake.name = "passer9"} : <i32>, <i1>
    ...
    %addressResult_1, %dataResult_2 = store[%42] %45 {handshake.bb = 1 : ui32, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store0"} : <i7>, <f32>, <i7>, <f32>
    %53 = divf %46#1, %52 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "divf0", internal_delay = "3_812000"} : <f32>
    %54 = mux %28#1 [%39, %53] {handshake.bb = 1 : ui32, handshake.name = "mux2"} : <i1>, [<f32>, <f32>] to <f32>
    %55 = buffer %54, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer14"} : <f32>
    %56:2 = fork [2] %55 {handshake.bb = 1 : ui32, handshake.name = "fork8"} : <f32>
    %57 = buffer %5#1, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer12"} : <i8>
    %58 = mux %28#2 [%57, %40#1] {handshake.bb = 1 : ui32, handshake.name = "mux3"} : <i1>, [<i8>, <i8>] to <i8>
    ...
    %61 = mux %28#0 [%13#0, %47#1] {handshake.bb = 1 : ui32, handshake.name = "mux4"} : <i1>, [<>, <>] to <>
    ...
    %68 = buffer %32#1, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer10"} : <i1>
    %69 = passer %70[%68] {handshake.bb = 1 : ui32, handshake.name = "passer10"} : <f32>, <i1>
    %70 = addf %56#0, %56#1 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "addf1", internal_delay = "2_922000"} : <f32>
    %71:2 = fork [2] %72 {handshake.bb = 1 : ui32, handshake.name = "fork46"} : <i9>
    %72 = addi %60, %64 {handshake.bb = 1 : ui32, handshake.name = "addi0"} : <i9>
    %73 = passer %74[%32#5] {handshake.bb = 1 : ui32, handshake.name = "passer11"} : <i8>, <i1>
    %74 = trunci %71#0 {handshake.bb = 1 : ui32, handshake.name = "trunci2"} : <i9> to <i8>
    %75 = passer %78#0[%32#4] {handshake.bb = 1 : ui32, handshake.name = "passer12"} : <i1>, <i1>
    %76 = passer %78#1[%32#3] {handshake.bb = 1 : ui32, handshake.name = "passer13"} : <i1>, <i1>
    %77 = passer %78#2[%32#2] {handshake.bb = 1 : ui32, handshake.name = "passer14"} : <i1>, <i1>
    ...
    %trueResult_5, %falseResult_6 = cond_br %77, %34 {handshake.bb = 1 : ui32, handshake.name = "cond_br7"} : <i1>, <>
