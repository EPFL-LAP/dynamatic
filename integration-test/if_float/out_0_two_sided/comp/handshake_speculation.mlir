module {
  handshake.func @if_float(%arg0: !handshake.channel<f32>, %arg1: memref<100xf32>, %arg2: memref<100xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x0", "a", "minus_trace", "a_start", "minus_trace_start", "start"], resNames = ["out0", "a_end", "minus_trace_end", "end"]} {
    ...
    %memEnd = mem_controller[%arg2 : memref<100xf32>] %arg4 (%47, %addressResult_5, %dataResult_6) %78#1 {connectedBlocks = [1 : i32], handshake.name = "mem_controller2"} :    (!handshake.channel<i32>, !handshake.channel<i7>, !handshake.channel<f32>) -> ()
    %outputs, %memEnd_0 = mem_controller[%arg1 : memref<100xf32>] %arg3 (%addressResult) %78#0 {connectedBlocks = [1 : i32], handshake.name = "mem_controller3"} :    (!handshake.channel<i7>) -> !handshake.channel<f32>
    ...
    %21:5 = fork [5] %20 {handshake.bb = 1 : ui32, handshake.name = "fork48"} : <i1>
    %22 = buffer %25, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer0"} : <i1>
    %23 = init %22 {handshake.bb = 1 : ui32, handshake.name = "init0", initToken = 0 : ui1} : <i1>
    %24:5 = fork [5] %23 {handshake.bb = 1 : ui32, handshake.name = "fork49"} : <i1>
    %25 = not %24#4 {handshake.bb = 1 : ui32, handshake.name = "not1"} : <i1>
    %26 = mux %24#3 [%29, %21#0] {handshake.bb = 1 : ui32, handshake.name = "mux5"} : <i1>, [<i1>, <i1>] to <i1>
    %27:6 = fork [6] %26 {handshake.bb = 1 : ui32, handshake.name = "fork50"} : <i1>
    %28 = passer %59[%27#0] {handshake.bb = 1 : ui32, handshake.name = "passer6"} : <>, <i1>
    ...
    %33 = constant %32 {handshake.bb = 1 : ui32, handshake.name = "constant8", value = 1.100000e+00 : f32} : <>, <f32>
    %34 = mulf %31, %33 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "mulf2"} : <f32>
    ...
    %38:2 = fork [2] %39 {handshake.bb = 1 : ui32, handshake.name = "fork43"} : <i8>
    ...
    %43:2 = fork [2] %44 {handshake.bb = 1 : ui32, handshake.name = "fork44"} : <f32>
    %44 = merge %10#3 {handshake.bb = 1 : ui32, handshake.name = "merge3"} : <f32>
    %45:2 = fork [2] %result_3 {handshake.bb = 1 : ui32, handshake.name = "fork45"} : <>
    ...
    %50 = constant %49 {handshake.bb = 1 : ui32, handshake.name = "constant9", value = 1.100000e+00 : f32} : <>, <f32>
    ...
    %51 = divf %43#1, %50 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "divf0"} : <f32>
    ...
    %55 = mux %24#1 [%35, %52] {handshake.bb = 1 : ui32, handshake.name = "mux2"} : <i1>, [<f32>, <f32>] to <f32>
    %56:2 = fork [2] %55 {handshake.bb = 1 : ui32, handshake.name = "fork8"} : <f32>
    %57 = mux %24#2 [%36, %53] {handshake.bb = 1 : ui32, handshake.name = "mux3"} : <i1>, [<i8>, <i8>] to <i8>
    %58 = extsi %57 {handshake.bb = 1 : ui32, handshake.name = "extsi5"} : <i8> to <i9>
    %59 = mux %24#0 [%37, %54] {handshake.bb = 1 : ui32, handshake.name = "mux4"} : <i1>, [<>, <>] to <>
    ...
    %66 = passer %67[%27#1] {handshake.bb = 1 : ui32, handshake.name = "passer10"} : <f32>, <i1>
    %67 = addf %56#0, %56#1 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "addf1"} : <f32>
    %68:2 = fork [2] %69 {handshake.bb = 1 : ui32, handshake.name = "fork46"} : <i9>
    %69 = addi %58, %62 {handshake.bb = 1 : ui32, handshake.name = "addi0"} : <i9>
    %70 = passer %71[%27#5] {handshake.bb = 1 : ui32, handshake.name = "passer11"} : <i8>, <i1>
    %71 = trunci %68#0 {handshake.bb = 1 : ui32, handshake.name = "trunci2"} : <i9> to <i8>
    %72 = passer %75#0[%27#4] {handshake.bb = 1 : ui32, handshake.name = "passer12"} : <i1>, <i1>
    %73 = passer %75#1[%27#3] {handshake.bb = 1 : ui32, handshake.name = "passer13"} : <i1>, <i1>
    %74 = passer %75#2[%27#2] {handshake.bb = 1 : ui32, handshake.name = "passer14"} : <i1>, <i1>
    %75:3 = fork [3] %76 {handshake.bb = 1 : ui32, handshake.name = "fork47"} : <i1>
    %76 = cmpi ult, %68#1, %65 {handshake.bb = 1 : ui32, handshake.name = "cmpi0"} : <i9>
    %trueResult, %falseResult = cond_br %72, %70 {handshake.bb = 1 : ui32, handshake.name = "cond_br5"} : <i1>, <i8>
    sink %falseResult {handshake.name = "sink2"} : <i8>
    %trueResult_7, %falseResult_8 = cond_br %73, %66 {handshake.bb = 1 : ui32, handshake.name = "cond_br6"} : <i1>, <f32>
    %trueResult_9, %falseResult_10 = cond_br %74, %28 {handshake.bb = 1 : ui32, handshake.name = "cond_br7"} : <i1>, <>
    %77 = merge %falseResult_8 {handshake.bb = 2 : ui32, handshake.name = "merge4"} : <f32>
    ...
    %78:2 = fork [2] %result_11 {handshake.bb = 2 : ui32, handshake.name = "fork12"} : <>
    end {handshake.bb = 2 : ui32, handshake.name = "end0"} %77, %memEnd_0, %memEnd, %0#1 : <f32>, <>, <>, <>
  }
}
