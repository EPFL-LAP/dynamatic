module {
  handshake.func @if_float(%arg0: !handshake.channel<f32>, %arg1: memref<100xf32>, %arg2: memref<100xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x0", "a", "minus_trace", "a_start", "minus_trace_start", "start"], resNames = ["out0", "a_end", "minus_trace_end", "end"]} {
    ...
    %0 = constant %arg5 {handshake.bb = 0 : ui32, handshake.name = "constant5", value = 0 : i32} : <>, <i32>
    ...
    %7 = constant %6 {handshake.bb = 1 : ui32, handshake.name = "constant6", value = -0.899999976 : f32} : <>, <f32>
    %8 = source {handshake.bb = 1 : ui32, handshake.name = "source1"} : <>
    %9 = constant %8 {handshake.bb = 1 : ui32, handshake.name = "constant7", value = 0.000000e+00 : f32} : <>, <f32>
    ...
    %20 = mulf %17, %19 {fastmath = #arith.fastmath<none>, handshake.bb = 2 : ui32, handshake.name = "mulf2"} : <f32>
    ...
    %31 = divf %26, %28 {fastmath = #arith.fastmath<none>, handshake.bb = 3 : ui32, handshake.name = "divf0"} : <f32>
    ...
    %38 = constant %37 {handshake.bb = 4 : ui32, handshake.name = "constant10", value = 1 : i32} : <>, <i32>
    %39 = source {handshake.bb = 4 : ui32, handshake.name = "source5"} : <>
    %40 = constant %39 {handshake.bb = 4 : ui32, handshake.name = "constant11", value = 100 : i32} : <>, <i32>
    %41 = addf %35, %35 {fastmath = #arith.fastmath<none>, handshake.bb = 4 : ui32, handshake.name = "addf1"} : <f32>
    %42 = addi %36, %38 {handshake.bb = 4 : ui32, handshake.name = "addi0"} : <i32>
    %43 = cmpi ult, %42, %40 {handshake.bb = 4 : ui32, handshake.name = "cmpi0"} : <i32>
    %trueResult_13, %falseResult_14 = cond_br %43, %42 {handshake.bb = 4 : ui32, handshake.name = "cond_br5"} : <i1>, <i32>
    %trueResult_15, %falseResult_16 = cond_br %43, %41 {handshake.bb = 4 : ui32, handshake.name = "cond_br6"} : <i1>, <f32>
    %trueResult_17, %falseResult_18 = cond_br %43, %result_11 {handshake.bb = 4 : ui32, handshake.name = "cond_br7"} : <i1>, <>
    %44 = merge %falseResult_16 {handshake.bb = 5 : ui32, handshake.name = "merge4"} : <f32>
    %result_19, %index_20 = control_merge [%falseResult_18]  {handshake.bb = 5 : ui32, handshake.name = "control_merge4"} : [<>] to <>, <i1>
    end {handshake.bb = 5 : ui32, handshake.name = "end0"} %44, %memEnd_0, %memEnd, %arg5 : <f32>, <>, <>, <>
  }
}
