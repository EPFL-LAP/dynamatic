module {
  func.func @if_float(%arg0: f32, %arg1: memref<100xf32>, %arg2: memref<100xf32>) -> f32 {
    ...
    %cst_1 = arith.constant {handshake.name = "constant3"} 1.100000e+00 : f32
  ...
  ^bb3:  // pred: ^bb1
    ...
    %12 = arith.divf %1, %cst_1 {handshake.name = "divf0"} : f32
