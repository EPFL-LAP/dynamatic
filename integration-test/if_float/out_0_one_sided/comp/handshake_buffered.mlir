module {
  handshake.func @if_float(%arg0: !handshake.channel<f32>, %arg1: memref<100xf32>, %arg2: memref<100xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x0", "a", "minus_trace", "a_start", "minus_trace_start", "start"], handshake.cfdfcThroughput = #handshake<cfdfcThroughput {"0" = 0.068965517241379309 : f64}>, handshake.cfdfcToBBList = #handshake<cfdfcToBBList {"0" = [1 : ui32]}>, resNames = ["out0", "a_end", "minus_trace_end", "end"]} {
    ...
    %12:4 = fork [4] %11 {handshake.bb = 1 : ui32, handshake.name = "fork15"} : <f32>
    %result, %index = control_merge [%5, %trueResult_9]  {handshake.bb = 1 : ui32, handshake.name = "control_merge0"} : [<>, <>] to <>, <i1>
    %13:2 = fork [2] %result {handshake.bb = 1 : ui32, handshake.name = "fork16"} : <>
    ...
    %19 = buffer %12#1, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer3"} : <f32>
    %20 = buffer %dataResult, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer4"} : <f32>
    %21 = mulf %20, %19 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "mulf0", internal_delay = "2_875333"} : <f32>
    %22 = buffer %12#0, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer2"} : <f32>
    %23 = mulf %22, %16 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "mulf1", internal_delay = "2_875333"} : <f32>
    ...
    %26:7 = fork [7] %25 {handshake.bb = 1 : ui32, handshake.name = "fork48"} : <i1>
    %27 = not %26#6 {handshake.bb = 1 : ui32, handshake.name = "not0"} : <i1>
    %28:2 = fork [2] %27 {handshake.bb = 1 : ui32, handshake.name = "fork49"} : <i1>
    %29 = spec_v2_repeating_init %28#1 {handshake.bb = 1 : ui32, handshake.name = "spec_v2_repeating_init0", initToken = 1 : ui1} : <i1>
    %30 = buffer %29, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer6"} : <i1>
    ...
    %32:4 = fork [4] %31 {handshake.bb = 1 : ui32, handshake.name = "fork50"} : <i1>
    %33 = source {handshake.bb = 1 : ui32, handshake.name = "source6"} : <>
    %34 = constant %33 {handshake.bb = 1 : ui32, handshake.name = "constant0", value = true} : <>, <i1>
    %35 = buffer %32#0, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer7"} : <i1>
    %36 = mux %35 [%28#0, %34] {handshake.bb = 1 : ui32, handshake.name = "mux5"} : <i1>, [<i1>, <i1>] to <i1>
    %37 = buffer %36, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer9"} : <i1>
    %38:6 = fork [6] %37 {handshake.bb = 1 : ui32, handshake.name = "fork51"} : <i1>
    %39 = buffer %82, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer16"} : <>
    %40 = buffer %39, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer17"} : <>
    %41 = passer %40[%38#5] {handshake.bb = 1 : ui32, handshake.name = "passer6"} : <>, <i1>
    ...
    %45 = constant %44 {handshake.bb = 1 : ui32, handshake.name = "constant8", value = 1.100000e+00 : f32} : <>, <f32>
    %46 = mulf %43, %45 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "mulf2", internal_delay = "2_875333"} : <f32>
    ...
    %50 = buffer %52, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer11"} : <i8>
    %51:2 = fork [2] %50 {handshake.bb = 1 : ui32, handshake.name = "fork43"} : <i8>
    ...
    %55 = buffer %57#0, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer12"} : <f32>
    %56 = passer %55[%26#3] {handshake.bb = 1 : ui32, handshake.name = "passer8"} : <f32>, <i1>
    %57:2 = fork [2] %58 {handshake.bb = 1 : ui32, handshake.name = "fork44"} : <f32>
    %58 = merge %12#3 {handshake.bb = 1 : ui32, handshake.name = "merge3"} : <f32>
    %59 = buffer %result_3, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer13"} : <>
    %60:2 = fork [2] %59 {handshake.bb = 1 : ui32, handshake.name = "fork45"} : <>
    ...
    %65 = constant %64 {handshake.bb = 1 : ui32, handshake.name = "constant9", value = 1.100000e+00 : f32} : <>, <f32>
    %addressResult_5, %dataResult_6 = store[%53] %56 {handshake.bb = 1 : ui32, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store0"} : <i7>, <f32>, <i7>, <f32>
    %66 = divf %57#1, %65 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "divf0", internal_delay = "3_812000"} : <f32>
    %67 = buffer %26#2, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer5"} : <i1>
    ...
    %74 = buffer %32#2, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer8"} : <i1>
    %75 = buffer %47, bufferType = FIFO_BREAK_NONE, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer10"} : <f32>
    %76 = mux %74 [%75, %68] {handshake.bb = 1 : ui32, handshake.name = "mux2"} : <i1>, [<f32>, <f32>] to <f32>
    %77 = buffer %76, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer14"} : <f32>
    %78:2 = fork [2] %77 {handshake.bb = 1 : ui32, handshake.name = "fork8"} : <f32>
    %79 = mux %32#3 [%48, %70] {handshake.bb = 1 : ui32, handshake.name = "mux3"} : <i1>, [<i8>, <i8>] to <i8>
    %80 = buffer %79, bufferType = ONE_SLOT_BREAK_R, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer15"} : <i8>
    %81 = extsi %80 {handshake.bb = 1 : ui32, handshake.name = "extsi5"} : <i8> to <i9>
    %82 = mux %32#1 [%49, %72] {handshake.bb = 1 : ui32, handshake.name = "mux4"} : <i1>, [<>, <>] to <>
    %83 = source {handshake.bb = 1 : ui32, handshake.name = "source4"} : <>
    %84 = constant %83 {handshake.bb = 1 : ui32, handshake.name = "constant4", value = 1 : i2} : <>, <i2>
    %85 = extsi %84 {handshake.bb = 1 : ui32, handshake.name = "extsi6"} : <i2> to <i9>
    %86 = source {handshake.bb = 1 : ui32, handshake.name = "source5"} : <>
    %87 = constant %86 {handshake.bb = 1 : ui32, handshake.name = "constant12", value = 100 : i8} : <>, <i8>
    %88 = extsi %87 {handshake.bb = 1 : ui32, handshake.name = "extsi7"} : <i8> to <i9>
    %89 = passer %90[%38#4] {handshake.bb = 1 : ui32, handshake.name = "passer13"} : <f32>, <i1>
    %90 = addf %78#0, %78#1 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "addf1", internal_delay = "2_922000"} : <f32>
    %91 = buffer %93, bufferType = ONE_SLOT_BREAK_DV, numSlots = 1 {debugCounter = false, handshake.bb = 1 : ui32, handshake.name = "buffer18"} : <i9>
    %92:2 = fork [2] %91 {handshake.bb = 1 : ui32, handshake.name = "fork46"} : <i9>
    %93 = addi %81, %85 {handshake.bb = 1 : ui32, handshake.name = "addi0"} : <i9>
    %94 = passer %95[%38#3] {handshake.bb = 1 : ui32, handshake.name = "passer14"} : <i8>, <i1>
    %95 = trunci %92#0 {handshake.bb = 1 : ui32, handshake.name = "trunci2"} : <i9> to <i8>
    %96 = passer %99#0[%38#2] {handshake.bb = 1 : ui32, handshake.name = "passer15"} : <i1>, <i1>
    %97 = passer %99#1[%38#1] {handshake.bb = 1 : ui32, handshake.name = "passer16"} : <i1>, <i1>
    %98 = passer %99#2[%38#0] {handshake.bb = 1 : ui32, handshake.name = "passer17"} : <i1>, <i1>
    %99:3 = fork [3] %100 {handshake.bb = 1 : ui32, handshake.name = "fork47"} : <i1>
    %100 = cmpi ult, %92#1, %88 {handshake.bb = 1 : ui32, handshake.name = "cmpi0"} : <i9>
    ...
    %trueResult_7, %falseResult_8 = cond_br %97, %89 {handshake.bb = 1 : ui32, handshake.name = "cond_br6"} : <i1>, <f32>
