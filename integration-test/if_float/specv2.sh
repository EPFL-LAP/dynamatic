...
# Baseline
python3 experimental/tools/integration/run_gamma_integration.py if_float --baseline --out out_baseline --cp 5.00
...
python3 experimental/tools/integration/run_gamma_integration.py if_float --branch-bb=1 --merge-bb=4 --prioritized-side 1 --out out_1_two_sided
python3 experimental/tools/integration/run_gamma_integration.py if_float --branch-bb=1 --merge-bb=4 --prioritized-side 1 --one-sided --out out_1_one_sided
