module {
  func.func @if_float(%arg0: f32 {handshake.arg_name = "x0"}, %arg1: memref<100xf32> {handshake.arg_name = "a"}, %arg2: memref<100xf32> {handshake.arg_name = "minus_trace"}) -> f32 {
    ...
    %cst = arith.constant 1.100000e+00 : f32
    %cst_0 = arith.constant 0.000000e+00 : f32
    %cst_1 = arith.constant -0.899999976 : f32
  ...
  ^bb1(%0: i32, %1: f32):  // 2 preds: ^bb0, ^bb4
    ...
    %6 = arith.mulf %1, %cst_1 {handshake.name = "mulf1"} : f32
  ...
  ^bb2:  // pred: ^bb1
    %9 = arith.mulf %1, %cst {handshake.name = "mulf2"} : f32
  ...
  ^bb3:  // pred: ^bb1
    ...
    %12 = arith.divf %1, %cst {handshake.name = "divf0"} : f32
