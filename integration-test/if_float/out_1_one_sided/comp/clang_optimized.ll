; ModuleID = '/home/shundroid/dynamatic/integration-test/if_float/out_1_one_sided/comp/clang_optnone_removed.ll'
...
for.end:                                          ; preds = %for.body
  %call2 = call float @if_float(float noundef 1.000000e+02, ptr noundef nonnull %a, ptr noundef nonnull %minus_trace)
  ret i32 0
}
