module {
  handshake.func @if_float(%arg0: !handshake.channel<f32>, %arg1: memref<100xf32>, %arg2: memref<100xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x0", "a", "minus_trace", "a_start", "minus_trace_start", "start"], resNames = ["out0", "a_end", "minus_trace_end", "end"]} {
    ...
    %memEnd = mem_controller[%arg2 : memref<100xf32>] %arg4 (%45, %addressResult_5, %dataResult_6) %70#1 {connectedBlocks = [3 : i32], handshake.name = "mem_controller2"} :    (!handshake.channel<i32>, !handshake.channel<i7>, !handshake.channel<f32>) -> ()
    %outputs, %memEnd_0 = mem_controller[%arg1 : memref<100xf32>] %arg3 (%addressResult) %70#0 {connectedBlocks = [1 : i32], handshake.name = "mem_controller3"} :    (!handshake.channel<i7>) -> !handshake.channel<f32>
    ...
    %21:7 = fork [7] %20 {handshake.bb = 1 : ui32, handshake.name = "fork17"} : <i1>
    %22 = not %21#6 {handshake.bb = 1 : ui32, handshake.name = "not0"} : <i1>
    %23:3 = fork [3] %22 {handshake.bb = 1 : ui32, handshake.name = "fork18"} : <i1>
    %24 = passer %7#2[%21#5] {handshake.bb = 1 : ui32, handshake.name = "passer0"} : <i8>, <i1>
    %25 = passer %7#1[%23#2] {handshake.bb = 1 : ui32, handshake.name = "passer1"} : <i8>, <i1>
    %26 = passer %10#3[%21#4] {handshake.bb = 1 : ui32, handshake.name = "passer2"} : <f32>, <i1>
    %27 = passer %10#2[%23#1] {handshake.bb = 1 : ui32, handshake.name = "passer3"} : <f32>, <i1>
    %28 = passer %11#1[%21#3] {handshake.bb = 1 : ui32, handshake.name = "passer4"} : <>, <i1>
    ...
    %33 = constant %32 {handshake.bb = 2 : ui32, handshake.name = "constant8", value = 1.100000e+00 : f32} : <>, <f32>
    %34 = mulf %31, %33 {fastmath = #arith.fastmath<none>, handshake.bb = 2 : ui32, handshake.name = "mulf2"} : <f32>
    ...
    %47 = constant %46 {handshake.bb = 3 : ui32, handshake.name = "constant9", value = 1.100000e+00 : f32} : <>, <f32>
    ...
    %48 = divf %42#1, %47 {fastmath = #arith.fastmath<none>, handshake.bb = 3 : ui32, handshake.name = "divf0"} : <f32>
    ...
    %52 = mux %21#1 [%35, %49] {handshake.bb = 4 : ui32, handshake.name = "mux2"} : <i1>, [<f32>, <f32>] to <f32>
    %53:2 = fork [2] %52 {handshake.bb = 4 : ui32, handshake.name = "fork8"} : <f32>
    %54 = mux %21#0 [%36, %50] {handshake.bb = 4 : ui32, handshake.name = "mux3"} : <i1>, [<i8>, <i8>] to <i8>
    %55 = extsi %54 {handshake.bb = 4 : ui32, handshake.name = "extsi5"} : <i8> to <i9>
    %56 = mux %21#2 [%37, %51] {handshake.bb = 4 : ui32, handshake.name = "mux4"} : <i1>, [<>, <>] to <>
    %57 = source {handshake.bb = 4 : ui32, handshake.name = "source4"} : <>
    %58 = constant %57 {handshake.bb = 4 : ui32, handshake.name = "constant4", value = 1 : i2} : <>, <i2>
    %59 = extsi %58 {handshake.bb = 4 : ui32, handshake.name = "extsi6"} : <i2> to <i9>
    %60 = source {handshake.bb = 4 : ui32, handshake.name = "source5"} : <>
    %61 = constant %60 {handshake.bb = 4 : ui32, handshake.name = "constant12", value = 100 : i8} : <>, <i8>
    %62 = extsi %61 {handshake.bb = 4 : ui32, handshake.name = "extsi7"} : <i8> to <i9>
    %63 = addf %53#0, %53#1 {fastmath = #arith.fastmath<none>, handshake.bb = 4 : ui32, handshake.name = "addf1"} : <f32>
    %64 = addi %55, %59 {handshake.bb = 4 : ui32, handshake.name = "addi0"} : <i9>
    %65:2 = fork [2] %64 {handshake.bb = 4 : ui32, handshake.name = "fork10"} : <i9>
    %66 = trunci %65#0 {handshake.bb = 4 : ui32, handshake.name = "trunci2"} : <i9> to <i8>
    %67 = cmpi ult, %65#1, %62 {handshake.bb = 4 : ui32, handshake.name = "cmpi0"} : <i9>
    %68:3 = fork [3] %67 {handshake.bb = 4 : ui32, handshake.name = "fork11"} : <i1>
    %trueResult, %falseResult = cond_br %68#0, %66 {handshake.bb = 4 : ui32, handshake.name = "cond_br5"} : <i1>, <i8>
    sink %falseResult {handshake.name = "sink2"} : <i8>
    %trueResult_7, %falseResult_8 = cond_br %68#1, %63 {handshake.bb = 4 : ui32, handshake.name = "cond_br6"} : <i1>, <f32>
    %trueResult_9, %falseResult_10 = cond_br %68#2, %56 {handshake.bb = 4 : ui32, handshake.name = "cond_br7"} : <i1>, <>
    %69 = merge %falseResult_8 {handshake.bb = 5 : ui32, handshake.name = "merge4"} : <f32>
    ...
    %70:2 = fork [2] %result_11 {handshake.bb = 5 : ui32, handshake.name = "fork12"} : <>
    end {handshake.bb = 5 : ui32, handshake.name = "end0"} %69, %memEnd_0, %memEnd, %0#1 : <f32>, <>, <>, <>
  }
}
