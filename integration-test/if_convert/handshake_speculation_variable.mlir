module {
  handshake.func @if_convert(%arg0: memref<200xi32>, %arg1: memref<200xi32>, %arg2: !handshake.control<>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["a", "b", "a_start", "b_start", "start"], resNames = ["a_end", "b_end", "end"]} {
    ...
    %24:5 = fork [5] %23 {handshake.bb = 2 : ui32, handshake.name = "fork25"} : <i1>
    %25 = andi %31, %28#0 {handshake.bb = 2 : ui32, handshake.name = "andi1"} : <i1>
    %26:3 = fork [3] %25 {handshake.bb = 2 : ui32, handshake.name = "fork26"} : <i1>
    %27 = spec_v2_resolver %30#5, %24#4 {handshake.bb = 2 : ui32, handshake.name = "spec_v2_resolver0"} : <i1>
    %28:9 = fork [9] %27 {handshake.bb = 2 : ui32, handshake.name = "fork27"} : <i1>
    %29 = passer %30#6[%26#0] {handshake.bb = 2 : ui32, handshake.name = "passer0"} : <i1>, <i1>
    %30:7 = fork [7] %17 {handshake.bb = 2 : ui32, handshake.name = "fork28"} : <i1>
    %31 = not %30#0 {handshake.bb = 2 : ui32, handshake.name = "not0"} : <i1>
    %32 = passer %67[%28#6] {handshake.bb = 2 : ui32, handshake.name = "passer1"} : <i8>, <i1>
    %33 = passer %32[%38] {handshake.bb = 2 : ui32, handshake.name = "passer2"} : <i8>, <i1>
    %34 = passer %8#1[%28#5] {handshake.bb = 2 : ui32, handshake.name = "passer3"} : <i32>, <i1>
    sink %34 {handshake.name = "sink2"} : <i32>
    %35 = passer %30#1[%28#4] {handshake.bb = 2 : ui32, handshake.name = "passer4"} : <i1>, <i1>
    sink %35 {handshake.name = "sink3"} : <i1>
    %36 = passer %30#2[%28#3] {handshake.bb = 2 : ui32, handshake.name = "passer5"} : <i1>, <i1>
    %37 = passer %30#3[%28#2] {handshake.bb = 2 : ui32, handshake.name = "passer6"} : <i1>, <i1>
    %38 = passer %30#4[%28#1] {handshake.bb = 2 : ui32, handshake.name = "passer7"} : <i1>, <i1>
    ...
    %42 = passer %53#0[%28#7] {handshake.bb = 2 : ui32, handshake.name = "passer10"} : <i32>, <i1>
    %43 = passer %54[%28#8] {handshake.bb = 2 : ui32, handshake.name = "passer11"} : <i32>, <i1>
    %44 = passer %66#1[%24#3] {handshake.bb = 2 : ui32, handshake.name = "passer12"} : <i32>, <i1>
    %45 = passer %68[%24#2] {handshake.bb = 2 : ui32, handshake.name = "passer13"} : <i32>, <i1>
    %46 = passer %41#2[%24#1] {handshake.bb = 2 : ui32, handshake.name = "passer14"} : <>, <i1>
    %47 = passer %41#0[%26#2] {handshake.bb = 2 : ui32, handshake.name = "passer15"} : <>, <i1>
    %48 = passer %8#2[%26#1] {handshake.bb = 2 : ui32, handshake.name = "passer16"} : <i32>, <i1>
    ...
    %addressResult_1, %dataResult_2 = store[%33] %39 {handshake.bb = 2 : ui32, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store1"} : <i8>, <i32>, <i8>, <i32>
