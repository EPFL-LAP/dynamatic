module {
  func.func @if_convert(%arg0: memref<20xi32> {handshake.arg_name = "a"}, %arg1: memref<20xi32> {handshake.arg_name = "b"}) {
    %c1_i32 = arith.constant {handshake.name = "constant0"} 1 : i32
    %c10000_i32 = arith.constant {handshake.name = "constant1"} 10000 : i32
    %c19_i32 = arith.constant {handshake.name = "constant2"} 19 : i32
  ...
  ^bb1(%0: i32):  // 2 preds: ^bb0, ^bb2
    ...
    %2 = memref.load %arg0[%1] {handshake.name = "load0"} : memref<20xi32>
    ...
    memref.store %c1_i32, %arg1[%8] {handshake.deps = #handshake<deps[<"store0" (0)>]>, handshake.name = "store0"} : memref<20xi32>
    %9 = arith.cmpi slt, %7, %c19_i32 {handshake.name = "cmpi1"} : i32
