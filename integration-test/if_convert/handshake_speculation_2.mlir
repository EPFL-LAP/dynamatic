module {
  handshake.func @if_convert(%arg0: memref<200xi32>, %arg1: memref<200xi32>, %arg2: !handshake.control<>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["a", "b", "a_start", "b_start", "start"], resNames = ["a_end", "b_end", "end"]} {
    ...
    %memEnd = mem_controller[%arg1 : memref<200xi32>] %arg3 (%38, %addressResult_1, %dataResult_2) %74#1 {connectedBlocks = [2 : i32], handshake.name = "mem_controller2"} :    (!handshake.channel<i32>, !handshake.channel<i8>, !handshake.channel<i32>) -> ()
    ...
    %7 = mux %19#2 [%4, %42] {handshake.bb = 2 : ui32, handshake.name = "mux2"} : <i1>, [<i32>, <i32>] to <i32>
    ...
    %20 = spec_v2_repeating_init %26 {handshake.bb = 2 : ui32, handshake.name = "spec_v2_repeating_init0", initToken = 1 : ui1} : <i1>
    %21:5 = fork [5] %20 {handshake.bb = 2 : ui32, handshake.name = "fork25"} : <i1>
    %22 = andi %29, %25#0 {handshake.bb = 2 : ui32, handshake.name = "andi1"} : <i1>
    %23:2 = fork [2] %22 {handshake.bb = 2 : ui32, handshake.name = "fork26"} : <i1>
    %24 = spec_v2_resolver %28#5, %21#0 {handshake.bb = 2 : ui32, handshake.name = "spec_v2_resolver0"} : <i1>
    %25:10 = fork [10] %24 {handshake.bb = 2 : ui32, handshake.name = "fork27"} : <i1>
    %26 = spec_v2_repeating_init %27 {handshake.bb = 2 : ui32, handshake.name = "spec_v2_repeating_init1", initToken = 1 : ui1} : <i1>
    %27 = passer %28#6[%25#9] {handshake.bb = 2 : ui32, handshake.name = "passer0"} : <i1>, <i1>
    %28:7 = fork [7] %17 {handshake.bb = 2 : ui32, handshake.name = "fork28"} : <i1>
    %29 = not %28#0 {handshake.bb = 2 : ui32, handshake.name = "not0"} : <i1>
    %30 = passer %33[%37] {handshake.bb = 2 : ui32, handshake.name = "passer1"} : <i8>, <i1>
    %31 = passer %8#1[%25#1] {handshake.bb = 2 : ui32, handshake.name = "passer2"} : <i32>, <i1>
    sink %31 {handshake.name = "sink2"} : <i32>
    %32 = passer %40[%36] {handshake.bb = 2 : ui32, handshake.name = "passer3"} : <i32>, <i1>
    %33 = passer %65[%25#4] {handshake.bb = 2 : ui32, handshake.name = "passer4"} : <i8>, <i1>
    %34 = passer %28#1[%25#5] {handshake.bb = 2 : ui32, handshake.name = "passer5"} : <i1>, <i1>
    sink %34 {handshake.name = "sink3"} : <i1>
    %35 = passer %28#2[%25#6] {handshake.bb = 2 : ui32, handshake.name = "passer6"} : <i1>, <i1>
    %36 = passer %28#3[%25#7] {handshake.bb = 2 : ui32, handshake.name = "passer7"} : <i1>, <i1>
    %37 = passer %28#4[%25#8] {handshake.bb = 2 : ui32, handshake.name = "passer8"} : <i1>, <i1>
    %38 = passer %41[%35] {handshake.bb = 2 : ui32, handshake.name = "passer9"} : <i32>, <i1>
    %39:3 = fork [3] %11 {handshake.bb = 2 : ui32, handshake.name = "fork21"} : <>
    %40 = passer %51#0[%25#3] {handshake.bb = 2 : ui32, handshake.name = "passer10"} : <i32>, <i1>
    %41 = passer %52[%25#2] {handshake.bb = 2 : ui32, handshake.name = "passer11"} : <i32>, <i1>
    %42 = passer %64#1[%21#1] {handshake.bb = 2 : ui32, handshake.name = "passer12"} : <i32>, <i1>
    %43 = passer %66[%21#2] {handshake.bb = 2 : ui32, handshake.name = "passer13"} : <i32>, <i1>
    %44 = passer %39#2[%21#3] {handshake.bb = 2 : ui32, handshake.name = "passer14"} : <>, <i1>
    %45 = passer %39#0[%23#1] {handshake.bb = 2 : ui32, handshake.name = "passer15"} : <>, <i1>
    %46 = passer %8#2[%23#0] {handshake.bb = 2 : ui32, handshake.name = "passer16"} : <i32>, <i1>
    %47 = trunci %10#2 {handshake.bb = 2 : ui32, handshake.name = "trunci0"} : <i32> to <i8>
    %48 = constant %39#1 {handshake.bb = 2 : ui32, handshake.name = "constant10", value = 1 : i2} : <>, <i2>
    ...
    %addressResult_1, %dataResult_2 = store[%30] %32 {handshake.bb = 2 : ui32, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store1"} : <i8>, <i32>, <i8>, <i32>
