...
# Baseline
python3 experimental/tools/integration/run_specv2_integration.py sparse_dataspec_transformed --baseline --out out_baseline --cp 10.00 --transformed-code sparse_dataspec_modified.c

# Spec v1
python3 experimental/tools/integration/run_adapted_spec_integration.py sparse_dataspec_transformed --out out_v1 --cp 10.00 --transformed-code sparse_dataspec_modified.c
...
python3 experimental/tools/integration/run_specv2_integration.py sparse_dataspec_transformed --n 8 --out out_8 --cp 10.00 --resolver --transformed-code sparse_dataspec_modified.c
