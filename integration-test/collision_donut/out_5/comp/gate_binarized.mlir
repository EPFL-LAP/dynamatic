module {
  ...
  ^bb2:  // pred: ^bb1
    ...
    cf.cond_br %11, ^bb5(%0, %c-2_i32 : i32, i32), ^bb3 {handshake.name = "cond_br1"}
  ^bb3:  // pred: ^bb2
  ...
  ^bb4(%14: i32, %15: i32):  // 2 preds: ^bb1, ^bb3
    cf.br ^bb5(%14, %15 : i32, i32) {handshake.name = "br1"}
  ^bb5(%16: i32, %17: i32):  // 2 preds: ^bb2, ^bb4
    %c1_i32_1 = arith.constant {handshake.name = "constant14"} 1 : i32
    %18 = arith.shli %16, %c1_i32_1 {handshake.name = "shli0"} : i32
    %19 = arith.andi %18, %17 {handshake.name = "andi0"} : i32
