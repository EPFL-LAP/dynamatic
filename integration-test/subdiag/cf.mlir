module {
  func.func @subdiag(%arg0: memref<1000xf32> {handshake.arg_name = "d"}, %arg1: memref<1000xf32> {handshake.arg_name = "e"}) -> i32 {
  ...
  ^bb1(%0: i32):  // 2 preds: ^bb0, ^bb2
    ...
    %5 = memref.load %arg0[%4] {handshake.name = "load1"} : memref<1000xf32>
    %6 = arith.addf %2, %5 {handshake.name = "addf0"} : f32
    %7 = memref.load %arg1[%4] {handshake.name = "load2"} : memref<1000xf32>
