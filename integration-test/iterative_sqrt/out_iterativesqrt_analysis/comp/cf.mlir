module {
  ...
  ^bb1(%1: i32, %2: i32, %3: i1, %4: i32, %5: i1):  // 2 preds: ^bb0, ^bb10
    ...
    cf.cond_br %7, ^bb2(%1, %3, %4, %2 : i32, i1, i32, i32), ^bb11 {handshake.name = "cond_br0"}
  ^bb2(%8: i32, %9: i1, %10: i32, %11: i32):  // pred: ^bb1
    ...
    cf.cond_br %16, ^bb3, ^bb8 {handshake.name = "cond_br1"}
  ^bb3:  // pred: ^bb2
    cf.cond_br %19, ^bb4, ^bb5 {handshake.name = "cond_br2"}
  ^bb4:  // pred: ^bb3
    %20 = arith.addi %13, %c1_i32 {handshake.name = "addi1"} : i32
    cf.br ^bb6(%8, %20 : i32, i32) {handshake.name = "br1"}
  ^bb5:  // pred: ^bb3
    %21 = arith.addi %13, %c-1_i32 {handshake.name = "addi2"} : i32
    cf.br ^bb6(%21, %11 : i32, i32) {handshake.name = "br2"}
  ^bb6(%22: i32, %23: i32):  // 2 preds: ^bb4, ^bb5
    cf.br ^bb7 {handshake.name = "br3"}
  ^bb7:  // pred: ^bb6
    cf.br ^bb9(%22, %23 : i32, i32) {handshake.name = "br4"}
  ^bb8:  // pred: ^bb2
    cf.br ^bb9(%8, %11 : i32, i32) {handshake.name = "br5"}
  ^bb9(%24: i32, %25: i32):  // 2 preds: ^bb7, ^bb8
    cf.br ^bb10 {handshake.name = "br6"}
  ^bb10:  // pred: ^bb9
    cf.br ^bb1(%24, %25, %17, %18, %16 : i32, i32, i1, i32, i1) {handshake.name = "br7"}
  ^bb11:  // pred: ^bb1
    %26 = arith.select %3, %1, %4 {handshake.name = "select1"} : i32
