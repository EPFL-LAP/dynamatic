...
Operation: %0:4 = "handshake.lsq"(%arg0, %arg2, %26#1, %32#0, %35#1, %39#0, %43#1, %50#0, %52#0, %52#1, %55#0) {groupSizes = [1 : i32, 1 : i32, 2 : i32], handshake.name = "lsq1"} : (memref<10xi32>, !handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>) -> (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>)
  ...
  Operand #2: Produced by: %26:2 = "handshake.lazy_fork"(%9) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
  ...
  Operand #4: Produced by: %35:2 = "handshake.lazy_fork"(%6) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
...
----
Operation: %7 = "handshake.merge"(%35#0, %35#0, %7, %arg3) {nphi} : (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) -> !handshake.control<>
  Operand #0: Produced by: %35:2 = "handshake.lazy_fork"(%6) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
  Operand #1: Produced by: %35:2 = "handshake.lazy_fork"(%6) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
  Operand #2: Produced by: %7 = "handshake.merge"(%35#0, %35#0, %7, %arg3) {nphi} : (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) -> !handshake.control<>
  Operand #3: null (function argument or constant?)
----
Operation: %8 = "handshake.merge"(%26#0, %26#0, %26#0, %arg3) {nphi} : (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) -> !handshake.control<>
  Operand #0: Produced by: %26:2 = "handshake.lazy_fork"(%9) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
  Operand #1: Produced by: %26:2 = "handshake.lazy_fork"(%9) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
  Operand #2: Produced by: %26:2 = "handshake.lazy_fork"(%9) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
  Operand #3: null (function argument or constant?)
----
...
-- Block #2 --
Operation: %26:2 = "handshake.lazy_fork"(%9) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>)
...
-- Block #3 --
Operation: %35:2 = "handshake.lazy_fork"(%6) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>)
...
-- Block #4 --
Operation: %42 = "handshake.join"(%26#0, %35#0) : (!handshake.control<>, !handshake.control<>) -> !handshake.control<>
  Operand #0: Produced by: %26:2 = "handshake.lazy_fork"(%9) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
  Operand #1: Produced by: %35:2 = "handshake.lazy_fork"(%6) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>) (from different block → possible phi needed)
----
Operation: %43:2 = "handshake.lazy_fork"(%42) : (!handshake.control<>) -> (!handshake.control<>, !handshake.control<>)
  Operand #0: Produced by: %42 = "handshake.join"(%26#0, %35#0) : (!handshake.control<>, !handshake.control<>) -> !handshake.control<>
----
