...
entity handshake_lsq_lsq1 is
	port(
		...
		io_storeAddr : out std_logic_vector(3 downto 0);
		io_storeEn : out std_logic;
		io_loadData : in std_logic_vector(31 downto 0);
		io_loadAddr : out std_logic_vector(3 downto 0);
		...
		io_ldAddr_0_bits : in std_logic_vector(3 downto 0);
		io_ldAddr_1_bits : in std_logic_vector(3 downto 0);
		io_ldAddr_2_bits : in std_logic_vector(3 downto 0);
		...
		io_stAddr_0_bits : in std_logic_vector(3 downto 0);
