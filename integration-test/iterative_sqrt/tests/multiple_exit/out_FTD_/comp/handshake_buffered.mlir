module {
  handshake.func @multiple_exit(%arg0: memref<10xi32>, %arg1: !handshake.control<>, %arg2: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["arr", "arr_start", "start"], cfg.edges = "[0,1][2,3,1,cmpi1][4,1][1,2,5,andi0][3,4,1,cmpi3]", resNames = ["out0", "arr_end", "end"]} {
    ...
    %1 = buffer %result_30 {handshake.name = "buffer33", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    ...
    %10 = br %0#2 {handshake.bb = 0 : ui32, handshake.name = "br1"} : <>
    %11 = buffer %27 {handshake.bb = 1 : ui32, handshake.name = "buffer10", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i32>
    %12 = buffer %11 {handshake.bb = 1 : ui32, handshake.name = "buffer11", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_R", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 1}>}} : <i32>
    %trueResult, %falseResult = cond_br %56#4, %12 {handshake.bb = 1 : ui32, handshake.name = "cond_br25"} : <i1>, <i32>
    sink %falseResult {handshake.name = "sink0"} : <i32>
    %13 = buffer %24 {handshake.bb = 1 : ui32, handshake.name = "buffer8", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i1>
    %14 = buffer %13 {handshake.bb = 1 : ui32, handshake.name = "buffer9", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_R", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 1}>}} : <i1>
    %trueResult_0, %falseResult_1 = cond_br %56#5, %14 {handshake.bb = 1 : ui32, handshake.name = "cond_br26"} : <i1>, <i1>
    sink %falseResult_1 {handshake.name = "sink1"} : <i1>
    %15 = buffer %23 {handshake.bb = 1 : ui32, handshake.name = "buffer6", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i2>
    %16 = buffer %15 {handshake.bb = 1 : ui32, handshake.name = "buffer7", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_R", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 1}>}} : <i2>
    %trueResult_2, %falseResult_3 = cond_br %56#6, %16 {handshake.bb = 1 : ui32, handshake.name = "cond_br27"} : <i1>, <i2>
    sink %falseResult_3 {handshake.name = "sink2"} : <i2>
    %17 = buffer %21 {handshake.bb = 1 : ui32, handshake.name = "buffer2", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i1>
    %18 = buffer %17 {handshake.bb = 1 : ui32, handshake.name = "buffer3", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_R", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 1}>}} : <i1>
    %trueResult_4, %falseResult_5 = cond_br %56#7, %18 {handshake.bb = 1 : ui32, handshake.name = "cond_br28"} : <i1>, <i1>
    sink %falseResult_5 {handshake.name = "sink3"} : <i1>
    %result, %index = control_merge [%10, %falseResult_11, %falseResult_21, %103]  {handshake.bb = 1 : ui32, handshake.name = "control_merge0"} : [<>, <>, <>, <>] to <>, <i2>
    ...
    %57 = buffer %result {handshake.bb = 1 : ui32, handshake.name = "buffer0", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    ...
    %59 = buffer %result_8 {handshake.bb = 2 : ui32, handshake.name = "buffer24", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    ...
    %trueResult_10, %falseResult_11 = cond_br %67#0, %68 {handshake.bb = 2 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0, 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br20"} : <i1>, <>
    %trueResult_12, %falseResult_13 = cond_br %56#2, %40#0 {handshake.bb = 3 : ui32, handshake.name = "cond_br29"} : <i1>, <i2>
    %69 = extsi %falseResult_13 {handshake.bb = 3 : ui32, handshake.name = "extsi8"} : <i2> to <i3>
    %trueResult_14, %falseResult_15 = cond_br %56#1, %44#0 {handshake.bb = 3 : ui32, handshake.name = "cond_br30"} : <i1>, <i1>
    ...
    %70 = buffer %result_16 {handshake.bb = 3 : ui32, handshake.name = "buffer27", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    ...
    %83 = andi %82#1, %trueResult_14 {handshake.bb = 3 : ui32, handshake.name = "andi1"} : <i1>
    %84 = select %80[%74, %trueResult_12] {handshake.bb = 3 : ui32, handshake.name = "select0"} : <i1>, <i2>
    ...
    %trueResult_20, %falseResult_21 = cond_br %82#0, %85 {handshake.bb = 3 : ui32, handshake.bufProps = #handshake<bufProps{"1": [0,inf], [1,inf], 0, 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "cond_br23"} : <i1>, <>
    %trueResult_22, %falseResult_23 = cond_br %56#0, %48#0 {handshake.bb = 4 : ui32, handshake.name = "cond_br31"} : <i1>, <i32>
    sink %falseResult_23 {handshake.name = "sink7"} : <i32>
    %86:5 = fork [5] %trueResult_22 {handshake.bb = 4 : ui32, handshake.name = "fork12"} : <i32>
    ...
    %91 = buffer %result_24 {handshake.bb = 4 : ui32, handshake.name = "buffer30", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <>
    ...
    %103 = br %102 {handshake.bb = 4 : ui32, handshake.bufProps = #handshake<bufProps{"0": [0,inf], [1,inf], 0, 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "br2"} : <>
    ...
    %104 = source {handshake.bb = 5 : ui32, handshake.name = "source12"} : <>
    %105 = constant %104 {handshake.bb = 5 : ui32, handshake.name = "constant16", value = 2 : i3} : <>, <i3>
    %106 = select %falseResult_15[%105, %69] {handshake.bb = 5 : ui32, handshake.name = "select1"} : <i1>, <i3>
    %107 = extsi %106 {handshake.bb = 5 : ui32, handshake.name = "extsi9"} : <i3> to <i32>
