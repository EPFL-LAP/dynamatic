module {
  handshake.func @nested_loop(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: memref<1000xi32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["a", "b", "c", "a_start", "b_start", "c_start", "start"], resNames = ["a_end", "b_end", "c_end", "end"]} {
    ...
    %13 = mux %37#3 [%12, %53] {handshake.bb = 2 : ui32, handshake.name = "mux1"} : <i1>, [<i32>, <i32>] to <i32>
    ...
    %18 = mux %37#2 [%4#1, %55] {handshake.bb = 2 : ui32, handshake.name = "mux2"} : <i1>, [<i2>, <i2>] to <i2>
    ...
    %addressResult_5, %dataResult_6 = store[%51] %52 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[<"store1" (0)>]>, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store1"} : <i10>, <i32>, <i10>, <i32>
    ...
    %51 = passer %34[%46#3] {handshake.bb = 2 : ui32, handshake.name = "passer1"} : <i10>, <i1>
    %52 = passer %33#0[%46#2] {handshake.bb = 2 : ui32, handshake.name = "passer2"} : <i32>, <i1>
    %53 = passer %49[%42#3] {handshake.bb = 2 : ui32, handshake.name = "passer3"} : <i32>, <i1>
    %54:2 = fork [2] %18 {handshake.bb = 2 : ui32, handshake.name = "fork16"} : <i2>
    %55 = passer %54#1[%42#2] {handshake.bb = 2 : ui32, handshake.name = "passer4"} : <i2>, <i1>
    %56 = passer %54#0[%44#2] {handshake.bb = 2 : ui32, handshake.name = "passer5"} : <i2>, <i1>
    ...
    %61 = extsi %56 {handshake.bb = 3 : ui32, handshake.name = "extsi12"} : <i2> to <i3>
