module {
  ...
  ^bb1(%0: index):  // 2 preds: ^bb0, ^bb3
    %c400_i32 = arith.constant {handshake.name = "constant7"} 400 : i32
    %c0_i32 = arith.constant {handshake.name = "constant8"} 0 : i32
  ...
  ^bb2(%3: i32):  // 2 preds: ^bb1, ^bb2
    ...
    %c1000_i32 = arith.constant {handshake.name = "constant10"} 1000 : i32
    %4 = arith.index_cast %3 {handshake.name = "index_cast1"} : i32 to index
    %5 = memref.load %arg0[%4] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load0"} : memref<1000xi32>
    %6 = memref.load %arg1[%4] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load1"} : memref<1000xi32>
    ...
    memref.store %7, %arg2[%9] {handshake.deps = #handshake<deps[<"store0" (0)>]>, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store0"} : memref<1000xi32>
  ...
  ^bb3:  // pred: ^bb2
    ...
    %c1 = arith.constant {handshake.name = "constant12"} 1 : index
