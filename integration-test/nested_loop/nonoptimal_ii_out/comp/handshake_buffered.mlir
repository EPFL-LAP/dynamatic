module {
  handshake.func @nested_loop(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: memref<1000xi32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["a", "b", "c", "a_start", "b_start", "c_start", "start"], handshake.cfdfcThroughput = #handshake<cfdfcThroughput {"0" = 1.000000e+00 : f64, "1" = 0.16666666666666666 : f64}>, handshake.cfdfcToBBList = #handshake<cfdfcToBBList {"0" = [2 : ui32], "1" = [3 : ui32, 1 : ui32, 2 : ui32]}>, resNames = ["a_end", "b_end", "c_end", "end"]} {
    ...
    %14 = mux %52#3 [%13, %54] {handshake.bb = 2 : ui32, handshake.name = "mux1"} : <i1>, [<i32>, <i32>] to <i32>
    ...
    %20 = mux %52#2 [%5#1, %55] {handshake.bb = 2 : ui32, handshake.name = "mux2"} : <i1>, [<i2>, <i2>] to <i2>
    ...
    %22 = buffer %53 {handshake.bb = 2 : ui32, handshake.name = "buffer13", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i12>
    %23 = mux %21 [%12, %22] {handshake.bb = 2 : ui32, handshake.name = "mux3"} : <i1>, [<i12>, <i12>] to <i12>
    ...
    %27 = mux %52#0 [%7#1, %56] {handshake.bb = 2 : ui32, handshake.name = "mux4"} : <i1>, [<>, <>] to <>
    ...
    %32 = extsi %31 {handshake.bb = 2 : ui32, handshake.name = "extsi3"} : <i2> to <i32>
    %33 = source {handshake.bb = 2 : ui32, handshake.name = "source1"} : <>
    %34 = constant %33 {handshake.bb = 2 : ui32, handshake.name = "constant13", value = 1 : i2} : <>, <i2>
    %35 = extsi %34 {handshake.bb = 2 : ui32, handshake.name = "extsi4"} : <i2> to <i32>
    %36 = source {handshake.bb = 2 : ui32, handshake.name = "source2"} : <>
    %37 = constant %36 {handshake.bb = 2 : ui32, handshake.name = "constant14", value = 1000 : i11} : <>, <i11>
    %38 = extsi %37 {handshake.bb = 2 : ui32, handshake.name = "extsi5"} : <i11> to <i32>
    ...
    %39 = muli %dataResult, %dataResult_4 {handshake.bb = 2 : ui32, handshake.name = "muli1", internal_delay = "1_000000"} : <i32>
    %40:2 = fork [2] %39 {handshake.bb = 2 : ui32, handshake.name = "fork7"} : <i32>
    %41 = buffer %17 {handshake.bb = 2 : ui32, handshake.name = "buffer3", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i10>
    %42 = addi %41, %26 {handshake.bb = 2 : ui32, handshake.name = "addi0", internal_delay = "0_000000"} : <i10>
    %addressResult_5, %dataResult_6 = store[%47] %45 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[<"store1" (0)>]>, handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "store1"} : <i10>, <i32>, <i10>, <i32>
    %43 = cmpi slt, %40#1, %38 {handshake.bb = 2 : ui32, handshake.name = "cmpi0", internal_delay = "0_000000"} : <i32>
    %44 = not %76#0 {handshake.bb = 2 : ui32, handshake.name = "not0"} : <i1>
    %45 = passer %40#0[%75#3] {handshake.bb = 2 : ui32, handshake.name = "passer0"} : <i32>, <i1>
    %46 = buffer %42 {handshake.bb = 2 : ui32, handshake.name = "buffer11", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 4 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i10>
    %47 = passer %46[%75#2] {handshake.bb = 2 : ui32, handshake.name = "passer1"} : <i10>, <i1>
    %48 = buffer %32 {handshake.bb = 2 : ui32, handshake.name = "buffer10", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 4 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i32>
    %49 = passer %48[%75#1] {handshake.bb = 2 : ui32, handshake.name = "passer2"} : <i32>, <i1>
    %50 = buffer %60#5 {handshake.bb = 2 : ui32, handshake.name = "buffer15", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 2 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i1>
    ...
    %53 = passer %25#1[%60#4] {handshake.bb = 2 : ui32, handshake.name = "passer3"} : <i12>, <i1>
    %54 = passer %78[%60#3] {handshake.bb = 2 : ui32, handshake.name = "passer4"} : <i32>, <i1>
    %55 = passer %81#1[%60#2] {handshake.bb = 2 : ui32, handshake.name = "passer5"} : <i2>, <i1>
    %56 = passer %30#2[%60#1] {handshake.bb = 2 : ui32, handshake.name = "passer6"} : <>, <i1>
    %57 = buffer %62 {handshake.bb = 2 : ui32, handshake.name = "buffer16", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i1>
    %58 = buffer %57 {handshake.bb = 2 : ui32, handshake.name = "buffer17", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i1>
    ...
    %61 = buffer %64 {handshake.bb = 2 : ui32, handshake.name = "buffer18", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 2 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i1>
    ...
    %63 = buffer %66 {handshake.bb = 2 : ui32, handshake.name = "buffer19", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 2 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i1>
    ...
    %65 = buffer %68 {handshake.bb = 2 : ui32, handshake.name = "buffer20", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 2 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i1>
    ...
    %67 = buffer %69 {handshake.bb = 2 : ui32, handshake.name = "buffer21", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 2 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i1>
    %68 = spec_v2_repeating_init %67 {handshake.bb = 2 : ui32, handshake.bufProps = #handshake<bufProps{"0": [0,inf], [0,inf], 2, 0.000000e+00, 0.000000e+00, 0.000000e+00}>, handshake.name = "spec_v2_repeating_init4"} : <i1>
    %69 = passer %76#2[%75#4] {handshake.bb = 2 : ui32, handshake.name = "passer7"} : <i1>, <i1>
    %70 = andi %75#0, %44 {handshake.bb = 2 : ui32, handshake.name = "andi0", internal_delay = "0_000000"} : <i1>
    %71 = buffer %70 {handshake.bb = 2 : ui32, handshake.name = "buffer22", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i1>
    %72:2 = fork [2] %71 {handshake.bb = 2 : ui32, handshake.name = "fork20"} : <i1>
    %73 = buffer %60#0 {handshake.bb = 2 : ui32, handshake.name = "buffer14", hw.parameters = {BUFFER_TYPE = "FIFO_BREAK_NONE", NUM_SLOTS = 4 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 0}>}} : <i1>
    %74 = spec_v2_resolver %76#1, %73 {handshake.bb = 2 : ui32, handshake.name = "spec_v2_resolver0"} : <i1>
    %75:5 = fork [5] %74 {handshake.bb = 2 : ui32, handshake.name = "fork21"} : <i1>
    %76:3 = fork [3] %43 {handshake.bb = 2 : ui32, handshake.name = "fork22"} : <i1>
    %77 = buffer %16#3 {handshake.bb = 2 : ui32, handshake.name = "buffer2", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i32>
    %78 = addi %77, %35 {handshake.bb = 2 : ui32, handshake.name = "addi1", internal_delay = "0_000000"} : <i32>
    %79 = buffer %20 {handshake.bb = 2 : ui32, handshake.name = "buffer4", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_DV", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 1, V: 1, R: 0}>}} : <i2>
    %80 = buffer %79 {handshake.bb = 2 : ui32, handshake.name = "buffer5", hw.parameters = {BUFFER_TYPE = "ONE_SLOT_BREAK_R", NUM_SLOTS = 1 : ui32, TIMING = #handshake<timing {D: 0, V: 0, R: 1}>}} : <i2>
    ...
    %83 = passer %82[%72#1] {handshake.bb = 2 : ui32, handshake.name = "passer8"} : <i2>, <i1>
    ...
    %85 = passer %84[%72#0] {handshake.bb = 2 : ui32, handshake.name = "passer9"} : <>, <i1>
