module {
  ...
  ^bb1(%0: i32):  // 2 preds: ^bb0, ^bb1
    ...
    %cst = arith.constant {handshake.name = "constant5"} 1.000000e-03 : f32
    %c998_i32 = arith.constant {handshake.name = "constant6"} 998 : i32
    ...
    %16 = arith.andi %15, %14 {handshake.name = "andi0"} : i1
