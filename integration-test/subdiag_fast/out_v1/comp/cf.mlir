module {
  func.func @subdiag_fast(%arg0: memref<1000xf32>, %arg1: memref<1000xf32>, %arg2: memref<1000xf32>) -> i32 {
    %c0_i32 = arith.constant {handshake.name = "constant0"} 0 : i32
    %c1_i32 = arith.constant {handshake.name = "constant1"} 1 : i32
    %cst = arith.constant {handshake.name = "constant2"} 1.000000e-03 : f32
    %c998_i32 = arith.constant {handshake.name = "constant3"} 998 : i32
    %false = arith.constant {handshake.name = "constant4"} false
  ...
  ^bb1(%0: i32):  // 2 preds: ^bb0, ^bb1
    ...
    %3 = memref.load %arg0[%2] {handshake.name = "load0"} : memref<1000xf32>
    ...
    %7 = memref.load %arg1[%6] {handshake.name = "load1"} : memref<1000xf32>
    ...
    %12 = memref.load %arg2[%11] {handshake.name = "load2"} : memref<1000xf32>
    ...
    %16 = arith.select %15, %14, %false {handshake.name = "select0"} : i1
