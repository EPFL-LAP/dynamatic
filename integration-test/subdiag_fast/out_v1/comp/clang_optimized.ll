; ModuleID = '/home/shundroid/dynamatic/integration-test/subdiag_fast/out_v1/comp/clang_optnone_removed.ll'
...
do.body:                                          ; preds = %do.body, %entry
  %next_i.0 = phi i32 [ 0, %entry ], [ %add4, %do.body ]
  %idxprom = zext i32 %next_i.0 to i64
  %arrayidx = getelementptr inbounds float, ptr %d1, i64 %idxprom
  %0 = load float, ptr %arrayidx, align 4
  %add = add nuw nsw i32 %next_i.0, 1
  %idxprom1 = zext i32 %add to i64
  %arrayidx2 = getelementptr inbounds float, ptr %d2, i64 %idxprom1
  %1 = load float, ptr %arrayidx2, align 4
  %add3 = fadd float %0, %1
  %add4 = add nuw nsw i32 %next_i.0, 1
  %idxprom5 = zext i32 %next_i.0 to i64
  %arrayidx6 = getelementptr inbounds float, ptr %e, i64 %idxprom5
  %2 = load float, ptr %arrayidx6, align 4
  %mul = fmul float %add3, 0x3F50624DE0000000
  %cmp = fcmp ugt float %2, %mul
  %cmp7 = icmp ult i32 %next_i.0, 998
  %3 = select i1 %cmp7, i1 %cmp, i1 false
  br i1 %3, label %do.body, label %do.end, !llvm.loop !6

do.end:                                           ; preds = %do.body
  %next_i.0.lcssa = phi i32 [ %next_i.0, %do.body ]
  ret i32 %next_i.0.lcssa
}
