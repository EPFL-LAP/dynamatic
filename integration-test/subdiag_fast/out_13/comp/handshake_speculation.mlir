module {
  handshake.func @subdiag_fast(%arg0: memref<1000xf32>, %arg1: memref<1000xf32>, %arg2: memref<1000xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["d1", "d2", "e", "d1_start", "d2_start", "e_start", "start"], resNames = ["out0", "d1_end", "d2_end", "e_end", "end"]} {
    ...
    %3 = init %70#3 {handshake.bb = 1 : ui32, handshake.name = "init0", initToken = 0 : ui1} : <i1>
    %4 = init %70#4 {handshake.bb = 1 : ui32, handshake.name = "init1", initToken = 0 : ui1} : <i1>
    ...
    %8 = trunci %79#2 {handshake.bb = 1 : ui32, handshake.name = "trunci2"} : <i11> to <i10>
    %9 = mux %4 [%0#2, %82] {handshake.bb = 1 : ui32, handshake.name = "mux3"} : <i1>, [<>, <>] to <>
    ...
    %16 = andi %77, %14#1 {handshake.bb = 1 : ui32, handshake.name = "andi0"} : <i1>
    %17 = not %14#0 {handshake.bb = 1 : ui32, handshake.name = "not0"} : <i1>
    %18 = passer %19[%74#1] {handshake.bb = 1 : ui32, handshake.name = "passer8"} : <i12>, <i1>
    %19 = extsi %79#3 {handshake.bb = 1 : ui32, handshake.name = "extsi4"} : <i11> to <i12>
    %20 = passer %83#2[%74#0] {handshake.bb = 1 : ui32, handshake.name = "passer3"} : <>, <i1>
    %21 = extsi %79#4 {handshake.bb = 1 : ui32, handshake.name = "extsi5"} : <i11> to <i12>
    ...
    %32 = passer %33[%72#2] {handshake.bb = 1 : ui32, handshake.name = "passer9"} : <i1>, <i1>
    ...
    %70:5 = fork [5] %69 {handshake.bb = 1 : ui32, handshake.name = "fork26"} : <i1>
    ...
    %73 = andi %17, %72#0 {handshake.bb = 1 : ui32, handshake.name = "andi14"} : <i1>
    %74:2 = fork [2] %73 {handshake.bb = 1 : ui32, handshake.name = "fork28"} : <i1>
    %75 = andi %16, %72#1 {handshake.bb = 1 : ui32, handshake.name = "andi15"} : <i1>
    %76:2 = fork [2] %75 {handshake.bb = 1 : ui32, handshake.name = "fork29"} : <i1>
    %77 = not %30#1 {handshake.bb = 1 : ui32, handshake.name = "not1"} : <i1>
    %78 = passer %28#1[%76#0] {handshake.bb = 1 : ui32, handshake.name = "passer5"} : <i12>, <i1>
    %79:5 = fork [5] %5 {handshake.bb = 1 : ui32, handshake.name = "fork30"} : <i11>
    %80 = passer %81[%70#2] {handshake.bb = 1 : ui32, handshake.name = "passer10"} : <i11>, <i1>
    %81 = trunci %28#2 {handshake.bb = 1 : ui32, handshake.name = "trunci3"} : <i12> to <i11>
    %82 = passer %83#1[%70#1] {handshake.bb = 1 : ui32, handshake.name = "passer11"} : <>, <i1>
    %83:3 = fork [3] %9 {handshake.bb = 1 : ui32, handshake.name = "fork31"} : <>
    %84 = passer %83#0[%76#1] {handshake.bb = 1 : ui32, handshake.name = "passer7"} : <>, <i1>
    %85 = mux %index [%18, %78] {handshake.bb = 2 : ui32, handshake.name = "mux1"} : <i1>, [<i12>, <i12>] to <i12>
    %86 = extsi %85 {handshake.bb = 2 : ui32, handshake.name = "extsi8"} : <i12> to <i32>
    %result, %index = control_merge [%20, %84]  {handshake.bb = 2 : ui32, handshake.name = "control_merge2"} : [<>, <>] to <>, <i1>
