module {
  handshake.func @subdiag_fast(%arg0: memref<1000xf32>, %arg1: memref<1000xf32>, %arg2: memref<1000xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["d1", "d2", "e", "d1_start", "d2_start", "e_start", "start"], resNames = ["out0", "d1_end", "d2_end", "e_end", "end"]} {
    ...
    %3 = mux %73#0 [%2, %83] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, [<i11>, <i11>] to <i11>
    %4 = trunci %82#0 {handshake.bb = 1 : ui32, handshake.name = "trunci0"} : <i11> to <i10>
    %5 = trunci %82#1 {handshake.bb = 1 : ui32, handshake.name = "trunci1"} : <i11> to <i10>
    %6 = trunci %82#2 {handshake.bb = 1 : ui32, handshake.name = "trunci2"} : <i11> to <i10>
    %7 = mux %73#1 [%0#2, %85] {handshake.bb = 1 : ui32, handshake.name = "mux3"} : <i1>, [<>, <>] to <>
    ...
    %14 = andi %80, %12#1 {handshake.bb = 1 : ui32, handshake.name = "andi0"} : <i1>
    %15 = not %12#0 {handshake.bb = 1 : ui32, handshake.name = "not0"} : <i1>
    %16 = passer %17[%77#1] {handshake.bb = 1 : ui32, handshake.name = "passer8"} : <i12>, <i1>
    %17 = extsi %82#3 {handshake.bb = 1 : ui32, handshake.name = "extsi4"} : <i11> to <i12>
    %18 = passer %86#2[%77#0] {handshake.bb = 1 : ui32, handshake.name = "passer3"} : <>, <i1>
    %19 = extsi %82#4 {handshake.bb = 1 : ui32, handshake.name = "extsi5"} : <i11> to <i12>
    ...
    %30 = passer %31[%75#2] {handshake.bb = 1 : ui32, handshake.name = "passer9"} : <i1>, <i1>
    ...
    %68:2 = fork [2] %67 {handshake.bb = 1 : ui32, handshake.name = "fork26"} : <i1>
    %69 = andi %66, %68#0 {handshake.bb = 1 : ui32, handshake.name = "andi13", specv2_tmp_and = true} : <i1>
    %70 = spec_v2_repeating_init %68#1 {handshake.bb = 1 : ui32, handshake.name = "spec_v2_repeating_init13", initToken = 1 : ui1} : <i1>
    %71:4 = fork [4] %70 {handshake.bb = 1 : ui32, handshake.name = "fork6"} : <i1>
    %72 = init %71#3 {handshake.bb = 1 : ui32, handshake.name = "init2", initToken = 0 : ui1} : <i1>
    %73:2 = fork [2] %72 {handshake.bb = 1 : ui32, handshake.name = "fork7"} : <i1>
    %74 = andi %69, %71#2 {handshake.bb = 1 : ui32, handshake.name = "andi14", specv2_tmp_and = true} : <i1>
    %75:3 = fork [3] %74 {handshake.bb = 1 : ui32, handshake.name = "fork28"} : <i1>
    %76 = andi %15, %75#0 {handshake.bb = 1 : ui32, handshake.name = "andi15"} : <i1>
    %77:2 = fork [2] %76 {handshake.bb = 1 : ui32, handshake.name = "fork29"} : <i1>
    %78 = andi %14, %75#1 {handshake.bb = 1 : ui32, handshake.name = "andi16"} : <i1>
    %79:2 = fork [2] %78 {handshake.bb = 1 : ui32, handshake.name = "fork30"} : <i1>
    %80 = not %28#1 {handshake.bb = 1 : ui32, handshake.name = "not1"} : <i1>
    %81 = passer %26#1[%79#0] {handshake.bb = 1 : ui32, handshake.name = "passer5"} : <i12>, <i1>
    %82:5 = fork [5] %3 {handshake.bb = 1 : ui32, handshake.name = "fork31"} : <i11>
    %83 = passer %84[%71#1] {handshake.bb = 1 : ui32, handshake.name = "passer10"} : <i11>, <i1>
    %84 = trunci %26#2 {handshake.bb = 1 : ui32, handshake.name = "trunci3"} : <i12> to <i11>
    %85 = passer %86#1[%71#0] {handshake.bb = 1 : ui32, handshake.name = "passer11"} : <>, <i1>
    %86:3 = fork [3] %7 {handshake.bb = 1 : ui32, handshake.name = "fork32"} : <>
    %87 = passer %86#0[%79#1] {handshake.bb = 1 : ui32, handshake.name = "passer7"} : <>, <i1>
    %88 = mux %index [%16, %81] {handshake.bb = 2 : ui32, handshake.name = "mux1"} : <i1>, [<i12>, <i12>] to <i12>
    %89 = extsi %88 {handshake.bb = 2 : ui32, handshake.name = "extsi8"} : <i12> to <i32>
    %result, %index = control_merge [%18, %87]  {handshake.bb = 2 : ui32, handshake.name = "control_merge2"} : [<>, <>] to <>, <i1>
