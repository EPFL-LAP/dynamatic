module {
  handshake.func @subdiag_fast(%arg0: memref<1000xf32>, %arg1: memref<1000xf32>, %arg2: memref<1000xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["d1", "d2", "e", "d1_start", "d2_start", "e_start", "start"], resNames = ["out0", "d1_end", "d2_end", "e_end", "end"]} {
    ...
    %outputs, %memEnd = mem_controller[%arg2 : memref<1000xf32>] %arg5 (%addressResult_6) %90#2 {connectedBlocks = [1 : i32], handshake.name = "mem_controller3"} :    (!handshake.channel<i10>) -> !handshake.channel<f32>
    %outputs_0, %memEnd_1 = mem_controller[%arg1 : memref<1000xf32>] %arg4 (%addressResult_4) %90#1 {connectedBlocks = [1 : i32], handshake.name = "mem_controller4"} :    (!handshake.channel<i10>) -> !handshake.channel<f32>
    %outputs_2, %memEnd_3 = mem_controller[%arg0 : memref<1000xf32>] %arg3 (%addressResult) %90#0 {connectedBlocks = [1 : i32], handshake.name = "mem_controller5"} :    (!handshake.channel<i10>) -> !handshake.channel<f32>
    ...
    %3 = init %73#2 {handshake.bb = 1 : ui32, handshake.name = "init0", initToken = 0 : ui1} : <i1>
    %4 = init %73#1 {handshake.bb = 1 : ui32, handshake.name = "init1", initToken = 0 : ui1} : <i1>
    %5 = mux %3 [%2, %83] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, [<i11>, <i11>] to <i11>
    %6 = trunci %82#0 {handshake.bb = 1 : ui32, handshake.name = "trunci0"} : <i11> to <i10>
    %7 = trunci %82#1 {handshake.bb = 1 : ui32, handshake.name = "trunci1"} : <i11> to <i10>
    %8 = trunci %82#2 {handshake.bb = 1 : ui32, handshake.name = "trunci2"} : <i11> to <i10>
    %9 = mux %4 [%0#2, %85] {handshake.bb = 1 : ui32, handshake.name = "mux3"} : <i1>, [<>, <>] to <>
    ...
    %16 = andi %80, %14#1 {handshake.bb = 1 : ui32, handshake.name = "andi0"} : <i1>
    %17 = not %14#0 {handshake.bb = 1 : ui32, handshake.name = "not0"} : <i1>
    %18 = passer %19[%77#1] {handshake.bb = 1 : ui32, handshake.name = "passer8"} : <i12>, <i1>
    %19 = extsi %82#3 {handshake.bb = 1 : ui32, handshake.name = "extsi4"} : <i11> to <i12>
    %20 = passer %86#2[%77#0] {handshake.bb = 1 : ui32, handshake.name = "passer3"} : <>, <i1>
    %21 = extsi %82#4 {handshake.bb = 1 : ui32, handshake.name = "extsi5"} : <i11> to <i12>
    ...
    %32 = passer %33[%75#2] {handshake.bb = 1 : ui32, handshake.name = "passer9"} : <i1>, <i1>
    ...
    %67:2 = fork [2] %66 {handshake.bb = 1 : ui32, handshake.name = "fork25"} : <i1>
    %68 = andi %65, %67#0 {handshake.bb = 1 : ui32, handshake.name = "andi12", specv2_tmp_and = true} : <i1>
    %69 = spec_v2_repeating_init %67#1 {handshake.bb = 1 : ui32, handshake.name = "spec_v2_repeating_init12", initToken = 1 : ui1} : <i1>
    %70:2 = fork [2] %69 {handshake.bb = 1 : ui32, handshake.name = "fork26"} : <i1>
    %71 = andi %68, %70#0 {handshake.bb = 1 : ui32, handshake.name = "andi13", specv2_tmp_and = true} : <i1>
    %72 = spec_v2_repeating_init %70#1 {handshake.bb = 1 : ui32, handshake.name = "spec_v2_repeating_init13", initToken = 1 : ui1} : <i1>
    %73:5 = fork [5] %72 {handshake.bb = 1 : ui32, handshake.name = "fork27"} : <i1>
    %74 = andi %71, %73#0 {handshake.bb = 1 : ui32, handshake.name = "andi14", specv2_tmp_and = true} : <i1>
    %75:3 = fork [3] %74 {handshake.bb = 1 : ui32, handshake.name = "fork28"} : <i1>
    %76 = andi %17, %75#0 {handshake.bb = 1 : ui32, handshake.name = "andi15"} : <i1>
    %77:2 = fork [2] %76 {handshake.bb = 1 : ui32, handshake.name = "fork29"} : <i1>
    %78 = andi %16, %75#1 {handshake.bb = 1 : ui32, handshake.name = "andi16"} : <i1>
    %79:2 = fork [2] %78 {handshake.bb = 1 : ui32, handshake.name = "fork30"} : <i1>
    %80 = not %30#1 {handshake.bb = 1 : ui32, handshake.name = "not1"} : <i1>
    %81 = passer %28#1[%79#0] {handshake.bb = 1 : ui32, handshake.name = "passer5"} : <i12>, <i1>
    %82:5 = fork [5] %5 {handshake.bb = 1 : ui32, handshake.name = "fork31"} : <i11>
    %83 = passer %84[%73#3] {handshake.bb = 1 : ui32, handshake.name = "passer10"} : <i11>, <i1>
    %84 = trunci %28#2 {handshake.bb = 1 : ui32, handshake.name = "trunci3"} : <i12> to <i11>
    %85 = passer %86#1[%73#4] {handshake.bb = 1 : ui32, handshake.name = "passer11"} : <>, <i1>
    %86:3 = fork [3] %9 {handshake.bb = 1 : ui32, handshake.name = "fork32"} : <>
    %87 = passer %86#0[%79#1] {handshake.bb = 1 : ui32, handshake.name = "passer7"} : <>, <i1>
    %88 = mux %index [%18, %81] {handshake.bb = 2 : ui32, handshake.name = "mux1"} : <i1>, [<i12>, <i12>] to <i12>
    %89 = extsi %88 {handshake.bb = 2 : ui32, handshake.name = "extsi8"} : <i12> to <i32>
    %result, %index = control_merge [%20, %87]  {handshake.bb = 2 : ui32, handshake.name = "control_merge2"} : [<>, <>] to <>, <i1>
    %90:3 = fork [3] %result {handshake.bb = 2 : ui32, handshake.name = "fork5"} : <>
    end {handshake.bb = 2 : ui32, handshake.name = "end0"} %89, %memEnd_3, %memEnd_1, %memEnd, %0#1 : <i32>, <>, <>, <>, <>
  }
}
