...
# - No CMerge
# - No Branch
python3 experimental/tools/integration/run_specv2_integration.py subdiag_fast --baseline --out out_baseline_7ns_trans --transformed-code subdiag_fast_v1.c --cp 7.00

# Spec v1
python3 experimental/tools/integration/run_adapted_spec_integration.py subdiag_fast --transformed-code subdiag_fast_v1.c --cp 7.00 --out out_v1_7ns

python3 experimental/tools/integration/run_specv2_integration.py subdiag_fast --n 13 --out out_13_7ns_trans --cp 7.00 --resolver --transformed-code subdiag_fast_v1.c
