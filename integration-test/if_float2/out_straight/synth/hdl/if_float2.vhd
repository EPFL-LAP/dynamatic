...
architecture behavioral of if_float2 is
  ...
  signal fork38_outs_3 : std_logic_vector(0 downto 0);
  ...
  signal passer13_result : std_logic_vector(6 downto 0);
  ...
  signal passer14_result : std_logic_vector(31 downto 0);
  ...
  signal passer16_result : std_logic_vector(31 downto 0);
...
begin
  ...
  mem_controller2 : entity work.handshake_mem_controller_0(arch)
    port map(
      ...
      ctrl(0) => passer16_result,
      ctrl_valid(0) => passer16_result_valid,
      ctrl_ready(0) => passer16_result_ready,
  ...
  mux5 : entity work.handshake_mux_2(arch)
    port map(
      ...
      ins_valid(1) => fork37_outs_0_valid,
      ins_ready(0) => constant0_outs_ready,
      ins_ready(1) => fork37_outs_0_ready,
      clk => clk,
      rst => rst,
      outs => mux5_outs,
  ...
  fork1 : entity work.handshake_fork_7(arch)
    port map(
      ins => buffer9_outs,
  ...
  passer6 : entity work.handshake_passer_0(arch)
    port map(
      ...
      ctrl => fork1_outs_2,
      ctrl_valid => fork1_outs_2_valid,
      ctrl_ready => fork1_outs_2_ready,
      clk => clk,
      rst => rst,
  ...
  buffer16 : entity work.handshake_buffer_1(arch)
    port map(
      ins => mux3_outs,
  ...
  buffer7 : entity work.handshake_buffer_2(arch)
    port map(
      ins => fork37_outs_6,
      ins_valid => fork37_outs_6_valid,
      ins_ready => fork37_outs_6_ready,
      clk => clk,
      rst => rst,
      outs => buffer7_outs,
  ...
  fork39 : entity work.handshake_fork_6(arch)
    port map(
      ins => not0_outs,
  ...
  passer9 : entity work.handshake_passer_3(arch)
    port map(
      data => constant1_outs,
      data_valid => constant1_outs_valid,
      data_ready => constant1_outs_ready,
      ctrl => fork39_outs_0,
  ...
  buffer5 : entity work.handshake_buffer_10(arch)
    port map(
  ...
  constant1 : entity work.handshake_constant_0(arch)
    port map(
  ...
  buffer10 : entity work.handshake_buffer_11(arch)
    port map(
      ins => fork12_outs_1,
  ...
  passer11 : entity work.handshake_passer_1(arch)
    port map(
      ...
      ctrl => fork39_outs_3,
      ctrl_valid => fork39_outs_3_valid,
      ctrl_ready => fork39_outs_3_ready,
      clk => clk,
      rst => rst,
  ...
  fork34 : entity work.handshake_fork_8(arch)
    port map(
      ins => buffer12_outs,
  ...
  passer13 : entity work.handshake_passer_5(arch)
    port map(
      ...
      ctrl => fork37_outs_5,
      ctrl_valid => fork37_outs_5_valid,
      ctrl_ready => fork37_outs_5_ready,
      clk => clk,
      rst => rst,
  ...
  passer14 : entity work.handshake_passer_6(arch)
    port map(
      data => buffer13_outs,
  ...
  fork35 : entity work.handshake_fork_9(arch)
    port map(
      ins => buffer14_outs,
  ...
  passer15 : entity work.handshake_passer_3(arch)
    port map(
      data => constant6_outs,
      data_valid => constant6_outs_valid,
      data_ready => constant6_outs_ready,
      ctrl => fork37_outs_2,
  ...
  sink1 : entity work.handshake_sink_0(arch)
    port map(
      ins => passer15_result,
      ins_valid => passer15_result_valid,
      ins_ready => passer15_result_ready,
      clk => clk,
      rst => rst
    );
  ...
  store0 : entity work.handshake_store_0(arch)
    port map(
      addrIn => passer13_result,
      addrIn_valid => passer13_result_valid,
      addrIn_ready => passer13_result_ready,
      dataIn => passer14_result,
      dataIn_valid => passer14_result_valid,
      dataIn_ready => passer14_result_ready,
      clk => clk,
      rst => rst,
  ...
  mux3 : entity work.handshake_mux_0(arch)
    port map(
      index => fork38_outs_2,
      index_valid => fork38_outs_2_valid,
      index_ready => fork38_outs_2_ready,
      ins(0) => passer11_result,
      ins(1) => fork34_outs_1,
      ins_valid(0) => passer11_result_valid,
      ins_valid(1) => fork34_outs_1_valid,
      ins_ready(0) => passer11_result_ready,
  ...
  mux4 : entity work.handshake_mux_4(arch)
    port map(
      index => fork38_outs_3,
      index_valid => fork38_outs_3_valid,
      index_ready => fork38_outs_3_ready,
  ...
  divf0 : entity work.handshake_divf_0(arch)
    port map(
      ...
      rhs => passer6_result,
      rhs_valid => passer6_result_valid,
      rhs_ready => passer6_result_ready,
      clk => clk,
      rst => rst,
      result => divf0_result,
  ...
  buffer18 : entity work.handshake_buffer_2(arch)
    port map(
      ins => fork10_outs_1,
  ...
  cond_br7 : entity work.handshake_cond_br_2(arch)
    port map(
      ...
      data_valid => passer8_result_valid,
      data_ready => passer8_result_ready,
      clk => clk,
      rst => rst,
