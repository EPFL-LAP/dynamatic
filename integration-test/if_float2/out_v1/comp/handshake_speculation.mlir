module {
  handshake.func @if_float2(%arg0: !handshake.channel<f32>, %arg1: memref<100xf32>, %arg2: memref<100xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x0", "a", "minus_trace", "a_start", "minus_trace_start", "start"], resNames = ["out0", "a_end", "minus_trace_end", "end"]} {
    ...
    %3 = spec_commit[%26#0] %65#1 {handshake.bb = 2 : ui32, handshake.name = "spec_commit0"} : !handshake.control<[spec: i1]>, !handshake.control<>, <i1>
    ...
    %5 = spec_commit[%26#1] %65#0 {handshake.bb = 2 : ui32, handshake.name = "spec_commit2"} : !handshake.control<[spec: i1]>, !handshake.control<>, <i1>
    ...
    %17 = constant %16 {handshake.bb = 1 : ui32, handshake.name = "constant7", value = -6.000000e-01 : f32} : <[spec: i1]>, <f32, [spec: i1]>
    %18 = source {handshake.bb = 1 : ui32, handshake.name = "source1"} : <[spec: i1]>
    %19 = constant %18 {handshake.bb = 1 : ui32, handshake.name = "constant8", value = 0.000000e+00 : f32} : <[spec: i1]>, <f32, [spec: i1]>
    ...
    %24:3 = fork [3] %SCSaveCtrl {handshake.bb = 1 : ui32, handshake.name = "fork8"} : <i3>
    ...
    %25:2 = fork [2] %commitCtrl {handshake.bb = 1 : ui32, handshake.name = "fork12"} : <i1>
    ...
    %26:3 = fork [3] %falseResult {handshake.bb = 1 : ui32, handshake.name = "fork14"} : <i1>
    ...
    %27:3 = fork [3] %trueResult_3 {handshake.bb = 1 : ui32, handshake.name = "fork15"} : <i1>
    %trueResult_5, %falseResult_6 = speculating_branch[%64#2] %64#3 {handshake.bb = 1 : ui32, handshake.name = "speculating_branch1"} : !handshake.channel<i1, [spec: i1]>, !handshake.channel<i1, [spec: i1]>, !handshake.channel<i1>, !handshake.channel<i1>
    sink %falseResult_6 {handshake.name = "sink5"} : <i1>
    %28:2 = fork [2] %trueResult_5 {handshake.bb = 1 : ui32, handshake.name = "fork16"} : <i1>
    ...
    %29:8 = fork [8] %dataOut {handshake.bb = 1 : ui32, handshake.name = "fork17"} : <i1, [spec: i1]>
    %30 = spec_save_commit[%24#1] %10#1 {fifoDepth = 30 : ui32, handshake.bb = 1 : ui32, handshake.name = "spec_save_commit0"} : !handshake.channel<i8, [spec: i1]>, <i3>
    ...
    %31 = spec_save_commit[%24#0] %13#0 {fifoDepth = 30 : ui32, handshake.bb = 1 : ui32, handshake.name = "spec_save_commit1"} : !handshake.channel<f32, [spec: i1]>, <i3>
    ...
    %34 = constant %33 {handshake.bb = 1 : ui32, handshake.name = "constant9", value = 3.000000e+00 : f32} : <[spec: i1]>, <f32, [spec: i1]>
    %35 = addf %falseResult_12, %34 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "addf1"} : <f32, [spec: i1]>
    ...
    %43 = constant %42 {handshake.bb = 1 : ui32, handshake.name = "constant10", value = 1.000000e+00 : f32} : <[spec: i1]>, <f32, [spec: i1]>
    ...
    %46 = addf %38#1, %43 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "addf2"} : <f32, [spec: i1]>
    ...
    %48 = mux %29#0 [%falseResult_10, %36#1] {handshake.bb = 1 : ui32, handshake.name = "mux3", specv1_adaptor_inner_loop = true} : <i1, [spec: i1]>, [<i8, [spec: i1]>, <i8, [spec: i1]>] to <i8, [spec: i1]>
    %49 = extsi %48 {handshake.bb = 1 : ui32, handshake.name = "extsi5"} : <i8, [spec: i1]> to <i9, [spec: i1]>
    %50 = mux %29#2 [%falseResult_14, %39#1] {handshake.bb = 1 : ui32, handshake.name = "mux4", specv1_adaptor_inner_loop = true} : <i1, [spec: i1]>, [<[spec: i1]>, <[spec: i1]>] to <[spec: i1]>
    %51 = source {handshake.bb = 1 : ui32, handshake.name = "source4"} : <[spec: i1]>
    %52 = constant %51 {handshake.bb = 1 : ui32, handshake.name = "constant11", value = 1.000000e+00 : f32} : <[spec: i1]>, <f32, [spec: i1]>
    %53 = source {handshake.bb = 1 : ui32, handshake.name = "source5"} : <[spec: i1]>
    %54 = constant %53 {handshake.bb = 1 : ui32, handshake.name = "constant4", value = 1 : i2} : <[spec: i1]>, <i2, [spec: i1]>
    %55 = extsi %54 {handshake.bb = 1 : ui32, handshake.name = "extsi6"} : <i2, [spec: i1]> to <i9, [spec: i1]>
    %56 = source {handshake.bb = 1 : ui32, handshake.name = "source6"} : <[spec: i1]>
    %57 = constant %56 {handshake.bb = 1 : ui32, handshake.name = "constant5", value = 100 : i8} : <[spec: i1]>, <i8, [spec: i1]>
    %58 = extsi %57 {handshake.bb = 1 : ui32, handshake.name = "extsi7"} : <i8, [spec: i1]> to <i9, [spec: i1]>
    %59 = divf %52, %47 {fastmath = #arith.fastmath<none>, handshake.bb = 1 : ui32, handshake.name = "divf0"} : <f32, [spec: i1]>
    %60 = addi %49, %55 {handshake.bb = 1 : ui32, handshake.name = "addi0"} : <i9, [spec: i1]>
    %61:2 = fork [2] %60 {handshake.bb = 1 : ui32, handshake.name = "fork9"} : <i9, [spec: i1]>
    %62 = trunci %61#0 {handshake.bb = 1 : ui32, handshake.name = "trunci2"} : <i9, [spec: i1]> to <i8, [spec: i1]>
    %63 = cmpi ult, %61#1, %58 {handshake.bb = 1 : ui32, handshake.name = "cmpi0"} : <i9, [spec: i1]>
    %64:5 = fork [5] %63 {handshake.bb = 1 : ui32, handshake.name = "fork18"} : <i1, [spec: i1]>
    %trueResult_17, %falseResult_18 = cond_br %64#4, %62 {handshake.bb = 1 : ui32, handshake.name = "cond_br5"} : <i1, [spec: i1]>, <i8, [spec: i1]>
    sink %falseResult_18 {handshake.name = "sink2"} : <i8, [spec: i1]>
    %trueResult_19, %falseResult_20 = cond_br %64#0, %59 {handshake.bb = 1 : ui32, handshake.name = "cond_br6"} : <i1, [spec: i1]>, <f32, [spec: i1]>
    %trueResult_21, %falseResult_22 = cond_br %64#1, %50 {handshake.bb = 1 : ui32, handshake.name = "cond_br7"} : <i1, [spec: i1]>, <[spec: i1]>
    %65:2 = fork [2] %falseResult_22 {handshake.bb = 2 : ui32, handshake.name = "fork11"} : <[spec: i1]>
    %66 = spec_commit[%26#2] %falseResult_20 {handshake.bb = 1 : ui32, handshake.name = "spec_commit5"} : !handshake.channel<f32, [spec: i1]>, !handshake.channel<f32>, <i1>
    end {handshake.bb = 2 : ui32, handshake.name = "end0"} %66, %memEnd_0, %memEnd, %1#1 : <f32>, <>, <>, <>
  }
}
