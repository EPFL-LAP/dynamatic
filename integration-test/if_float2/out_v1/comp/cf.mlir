module {
  func.func @if_float2(%arg0: f32, %arg1: memref<100xf32>, %arg2: memref<100xf32>) -> f32 {
    %c0_i32 = arith.constant {handshake.name = "constant0"} 0 : i32
    %cst = arith.constant {handshake.name = "constant1"} -6.000000e-01 : f32
    %cst_0 = arith.constant {handshake.name = "constant2"} 0.000000e+00 : f32
    %cst_1 = arith.constant {handshake.name = "constant3"} 3.000000e+00 : f32
    %cst_2 = arith.constant {handshake.name = "constant4"} 1.000000e+00 : f32
    %c1_i32 = arith.constant {handshake.name = "constant5"} 1 : i32
    %c100_i32 = arith.constant {handshake.name = "constant6"} 100 : i32
  ...
  ^bb1(%0: i32, %1: f32):  // 2 preds: ^bb0, ^bb4
    ...
    %4 = memref.load %arg1[%3] {handshake.name = "load0"} : memref<100xf32>
