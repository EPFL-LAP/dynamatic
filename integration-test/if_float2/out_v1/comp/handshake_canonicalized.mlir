module {
  handshake.func @if_float2(%arg0: !handshake.channel<f32>, %arg1: memref<100xf32>, %arg2: memref<100xf32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x0", "a", "minus_trace", "a_start", "minus_trace_start", "start"], resNames = ["out0", "a_end", "minus_trace_end", "end"]} {
    ...
    %memEnd = mem_controller[%arg2 : memref<100xf32>] %arg4 (%26, %addressResult_5, %dataResult_6) %48#1 {connectedBlocks = [3 : i32], handshake.name = "mem_controller2"} :    (!handshake.channel<i32>, !handshake.channel<i7>, !handshake.channel<f32>) -> ()
    ...
    %20 = addf %falseResult_2, %19 {fastmath = #arith.fastmath<none>, handshake.bb = 2 : ui32, handshake.name = "addf1"} : <f32>
    ...
    %29 = addf %23#1, %28 {fastmath = #arith.fastmath<none>, handshake.bb = 3 : ui32, handshake.name = "addf2"} : <f32>
    %30 = mux %33#1 [%20, %29] {handshake.bb = 4 : ui32, handshake.name = "mux2"} : <i1>, [<f32>, <f32>] to <f32>
    %31 = mux %33#0 [%falseResult, %21#1] {handshake.bb = 4 : ui32, handshake.name = "mux3"} : <i1>, [<i8>, <i8>] to <i8>
    %32 = extsi %31 {handshake.bb = 4 : ui32, handshake.name = "extsi5"} : <i8> to <i9>
    %result_7, %index_8 = control_merge [%falseResult_4, %24#1]  {handshake.bb = 4 : ui32, handshake.name = "control_merge3"} : [<>, <>] to <>, <i1>
    %33:2 = fork [2] %index_8 {handshake.bb = 4 : ui32, handshake.name = "fork8"} : <i1>
    %34 = source {handshake.bb = 4 : ui32, handshake.name = "source4"} : <>
    %35 = constant %34 {handshake.bb = 4 : ui32, handshake.name = "constant11", value = 1.000000e+00 : f32} : <>, <f32>
    %36 = source {handshake.bb = 4 : ui32, handshake.name = "source5"} : <>
    %37 = constant %36 {handshake.bb = 4 : ui32, handshake.name = "constant4", value = 1 : i2} : <>, <i2>
    %38 = extsi %37 {handshake.bb = 4 : ui32, handshake.name = "extsi6"} : <i2> to <i9>
    %39 = source {handshake.bb = 4 : ui32, handshake.name = "source6"} : <>
    %40 = constant %39 {handshake.bb = 4 : ui32, handshake.name = "constant5", value = 100 : i8} : <>, <i8>
    %41 = extsi %40 {handshake.bb = 4 : ui32, handshake.name = "extsi7"} : <i8> to <i9>
    %42 = divf %35, %30 {fastmath = #arith.fastmath<none>, handshake.bb = 4 : ui32, handshake.name = "divf0"} : <f32>
    %43 = addi %32, %38 {handshake.bb = 4 : ui32, handshake.name = "addi0"} : <i9>
    %44:2 = fork [2] %43 {handshake.bb = 4 : ui32, handshake.name = "fork9"} : <i9>
    %45 = trunci %44#0 {handshake.bb = 4 : ui32, handshake.name = "trunci2"} : <i9> to <i8>
    %46 = cmpi ult, %44#1, %41 {handshake.bb = 4 : ui32, handshake.name = "cmpi0"} : <i9>
    %47:3 = fork [3] %46 {handshake.bb = 4 : ui32, handshake.name = "fork10"} : <i1>
    %trueResult_9, %falseResult_10 = cond_br %47#0, %45 {handshake.bb = 4 : ui32, handshake.name = "cond_br5"} : <i1>, <i8>
    sink %falseResult_10 {handshake.name = "sink2"} : <i8>
    %trueResult_11, %falseResult_12 = cond_br %47#1, %42 {handshake.bb = 4 : ui32, handshake.name = "cond_br6"} : <i1>, <f32>
    %trueResult_13, %falseResult_14 = cond_br %47#2, %result_7 {handshake.bb = 4 : ui32, handshake.name = "cond_br7"} : <i1>, <>
    %48:2 = fork [2] %falseResult_14 {handshake.bb = 5 : ui32, handshake.name = "fork11"} : <>
