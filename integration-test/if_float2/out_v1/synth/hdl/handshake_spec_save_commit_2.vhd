-- handshake_spec_save_commit_2 : spec_save_commit({'fifo_depth': 30, 'bitwidth': 0, 'extra_signals': {'spec': 1}})
...
entity handshake_spec_save_commit_2 is
  port (
    clk : in std_logic;
    rst : in std_logic;
    -- inputs
...
architecture arch of handshake_spec_save_commit_2 is
