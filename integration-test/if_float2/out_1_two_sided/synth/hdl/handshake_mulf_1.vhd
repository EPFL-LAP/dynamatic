-- handshake_mulf_1 : mulf({'is_double': False, 'extra_signals': {}})
...
-- Entity of and_n
entity handshake_mulf_1_join_and_n is
  port (
    -- inputs
...
architecture arch of handshake_mulf_1_join_and_n is
...
-- Entity of join
entity handshake_mulf_1_join is
  port (
    -- inputs
...
architecture arch of handshake_mulf_1_join is
  signal allValid : std_logic;
begin
  allValidAndGate : entity work.handshake_mulf_1_join_and_n port map(ins_valid, allValid);
  outs_valid <= allValid;
...
entity handshake_mulf_1_one_slot_break_dv is
  port (
    clk : in std_logic;
    rst : in std_logic;
    -- input channel
...
architecture arch of handshake_mulf_1_one_slot_break_dv is
...
begin
  join_inputs : entity work.handshake_mulf_1_join(arch)
    port map(
      -- inputs
  ...
  one_slot_break_dv : entity work.handshake_mulf_1_one_slot_break_dv(arch)
  port map(
    clk        => clk,
    rst        => rst,
