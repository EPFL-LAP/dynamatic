...
architecture behavioral of if_float2 is
  ...
  signal buffer18_outs : std_logic_vector(7 downto 0);
...
begin
  ...
  not0 : entity work.handshake_not_0(arch)
    port map(
      ins => fork46_outs_5,
      ins_valid => fork46_outs_5_valid,
      ins_ready => fork46_outs_5_ready,
      clk => clk,
      rst => rst,
      outs => not0_outs,
  ...
  buffer15 : entity work.handshake_buffer_11(arch)
    port map(
      ins => trunci1_outs,
  ...
  mux3 : entity work.handshake_mux_0(arch)
    port map(
      index => fork47_outs_2,
      index_valid => fork47_outs_2_valid,
      index_ready => fork47_outs_2_ready,
  ...
  buffer19 : entity work.handshake_buffer_15(arch)
    port map(
      ins => extsi5_outs,
  ...
  fork45 : entity work.handshake_fork_7(arch)
    port map(
      ins => cmpi0_result,
