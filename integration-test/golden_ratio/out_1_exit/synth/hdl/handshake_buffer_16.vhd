-- handshake_buffer_16 : buffer({'num_slots': 1, 'bitwidth': 32, 'buffer_type': 'FIFO_BREAK_NONE', 'extra_signals': {}, 'debug_counter': 0})
...
entity handshake_buffer_16_fifo_inner is
  port (
    clk : in std_logic;
    rst : in std_logic;
    -- input channel
...
architecture arch of handshake_buffer_16_fifo_inner is
...
begin
  ...
  control : entity work.handshake_buffer_16_fifo_inner
    port map(
      clk        => clk,
      rst        => rst,
      ins_valid  => ins_valid,
