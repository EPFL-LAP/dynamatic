module {
  ...
  ^bb2(%3: f32):  // 2 preds: ^bb1, ^bb2
    %cst = arith.constant {handshake.name = "constant6"} 5.000000e-01 : f32
    %cst_0 = arith.constant {handshake.name = "constant7"} 1.000000e-01 : f32
  ...
  ^bb3(%10: f32):  // pred: ^bb2
    %cst_1 = arith.constant {handshake.name = "constant8"} 1.000000e+00 : f32
