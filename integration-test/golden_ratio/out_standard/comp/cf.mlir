module {
  func.func @golden_ratio(%arg0: f32) -> f32 {
    %cst = arith.constant {handshake.name = "constant0"} 1.000000e+00 : f32
    %c0_i32 = arith.constant {handshake.name = "constant1"} 0 : i32
    %cst_0 = arith.constant {handshake.name = "constant2"} 5.000000e-01 : f32
    %cst_1 = arith.constant {handshake.name = "constant3"} 1.000000e-01 : f32
  ...
  ^bb3(%11: f32):  // pred: ^bb2
    ...
    %14 = arith.divf %cst, %12 {handshake.name = "divf1"} : f32
