module {
  func.func @golden_ratio(%arg0: f32, %arg1: f32) -> f32 {
    %c0_i32 = arith.constant {handshake.name = "constant0"} 0 : i32
    %cst = arith.constant {handshake.name = "constant1"} 5.000000e-01 : f32
    %cst_0 = arith.constant {handshake.name = "constant2"} 1.000000e-01 : f32
    %cst_1 = arith.constant {handshake.name = "constant3"} 1.000000e+00 : f32
  ...
  ^bb2(%3: f32):  // 2 preds: ^bb1, ^bb2
    ...
    %6 = arith.mulf %5, %cst {handshake.name = "mulf1"} : f32
  ...
  ^bb3(%10: f32):  // pred: ^bb2
    %11 = arith.addf %10, %cst_1 {handshake.name = "addf1"} : f32
    %12 = arith.divf %cst_1, %11 {handshake.name = "divf0"} : f32
