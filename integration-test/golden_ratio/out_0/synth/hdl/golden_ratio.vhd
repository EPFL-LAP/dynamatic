...
architecture behavioral of golden_ratio is
  ...
  signal fork2_outs_3 : std_logic_vector(31 downto 0);
  ...
  signal fork11_outs_0 : std_logic_vector(7 downto 0);
  signal fork11_outs_0_valid : std_logic;
  signal fork11_outs_0_ready : std_logic;
  signal fork11_outs_1 : std_logic_vector(7 downto 0);
  ...
  signal passer2_result : std_logic_vector(7 downto 0);
...
begin
  ...
  mulf0 : entity work.handshake_mulf_0(arch)
    port map(
      lhs => fork2_outs_3,
      lhs_valid => fork2_outs_3_valid,
      lhs_ready => fork2_outs_3_ready,
      rhs => fork3_outs_1,
  ...
  fork5 : entity work.handshake_fork_6(arch)
    port map(
      ins => mulf1_result,
  ...
  fork6 : entity work.handshake_fork_7(arch)
    port map(
      ins => init4_outs,
  ...
  buffer4 : entity work.handshake_buffer_11(arch)
    port map(
      ins => fork2_outs_0,
  ...
  passer0 : entity work.handshake_passer_0(arch)
    port map(
      ...
      ctrl => fork13_outs_2,
      ctrl_valid => fork13_outs_2_valid,
      ctrl_ready => fork13_outs_2_ready,
      clk => clk,
      rst => rst,
  ...
  passer5 : entity work.handshake_passer_3(arch)
    port map(
      ...
      ctrl => fork4_outs_2,
      ctrl_valid => fork4_outs_2_valid,
      ctrl_ready => fork4_outs_2_ready,
      clk => clk,
      rst => rst,
  ...
  passer6 : entity work.handshake_passer_4(arch)
    port map(
      ...
      ctrl => fork4_outs_3,
      ctrl_valid => fork4_outs_3_valid,
      ctrl_ready => fork4_outs_3_ready,
      clk => clk,
      rst => rst,
  ...
  fork7 : entity work.handshake_fork_9(arch)
    port map(
      ins => constant8_outs,
  ...
  buffer17 : entity work.handshake_buffer_15(arch)
    port map(
      ins => fork7_outs_0,
  ...
  buffer18 : entity work.handshake_buffer_16(arch)
    port map(
      ins => fork8_outs_0,
