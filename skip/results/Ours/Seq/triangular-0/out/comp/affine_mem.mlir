  ...
  func.func @triangular(%arg0: memref<10xi32> {handshake.arg_name = "x"}, %arg1: i32 {handshake.arg_name = "n"}, %arg2: memref<10x10xi32> {handshake.arg_name = "a"}) {
    ...
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = 0 to #map(%arg3)[%0] {
        ...
        %4 = affine.load %arg2[-%arg3 - %arg4 + symbol(%0) - 2, symbol(%0)] {handshake.deps = #handshake<deps[["store0", 1, true], ["store0", 3, true]]>, handshake.name = "load2"} : memref<10x10xi32>
        %5 = arith.subi %4, %3 {handshake.name = "subi0"} : i32
        affine.store %5, %arg2[-%arg3 - %arg4 + symbol(%0) - 2, symbol(%0)] {handshake.deps = #handshake<deps[["load2", 1, true], ["store0", 1, true]]>, handshake.name = "store0"} : memref<10x10xi32>
      } {handshake.name = "for0"}
    } {handshake.name = "for1"}
