module {
  ...
  ^bb2(%2: index, %3: f32):  // 2 preds: ^bb1, ^bb2
    ...
    %9 = memref.load %arg1[%2] {handshake.name = "load7"} : memref<20xf32>
  ...
  ^bb3(%14: index):  // 2 preds: ^bb2, ^bb3
    ...
    %15 = memref.load %arg2[%14] {handshake.deps = #handshake<deps[["store2", 1, true], ["store2", 3, true]]>, handshake.name = "load8"} : memref<20xf32>
    ...
    %20 = memref.load %arg0[%19] {handshake.name = "load11"} : memref<400xf32>
    %21 = arith.mulf %20, %11 {handshake.name = "mulf1"} : f32
    %22 = arith.addf %15, %21 {handshake.name = "addf1"} : f32
    memref.store %22, %arg2[%14] {handshake.deps = #handshake<deps[["load8", 1, true], ["store2", 1, true]]>, handshake.name = "store2"} : memref<20xf32>
  ...
  ^bb4:  // pred: ^bb3
    ...
    memref.store %11, %arg3[%0] {handshake.name = "store3"} : memref<20xf32>
