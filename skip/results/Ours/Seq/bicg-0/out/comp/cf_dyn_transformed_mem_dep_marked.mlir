module {
  ...
  ^bb1(%0: index):  // 2 preds: ^bb0, ^bb3
    ...
    %1 = memref.load %arg2[%0] {handshake.deps = #handshake<deps[["store3", 2, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load5"} : memref<30xi32>
  ...
  ^bb2(%2: index, %3: i32):  // 2 preds: ^bb1, ^bb2
    ...
    %6 = memref.load %arg0[%5] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load10"} : memref<900xi32>
    %7 = memref.load %arg1[%2] {handshake.deps = #handshake<deps[["store2", 1, true], ["store2", 3, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load7"} : memref<30xi32>
    %8 = memref.load %arg4[%0] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load8"} : memref<30xi32>
    %9 = arith.muli %8, %6 {handshake.name = "muli0"} : i32
    %10 = arith.addi %7, %9 {handshake.name = "addi0"} : i32
    memref.store %10, %arg1[%2] {handshake.deps = #handshake<deps[["load7", 1, true], ["store2", 1, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store2"} : memref<30xi32>
    %11 = memref.load %arg3[%2] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load9"} : memref<30xi32>
  ...
  ^bb3:  // pred: ^bb2
    ...
    memref.store %13, %arg2[%0] {handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store3"} : memref<30xi32>
