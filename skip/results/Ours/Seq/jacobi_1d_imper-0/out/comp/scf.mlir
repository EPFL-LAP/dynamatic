  ...
  func.func @jacobi_1d_imper(%arg0: memref<100xi32> {handshake.arg_name = "A"}, %arg1: memref<100xi32> {handshake.arg_name = "B"}) {
    ...
    %0 = scf.while (%arg2 = %c0) : (index) -> index {
      %1 = scf.while (%arg3 = %c1) : (index) -> index {
        ...
        %6 = memref.load %arg0[%5] {handshake.deps = #handshake<deps[["store3", 1, true], ["store3", 2, true]]>, handshake.name = "load4"} : memref<100xi32>
        %7 = memref.load %arg0[%arg3] {handshake.deps = #handshake<deps[["store3", 1, true], ["store3", 2, true]]>, handshake.name = "load5"} : memref<100xi32>
        %8 = arith.addi %6, %7 {handshake.name = "addi0"} : i32
        %9 = arith.addi %arg3, %c1 {handshake.name = "addi3"} : index
        %10 = memref.load %arg0[%9] {handshake.deps = #handshake<deps[["store3", 1, true], ["store3", 2, true]]>, handshake.name = "load6"} : memref<100xi32>
        %11 = arith.addi %8, %10 {handshake.name = "addi1"} : i32
        %12 = arith.muli %11, %c3_i32 {handshake.name = "muli0"} : i32
        memref.store %12, %arg1[%arg3] {handshake.deps = #handshake<deps[["store2", 1, true], ["load7", 1, true], ["load7", 2, true]]>, handshake.name = "store2"} : memref<100xi32>
      ...
      %2 = scf.while (%arg3 = %c1) : (index) -> index {
        %5 = memref.load %arg1[%arg3] {handshake.deps = #handshake<deps[["store2", 1, true]]>, handshake.name = "load7"} : memref<100xi32>
        memref.store %5, %arg0[%arg3] {handshake.deps = #handshake<deps[["load4", 1, true], ["load5", 1, true], ["load6", 1, true], ["store3", 1, true]]>, handshake.name = "store3"} : memref<100xi32>
