module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb2
    ...
    %3 = memref.load %arg0[%2] {handshake.deps = #handshake<deps[["store3", 1, true], ["store3", 2, true]]>, handshake.name = "load4"} : memref<100xi32>
    %4 = memref.load %arg0[%1] {handshake.deps = #handshake<deps[["store3", 1, true], ["store3", 2, true]]>, handshake.name = "load5"} : memref<100xi32>
    %5 = arith.addi %3, %4 {handshake.name = "addi0"} : i32
    %6 = arith.addi %1, %c1_0 {handshake.name = "addi3"} : index
    %7 = memref.load %arg0[%6] {handshake.deps = #handshake<deps[["store3", 1, true], ["store3", 2, true]]>, handshake.name = "load6"} : memref<100xi32>
    ...
    memref.store %10, %arg1[%1] {handshake.deps = #handshake<deps[["store2", 1, true], ["load7", 1, true], ["load7", 2, true]]>, handshake.name = "store2"} : memref<100xi32>
  ...
  ^bb3(%13: index):  // 2 preds: ^bb2, ^bb3
    ...
    %14 = memref.load %arg1[%13] {handshake.deps = #handshake<deps[["store2", 1, true]]>, handshake.name = "load7"} : memref<100xi32>
    memref.store %14, %arg0[%13] {handshake.deps = #handshake<deps[["load4", 1, true], ["load5", 1, true], ["load6", 1, true], ["store3", 1, true]]>, handshake.name = "store3"} : memref<100xi32>
