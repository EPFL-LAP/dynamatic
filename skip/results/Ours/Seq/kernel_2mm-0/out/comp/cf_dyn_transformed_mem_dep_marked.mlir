module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb4
    ...
    memref.store %c0_i32, %arg2[%5] {handshake.deps = #handshake<deps[["load16", 3, true], ["store9", 3, true], ["load18", 1, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store8"} : memref<100xi32>
  ...
  ^bb3(%6: index):  // 2 preds: ^bb2, ^bb3
    ...
    %11 = memref.load %arg3[%10] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load14"} : memref<100xi32>
    ...
    %17 = memref.load %arg4[%16] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load15"} : memref<100xi32>
    ...
    %23 = memref.load %arg2[%22] {handshake.deps = #handshake<deps[["store9", 3, true], ["store9", 4, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load16"} : memref<100xi32>
    ...
    memref.store %24, %arg2[%28] {handshake.deps = #handshake<deps[["load16", 3, true], ["store9", 3, true], ["load18", 1, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store9"} : memref<100xi32>
  ...
  ^bb7(%36: index):  // 2 preds: ^bb6, ^bb9
    ...
    %41 = memref.load %arg6[%40] {handshake.deps = #handshake<deps[["store10", 3, true], ["store11", 3, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load17"} : memref<100xi32>
    ...
    memref.store %42, %arg6[%46] {handshake.deps = #handshake<deps[["load20", 3, true], ["store11", 3, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store10"} : memref<100xi32>
  ...
  ^bb8(%47: index):  // 2 preds: ^bb7, ^bb8
    ...
    %52 = memref.load %arg2[%51] {handshake.mem_interface = #handshake.mem_interface<LSQ: 2>, handshake.name = "load18"} : memref<100xi32>
    ...
    %57 = memref.load %arg5[%56] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load19"} : memref<100xi32>
    ...
    %63 = memref.load %arg6[%62] {handshake.deps = #handshake<deps[["store11", 3, true], ["store11", 4, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load20"} : memref<100xi32>
    ...
    memref.store %64, %arg6[%68] {handshake.deps = #handshake<deps[["load20", 3, true], ["store11", 3, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store11"} : memref<100xi32>
