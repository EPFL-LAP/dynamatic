module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb4
    ...
    memref.store %c0_i32, %arg4[%5] {handshake.deps = #handshake<deps[["load20", 3, true], ["store13", 3, true], ["load24", 1, true]]>, handshake.name = "store12"} : memref<100xi32>
  ...
  ^bb3(%6: index):  // 2 preds: ^bb2, ^bb3
    ...
    %11 = memref.load %arg0[%10] {handshake.name = "load18"} : memref<100xi32>
    ...
    %22 = memref.load %arg4[%21] {handshake.deps = #handshake<deps[["store13", 3, true], ["store13", 4, true]]>, handshake.name = "load20"} : memref<100xi32>
    ...
    memref.store %23, %arg4[%27] {handshake.deps = #handshake<deps[["load20", 3, true], ["store13", 3, true], ["load24", 1, true]]>, handshake.name = "store13"} : memref<100xi32>
  ...
  ^bb7(%35: index):  // 2 preds: ^bb6, ^bb9
    ...
    memref.store %c0_i32_10, %arg5[%39] {handshake.deps = #handshake<deps[["load23", 3, true], ["store15", 3, true], ["load25", 1, true]]>, handshake.name = "store14"} : memref<100xi32>
  ...
  ^bb8(%40: index):  // 2 preds: ^bb7, ^bb8
    ...
    %45 = memref.load %arg2[%44] {handshake.name = "load21"} : memref<100xi32>
    ...
    %50 = memref.load %arg3[%49] {handshake.name = "load22"} : memref<100xi32>
    ...
    %56 = memref.load %arg5[%55] {handshake.deps = #handshake<deps[["store15", 3, true], ["store15", 4, true]]>, handshake.name = "load23"} : memref<100xi32>
    ...
    memref.store %57, %arg5[%61] {handshake.deps = #handshake<deps[["load23", 3, true], ["store15", 3, true], ["load25", 1, true]]>, handshake.name = "store15"} : memref<100xi32>
  ...
  ^bb12(%69: index):  // 2 preds: ^bb11, ^bb14
    ...
    memref.store %c0_i32_23, %arg6[%73] {handshake.deps = #handshake<deps[["load26", 3, true], ["store17", 3, true]]>, handshake.name = "store16"} : memref<100xi32>
  ...
  ^bb13(%74: index):  // 2 preds: ^bb12, ^bb13
    ...
    %79 = memref.load %arg4[%78] {handshake.name = "load24"} : memref<100xi32>
    ...
    %84 = memref.load %arg5[%83] {handshake.name = "load25"} : memref<100xi32>
    ...
    %90 = memref.load %arg6[%89] {handshake.deps = #handshake<deps[["store17", 3, true], ["store17", 4, true]]>, handshake.name = "load26"} : memref<100xi32>
    ...
    memref.store %91, %arg6[%95] {handshake.deps = #handshake<deps[["load26", 3, true], ["store17", 3, true]]>, handshake.name = "store17"} : memref<100xi32>
