module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb4
    ...
    memref.store %c0_i32, %arg4[%3] {handshake.deps = #handshake<deps[["load20", 3, true], ["store13", 3, true], ["load24", 1, true]]>, handshake.name = "store12"} : memref<100xi32>
  ...
  ^bb3(%4: index):  // 2 preds: ^bb2, ^bb3
    ...
    %7 = memref.load %arg0[%6] {handshake.name = "load18"} : memref<100xi32>
    %8 = arith.muli %4, %c10 {handshake.name = "muli5"} : index
    %9 = arith.addi %1, %8 {handshake.name = "addi5"} : index
    %10 = memref.load %arg1[%9] {handshake.name = "load19"} : memref<100xi32>
    ...
    %14 = memref.load %arg4[%13] {handshake.deps = #handshake<deps[["store13", 3, true], ["store13", 4, true]]>, handshake.name = "load20"} : memref<100xi32>
    ...
    memref.store %15, %arg4[%17] {handshake.deps = #handshake<deps[["load20", 3, true], ["store13", 3, true], ["load24", 1, true]]>, handshake.name = "store13"} : memref<100xi32>
  ...
  ^bb8(%25: index):  // 2 preds: ^bb7, ^bb10
    ...
    memref.store %c0_i32, %arg5[%27] {handshake.deps = #handshake<deps[["load23", 3, true], ["store15", 3, true], ["load25", 1, true]]>, handshake.name = "store14"} : memref<100xi32>
  ...
  ^bb9(%28: index):  // 2 preds: ^bb8, ^bb9
    ...
    %31 = memref.load %arg2[%30] {handshake.name = "load21"} : memref<100xi32>
    %32 = arith.muli %28, %c10 {handshake.name = "muli10"} : index
    %33 = arith.addi %25, %32 {handshake.name = "addi10"} : index
    %34 = memref.load %arg3[%33] {handshake.name = "load22"} : memref<100xi32>
    ...
    %38 = memref.load %arg5[%37] {handshake.deps = #handshake<deps[["store15", 3, true], ["store15", 4, true]]>, handshake.name = "load23"} : memref<100xi32>
    ...
    memref.store %39, %arg5[%41] {handshake.deps = #handshake<deps[["load23", 3, true], ["store15", 3, true], ["load25", 1, true]]>, handshake.name = "store15"} : memref<100xi32>
  ...
  ^bb14(%49: index):  // 2 preds: ^bb13, ^bb16
    ...
    memref.store %c0_i32, %arg6[%51] {handshake.deps = #handshake<deps[["load26", 3, true], ["store17", 3, true]]>, handshake.name = "store16"} : memref<100xi32>
  ...
  ^bb15(%52: index):  // 2 preds: ^bb14, ^bb15
    ...
    %55 = memref.load %arg4[%54] {handshake.name = "load24"} : memref<100xi32>
    %56 = arith.muli %52, %c10 {handshake.name = "muli15"} : index
    %57 = arith.addi %49, %56 {handshake.name = "addi15"} : index
    %58 = memref.load %arg5[%57] {handshake.name = "load25"} : memref<100xi32>
    ...
    %62 = memref.load %arg6[%61] {handshake.deps = #handshake<deps[["store17", 3, true], ["store17", 4, true]]>, handshake.name = "load26"} : memref<100xi32>
    ...
    memref.store %63, %arg6[%65] {handshake.deps = #handshake<deps[["load26", 3, true], ["store17", 3, true]]>, handshake.name = "store17"} : memref<100xi32>
