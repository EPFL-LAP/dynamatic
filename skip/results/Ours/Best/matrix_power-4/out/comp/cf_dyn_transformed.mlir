module {
  ...
  ^bb2(%4: index):  // 2 preds: ^bb1, ^bb2
    ...
    %20 = memref.load %arg0[%19] {handshake.deps = #handshake<deps[["store1", 0, true]]>, handshake.name = "load9"} : memref<400xi32>
    ...
    memref.store %21, %arg0[%25] {handshake.deps = #handshake<deps[["load8", 0, true], ["load9", 0, true], ["store1", 0, true]]>, handshake.name = "store1"} : memref<400xi32>
