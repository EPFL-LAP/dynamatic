  ...
  func.func @matrix_power(%arg0: memref<20x20xi32> {handshake.arg_name = "mat"}, %arg1: memref<20xi32> {handshake.arg_name = "row"}, %arg2: memref<20xi32> {handshake.arg_name = "col"}, %arg3: memref<20xi32> {handshake.arg_name = "a"}) {
    ...
    affine.for %arg4 = 1 to 20 {
      ...
      affine.for %arg5 = 0 to 20 {
        ...
        %8 = memref.load %arg0[%2, %7] {handshake.deps = #handshake<deps[["store0", 0, true]]>, handshake.name = "load3"} : memref<20x20xi32>
        %9 = arith.muli %5, %8 {handshake.name = "muli0"} : i32
        %10 = memref.load %arg0[%arg4, %4] {handshake.deps = #handshake<deps[["store0", 0, true]]>, handshake.name = "load4"} : memref<20x20xi32>
        %11 = arith.addi %10, %9 {handshake.name = "addi1"} : i32
        memref.store %11, %arg0[%arg4, %4] {handshake.deps = #handshake<deps[["load3", 0, true], ["load4", 0, true], ["store0", 0, true]]>, handshake.name = "store0"} : memref<20x20xi32>
      } {handshake.name = "for0"}
    } {handshake.name = "for1"}
