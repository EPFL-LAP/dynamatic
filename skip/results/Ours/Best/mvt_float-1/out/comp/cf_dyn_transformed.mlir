module {
  ...
  ^bb1(%0: index):  // 2 preds: ^bb0, ^bb3
    ...
    %1 = memref.load %arg1[%0] {handshake.deps = #handshake<deps[["store2", 2, true]]>, handshake.name = "load6"} : memref<30xf32>
  ...
  ^bb2(%2: index, %3: f32):  // 2 preds: ^bb1, ^bb2
    ...
    %6 = memref.load %arg0[%5] {handshake.name = "load12"} : memref<900xf32>
    %7 = memref.load %arg3[%2] {handshake.name = "load8"} : memref<30xf32>
  ...
  ^bb3:  // pred: ^bb2
    ...
    memref.store %9, %arg1[%0] {handshake.name = "store2"} : memref<30xf32>
  ...
  ^bb4(%14: index):  // 2 preds: ^bb3, ^bb6
    ...
    %15 = memref.load %arg2[%14] {handshake.deps = #handshake<deps[["store3", 2, true]]>, handshake.name = "load9"} : memref<30xf32>
  ...
  ^bb5(%16: index, %17: f32):  // 2 preds: ^bb4, ^bb5
    ...
    %20 = memref.load %arg0[%19] {handshake.name = "load13"} : memref<900xf32>
    %21 = memref.load %arg4[%16] {handshake.name = "load11"} : memref<30xf32>
  ...
  ^bb6:  // pred: ^bb5
    ...
    memref.store %23, %arg2[%14] {handshake.name = "store3"} : memref<30xf32>
