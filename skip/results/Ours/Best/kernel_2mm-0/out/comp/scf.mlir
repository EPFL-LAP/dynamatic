  ...
  func.func @kernel_2mm(%arg0: i32 {handshake.arg_name = "alpha"}, %arg1: i32 {handshake.arg_name = "beta"}, %arg2: memref<100xi32> {handshake.arg_name = "tmp"}, %arg3: memref<100xi32> {handshake.arg_name = "A"}, %arg4: memref<100xi32> {handshake.arg_name = "B"}, %arg5: memref<100xi32> {handshake.arg_name = "C"}, %arg6: memref<100xi32> {handshake.arg_name = "D"}) {
    ...
    %0 = scf.while (%arg7 = %c0) : (index) -> index {
      %2 = scf.while (%arg8 = %c0) : (index) -> index {
        ...
        memref.store %c0_i32, %arg2[%6] {handshake.deps = #handshake<deps[["load16", 3, true], ["store9", 3, true], ["load18", 1, true]]>, handshake.name = "store8"} : memref<100xi32>
        %7 = scf.while (%arg9 = %c0) : (index) -> index {
          ...
          %12 = memref.load %arg3[%11] {handshake.name = "load14"} : memref<100xi32>
          ...
          %16 = memref.load %arg4[%15] {handshake.name = "load15"} : memref<100xi32>
          ...
          %20 = memref.load %arg2[%19] {handshake.deps = #handshake<deps[["store9", 3, true], ["store9", 4, true]]>, handshake.name = "load16"} : memref<100xi32>
          ...
          memref.store %21, %arg2[%23] {handshake.deps = #handshake<deps[["load16", 3, true], ["store9", 3, true], ["load18", 1, true]]>, handshake.name = "store9"} : memref<100xi32>
    ...
    %1 = scf.while (%arg7 = %c0) : (index) -> index {
      %2 = scf.while (%arg8 = %c0) : (index) -> index {
        ...
        %7 = memref.load %arg6[%6] {handshake.deps = #handshake<deps[["store10", 3, true], ["store11", 3, true]]>, handshake.name = "load17"} : memref<100xi32>
        ...
        memref.store %8, %arg6[%10] {handshake.deps = #handshake<deps[["load20", 3, true], ["store11", 3, true]]>, handshake.name = "store10"} : memref<100xi32>
        %11 = scf.while (%arg9 = %c0) : (index) -> index {
          ...
          %16 = memref.load %arg2[%15] {handshake.name = "load18"} : memref<100xi32>
          %17 = arith.muli %arg9, %c10 {handshake.name = "muli12"} : index
          %18 = arith.addi %arg8, %17 {handshake.name = "addi10"} : index
          %19 = memref.load %arg5[%18] {handshake.name = "load19"} : memref<100xi32>
          ...
          %23 = memref.load %arg6[%22] {handshake.deps = #handshake<deps[["store11", 3, true], ["store11", 4, true]]>, handshake.name = "load20"} : memref<100xi32>
          ...
          memref.store %24, %arg6[%26] {handshake.deps = #handshake<deps[["load20", 3, true], ["store11", 3, true]]>, handshake.name = "store11"} : memref<100xi32>
