module {
  ...
  ^bb3(%6: index, %7: i32, %8: i32):  // 2 preds: ^bb2, ^bb3
    ...
    %12 = memref.load %arg1[%11] {handshake.deps = #handshake<deps[["store1", 0, true]]>, handshake.name = "load4"} : memref<400xi32>
    %13 = memref.load %arg0[%0] {handshake.name = "load3"} : memref<20xi32>
    %14 = arith.muli %0, %c20 {handshake.name = "muli2"} : index
    %15 = arith.addi %9, %14 {handshake.name = "addi4"} : index
    %16 = memref.load %arg1[%15] {handshake.deps = #handshake<deps[["store1", 0, true]]>, handshake.name = "load5"} : memref<400xi32>
    ...
    memref.store %18, %arg1[%20] {handshake.deps = #handshake<deps[["load4", 0, true], ["load5", 0, true], ["store1", 0, true]]>, handshake.name = "store1"} : memref<400xi32>
