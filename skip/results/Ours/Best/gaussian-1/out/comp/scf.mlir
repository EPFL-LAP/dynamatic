    ...
    %1:2 = scf.while (%arg2 = %c1, %arg3 = %c0_i32) : (index, i32) -> (index, i32) {
      ...
      %3 = scf.for %arg4 = %2 to %c19 step %c1 iter_args(%arg5 = %arg3) -> (i32) {
        %6:7 = scf.while (%arg6 = %c1, %arg7 = %c1_i32, %arg8 = %arg5, %arg9 = %arg5, %arg10 = %0, %arg11 = %c1_i32, %arg12 = %arg5) : (index, i32, i32, i32, i32, i32, i32) -> (index, i32, i32, i32, i32, i32, i32) {
          ...
          %10 = memref.load %arg1[%9] {handshake.deps = #handshake<deps[["store1", 0, true]]>, handshake.name = "load4"} : memref<400xi32>
          %11 = memref.load %arg0[%arg2] {handshake.name = "load3"} : memref<20xi32>
          %12 = arith.muli %arg2, %c20 {handshake.name = "muli2"} : index
          %13 = arith.addi %7, %12 {handshake.name = "addi4"} : index
          %14 = memref.load %arg1[%13] {handshake.deps = #handshake<deps[["store1", 0, true]]>, handshake.name = "load5"} : memref<400xi32>
          ...
          memref.store %16, %arg1[%18] {handshake.deps = #handshake<deps[["load4", 0, true], ["load5", 0, true], ["store1", 0, true]]>, handshake.name = "store1"} : memref<400xi32>
