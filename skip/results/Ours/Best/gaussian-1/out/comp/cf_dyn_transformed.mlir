module {
  ...
  ^bb3(%6: index, %7: i32, %8: i32):  // 2 preds: ^bb2, ^bb3
    ...
    %14 = memref.load %arg1[%13] {handshake.deps = #handshake<deps[["store1", 0, true]]>, handshake.name = "load4"} : memref<400xi32>
    %15 = memref.load %arg0[%0] {handshake.name = "load3"} : memref<20xi32>
    ...
    %20 = memref.load %arg1[%19] {handshake.deps = #handshake<deps[["store1", 0, true]]>, handshake.name = "load5"} : memref<400xi32>
    ...
    memref.store %22, %arg1[%26] {handshake.deps = #handshake<deps[["load4", 0, true], ["load5", 0, true], ["store1", 0, true]]>, handshake.name = "store1"} : memref<400xi32>
