module {
  ...
  ^bb1(%0: index):  // 2 preds: ^bb0, ^bb3
    ...
    %1 = memref.load %arg1[%0] {handshake.name = "load2"} : memref<1000xi32>
  ...
  ^bb3(%11: f32):  // 2 preds: ^bb1, ^bb2
    ...
    memref.store %11, %arg0[%2] {handshake.deps = #handshake<deps[["load1", 0, true], ["store0", 0, true]]>, handshake.name = "store0"} : memref<1000xf32>
