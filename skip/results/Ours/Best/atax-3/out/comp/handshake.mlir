module {
  handshake.func @atax(%arg0: memref<400xf32>, %arg1: memref<20xf32>, %arg2: memref<20xf32>, %arg3: memref<20xf32>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["A", "x", "y", "tmp", "A_start", "x_start", "y_start", "tmp_start", "start"], cfg.edges = "[0,1][2,2,3,cmpi0][4,1,5,cmpi2][1,2][3,3,4,cmpi1]", resNames = ["A_end", "x_end", "y_end", "tmp_end", "end"]} {
    %0:3 = lsq[%arg3 : memref<20xf32>] (%arg7, %result, %addressResult, %result_32, %addressResult_34, %dataResult_35, %result_41)  {groupSizes = [1 : i32, 1 : i32], handshake.name = "lsq0"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<f32>, !handshake.control<>) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>)
    %1:3 = lsq[%arg2 : memref<20xf32>] (%arg6, %result_16, %addressResult_18, %addressResult_22, %dataResult_23, %result_41)  {groupSizes = [2 : i32], handshake.name = "lsq1"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<f32>, !handshake.control<>) -> (!handshake.channel<f32>, !handshake.control<>, !handshake.control<>)
    %outputs, %memEnd = mem_controller[%arg1 : memref<20xf32>] %arg5 (%addressResult_6) %result_41 {connectedBlocks = [2 : i32], handshake.name = "mem_controller0"} :    (!handshake.channel<i32>) -> !handshake.channel<f32>
    %outputs_0:2, %memEnd_1 = mem_controller[%arg0 : memref<400xf32>] %arg4 (%addressResult_4, %addressResult_20) %result_41 {connectedBlocks = [2 : i32, 3 : i32], handshake.name = "mem_controller1"} :    (!handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.channel<f32>, !handshake.channel<f32>)
    ...
    %5 = mux %index [%3, %trueResult_37] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, [<i32>, <i32>] to <i32>
    %result, %index = control_merge [%4, %trueResult_39]  {handshake.bb = 1 : ui32, handshake.name = "control_merge0"} : [<>, <>] to <>, <i1>
    %6 = constant %result {handshake.bb = 1 : ui32, handshake.name = "constant5", value = 0 : i32} : <>, <i32>
    %addressResult, %dataResult = load[%5] %0#0 {handshake.bb = 1 : ui32, handshake.deps = #handshake<deps[["store1", 2, true]]>, handshake.name = "load0"} : <i32>, <f32>, <i32>, <f32>
    ...
    %addressResult_18, %dataResult_19 = load[%31] %1#0 {handshake.bb = 3 : ui32, handshake.deps = #handshake<deps[["store0", 1, true], ["store0", 3, true]]>, handshake.name = "load3"} : <i32>, <f32>, <i32>, <f32>
    ...
    %addressResult_22, %dataResult_23, %doneResult = store[%31] %47 %1#1 {handshake.bb = 3 : ui32, handshake.deps = #handshake<deps[["load3", 1, true], ["store0", 1, true]]>, handshake.name = "store0"} : <i32>, <f32>, <>, <i32>, <f32>, <>
    ...
    %addressResult_34, %dataResult_35, %doneResult_36 = store[%50] %51 %0#1 {handshake.bb = 4 : ui32, handshake.name = "store1"} : <i32>, <f32>, <>, <i32>, <f32>, <>
    %56 = addi %50, %55 {handshake.bb = 4 : ui32, handshake.name = "addi4"} : <i32>
    %57 = cmpi ult, %56, %53 {handshake.bb = 4 : ui32, handshake.name = "cmpi2"} : <i32>
    %trueResult_37, %falseResult_38 = cond_br %57, %56 {handshake.bb = 4 : ui32, handshake.name = "cond_br12"} : <i1>, <i32>
    %trueResult_39, %falseResult_40 = cond_br %57, %result_32 {handshake.bb = 4 : ui32, handshake.name = "cond_br13"} : <i1>, <>
    %result_41, %index_42 = control_merge [%falseResult_40]  {handshake.bb = 5 : ui32, handshake.name = "control_merge4"} : [<>] to <>, <i1>
    end {handshake.bb = 5 : ui32, handshake.name = "end0"} %memEnd_1, %memEnd, %1#2, %0#2, %arg8 : <>, <>, <>, <>, <>
  }
}
