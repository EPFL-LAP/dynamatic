module {
  func.func @atax(%arg0: memref<20x20xf32> {handshake.arg_name = "A"}, %arg1: memref<20xf32> {handshake.arg_name = "x"}, %arg2: memref<20xf32> {handshake.arg_name = "y"}, %arg3: memref<20xf32> {handshake.arg_name = "tmp"}) {
    affine.for %arg4 = 0 to 20 {
      %0 = affine.load %arg3[%arg4] {handshake.deps = #handshake<deps[["store1", 2, true]]>, handshake.name = "load0"} : memref<20xf32>
      ...
      affine.for %arg5 = 0 to 20 {
        %2 = affine.load %arg2[%arg5] {handshake.deps = #handshake<deps[["store0", 1, true], ["store0", 3, true]]>, handshake.name = "load3"} : memref<20xf32>
        ...
        affine.store %5, %arg2[%arg5] {handshake.deps = #handshake<deps[["load3", 1, true], ["store0", 1, true]]>, handshake.name = "store0"} : memref<20xf32>
      } {handshake.name = "for1"}
