module {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %16 = memref.load %arg0[%15] {handshake.name = "load4"} : memref<10xi32>
    ...
    %24 = memref.load %arg2[%23] {handshake.deps = #handshake<deps[["store2", 1, true], ["store2", 3, true]]>, handshake.name = "load7"} : memref<100xi32>
    ...
    memref.store %25, %arg2[%31] {handshake.deps = #handshake<deps[["load7", 1, true], ["store2", 1, true]]>, handshake.name = "store2"} : memref<100xi32>
