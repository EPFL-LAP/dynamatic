module {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %17 = memref.load %arg2[%16] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load6"} : memref<100xi32>
    %18 = arith.addi %3, %c-1_1 {handshake.name = "addi8"} : index
    %19 = memref.load %arg0[%18] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load4"} : memref<10xi32>
    ...
    %30 = memref.load %arg2[%29] {handshake.deps = #handshake<deps[["store2", 1, true], ["store2", 3, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load7"} : memref<100xi32>
    ...
    memref.store %31, %arg2[%40] {handshake.deps = #handshake<deps[["load7", 1, true], ["store2", 1, true]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store2"} : memref<100xi32>
