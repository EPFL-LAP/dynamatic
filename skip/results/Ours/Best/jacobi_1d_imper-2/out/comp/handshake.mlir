module {
  handshake.func @jacobi_1d_imper(%arg0: memref<100xi32>, %arg1: memref<100xi32>, %arg2: !handshake.control<>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["A", "B", "A_start", "B_start", "start"], cfg.edges = "[0,1][2,2,3,cmpi0][4,1,5,cmpi2][1,2][3,3,4,cmpi1]", resNames = ["A_end", "B_end", "end"]} {
    ...
    %5 = mux %index [%3, %trueResult_29] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, [<i32>, <i32>] to <i32>
    %result, %index = control_merge [%4, %trueResult_31]  {handshake.bb = 1 : ui32, handshake.name = "control_merge0"} : [<>, <>] to <>, <i1>
    ...
    %addressResult, %dataResult = load[%19] %1#0 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store1", 1, true], ["store1", 2, true]]>, handshake.name = "load0"} : <i32>, <i32>, <i32>, <i32>
    %addressResult_2, %dataResult_3 = load[%10] %1#1 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store1", 1, true], ["store1", 2, true]]>, handshake.name = "load1"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_4, %dataResult_5 = load[%21] %1#2 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store1", 1, true], ["store1", 2, true]]>, handshake.name = "load2"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_6, %dataResult_7, %doneResult = store[%10] %24 %0#0 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store0", 1, true], ["load3", 1, true], ["load3", 2, true]]>, handshake.name = "store0"} : <i32>, <i32>, <>, <i32>, <i32>, <>
    ...
    %27 = mux %index_15 [%falseResult_13, %trueResult_21] {handshake.bb = 3 : ui32, handshake.name = "mux3"} : <i1>, [<i32>, <i32>] to <i32>
    %28 = mux %index_15 [%falseResult_9, %trueResult_23] {handshake.bb = 3 : ui32, handshake.name = "mux4"} : <i1>, [<i32>, <i32>] to <i32>
    %result_14, %index_15 = control_merge [%falseResult_11, %trueResult_25]  {handshake.bb = 3 : ui32, handshake.name = "control_merge2"} : [<>, <>] to <>, <i1>
    ...
    %addressResult_16, %dataResult_17 = load[%27] %0#1 {handshake.bb = 3 : ui32, handshake.deps = #handshake<deps[["store0", 1, true]]>, handshake.name = "load3"} : <i32>, <i32>, <i32>, <i32>
    %addressResult_18, %dataResult_19, %doneResult_20 = store[%27] %dataResult_17 %1#3 {handshake.bb = 3 : ui32, handshake.deps = #handshake<deps[["load0", 1, true], ["load1", 1, true], ["load2", 1, true], ["store1", 1, true]]>, handshake.name = "store1"} : <i32>, <i32>, <>, <i32>, <i32>, <>
    %33 = addi %27, %32 {handshake.bb = 3 : ui32, handshake.name = "addi5"} : <i32>
    %34 = cmpi ult, %33, %30 {handshake.bb = 3 : ui32, handshake.name = "cmpi1"} : <i32>
    %trueResult_21, %falseResult_22 = cond_br %34, %33 {handshake.bb = 3 : ui32, handshake.name = "cond_br7"} : <i1>, <i32>
    %trueResult_23, %falseResult_24 = cond_br %34, %28 {handshake.bb = 3 : ui32, handshake.name = "cond_br8"} : <i1>, <i32>
    %trueResult_25, %falseResult_26 = cond_br %34, %result_14 {handshake.bb = 3 : ui32, handshake.name = "cond_br9"} : <i1>, <>
    %35 = merge %falseResult_24 {handshake.bb = 4 : ui32, handshake.name = "merge0"} : <i32>
    ...
    %trueResult_29, %falseResult_30 = cond_br %41, %40 {handshake.bb = 4 : ui32, handshake.name = "cond_br10"} : <i1>, <i32>
    %trueResult_31, %falseResult_32 = cond_br %41, %result_27 {handshake.bb = 4 : ui32, handshake.name = "cond_br11"} : <i1>, <>
    %result_33, %index_34 = control_merge [%falseResult_32]  {handshake.bb = 5 : ui32, handshake.name = "control_merge4"} : [<>] to <>, <i1>
    end {handshake.bb = 5 : ui32, handshake.name = "end0"} %1#4, %0#2, %arg4 : <>, <>, <>
  }
}
