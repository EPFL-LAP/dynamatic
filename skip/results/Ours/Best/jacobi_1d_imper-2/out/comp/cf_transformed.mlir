module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb2
    ...
    memref.store %9, %arg1[%1] {handshake.deps = #handshake<deps[["store2", 1, true], ["load7", 1, true], ["load7", 2, true]]>, handshake.name = "store2"} : memref<100xi32>
  ...
  ^bb3(%12: index):  // 2 preds: ^bb2, ^bb3
    %13 = memref.load %arg1[%12] {handshake.deps = #handshake<deps[["store2", 1, true]]>, handshake.name = "load7"} : memref<100xi32>
    memref.store %13, %arg0[%12] {handshake.deps = #handshake<deps[["load4", 1, true], ["load5", 1, true], ["load6", 1, true], ["store3", 1, true]]>, handshake.name = "store3"} : memref<100xi32>
