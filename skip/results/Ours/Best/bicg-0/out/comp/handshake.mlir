module {
  handshake.func @bicg(%arg0: memref<900xi32>, %arg1: memref<30xi32>, %arg2: memref<30xi32>, %arg3: memref<30xi32>, %arg4: memref<30xi32>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, %arg9: !handshake.control<>, %arg10: !handshake.control<>, ...) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["a", "s", "q", "p", "r", "a_start", "s_start", "q_start", "p_start", "r_start", "start"], cfg.edges = "[0,1][2,2,3,cmpi0][1,2][3,1,4,cmpi1]", resNames = ["out0", "a_end", "s_end", "q_end", "p_end", "r_end", "end"]} {
    %outputs, %memEnd = mem_controller[%arg4 : memref<30xi32>] %arg9 (%addressResult_10) %result_33 {connectedBlocks = [2 : i32], handshake.name = "mem_controller0"} :    (!handshake.channel<i32>) -> !handshake.channel<i32>
    %outputs_0, %memEnd_1 = mem_controller[%arg3 : memref<30xi32>] %arg8 (%addressResult_14) %result_33 {connectedBlocks = [2 : i32], handshake.name = "mem_controller1"} :    (!handshake.channel<i32>) -> !handshake.channel<i32>
    %0:3 = lsq[%arg2 : memref<30xi32>] (%arg7, %result, %addressResult, %result_22, %addressResult_24, %dataResult_25, %result_33)  {groupSizes = [1 : i32, 1 : i32], handshake.name = "lsq0"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>)
    %1:3 = lsq[%arg1 : memref<30xi32>] (%arg6, %result_4, %addressResult_8, %addressResult_12, %dataResult_13, %result_33)  {groupSizes = [2 : i32], handshake.name = "lsq1"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>) -> (!handshake.channel<i32>, !handshake.control<>, !handshake.control<>)
    %outputs_2, %memEnd_3 = mem_controller[%arg0 : memref<900xi32>] %arg5 (%addressResult_6) %result_33 {connectedBlocks = [2 : i32], handshake.name = "mem_controller2"} :    (!handshake.channel<i32>) -> !handshake.channel<i32>
    ...
    %5 = mux %index [%3, %trueResult_27] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, [<i32>, <i32>] to <i32>
    %result, %index = control_merge [%4, %trueResult_29]  {handshake.bb = 1 : ui32, handshake.name = "control_merge0"} : [<>, <>] to <>, <i1>
    %6 = constant %result {handshake.bb = 1 : ui32, handshake.name = "constant3", value = 0 : i32} : <>, <i32>
    %addressResult, %dataResult = load[%5] %0#0 {handshake.bb = 1 : ui32, handshake.deps = #handshake<deps[["store1", 2, true]]>, handshake.name = "load0"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_8, %dataResult_9 = load[%11] %1#0 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store0", 1, true], ["store0", 3, true]]>, handshake.name = "load2"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_12, %dataResult_13, %doneResult = store[%11] %21 %1#1 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["load2", 1, true], ["store0", 1, true]]>, handshake.name = "store0"} : <i32>, <i32>, <>, <i32>, <i32>, <>
    ...
    %addressResult_24, %dataResult_25, %doneResult_26 = store[%26] %27 %0#1 {handshake.bb = 3 : ui32, handshake.name = "store1"} : <i32>, <i32>, <>, <i32>, <i32>, <>
    %32 = addi %26, %31 {handshake.bb = 3 : ui32, handshake.name = "addi4"} : <i32>
    %33 = cmpi ult, %32, %29 {handshake.bb = 3 : ui32, handshake.name = "cmpi1"} : <i32>
    %trueResult_27, %falseResult_28 = cond_br %33, %32 {handshake.bb = 3 : ui32, handshake.name = "cond_br6"} : <i1>, <i32>
    %trueResult_29, %falseResult_30 = cond_br %33, %result_22 {handshake.bb = 3 : ui32, handshake.name = "cond_br7"} : <i1>, <>
    %trueResult_31, %falseResult_32 = cond_br %33, %27 {handshake.bb = 3 : ui32, handshake.name = "cond_br8"} : <i1>, <i32>
    %34 = merge %falseResult_32 {handshake.bb = 4 : ui32, handshake.name = "merge2"} : <i32>
    %result_33, %index_34 = control_merge [%falseResult_30]  {handshake.bb = 4 : ui32, handshake.name = "control_merge3"} : [<>] to <>, <i1>
    end {handshake.bb = 4 : ui32, handshake.name = "end0"} %34, %memEnd_3, %1#2, %0#2, %memEnd_1, %memEnd, %arg10 : <i32>, <>, <>, <>, <>, <>, <>
  }
}
