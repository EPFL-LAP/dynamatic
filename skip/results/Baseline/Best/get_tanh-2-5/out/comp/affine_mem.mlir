module {
  func.func @get_tanh(%arg0: memref<1000xf32> {handshake.arg_name = "A"}, %arg1: memref<1000xi32> {handshake.arg_name = "addr"}) {
    ...
    affine.for %arg2 = 0 to 1000 {
      ...
      %2 = memref.load %arg0[%1] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load1"} : memref<1000xf32>
      ...
      memref.store %4, %arg0[%1] {handshake.deps = #handshake<deps[["load1", 0], ["store0", 0]]>, handshake.name = "store0"} : memref<1000xf32>
    } {handshake.name = "for0"}
