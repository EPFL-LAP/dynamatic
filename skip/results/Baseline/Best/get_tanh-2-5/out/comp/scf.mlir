module {
  func.func @get_tanh(%arg0: memref<1000xf32> {handshake.arg_name = "A"}, %arg1: memref<1000xi32> {handshake.arg_name = "addr"}) {
    ...
    %0 = scf.while (%arg2 = %c0) : (index) -> index {
      %1 = memref.load %arg1[%arg2] {handshake.name = "load0"} : memref<1000xi32>
      ...
      memref.store %5, %arg0[%2] {handshake.deps = #handshake<deps[["load1", 0], ["store0", 0]]>, handshake.name = "store0"} : memref<1000xf32>
