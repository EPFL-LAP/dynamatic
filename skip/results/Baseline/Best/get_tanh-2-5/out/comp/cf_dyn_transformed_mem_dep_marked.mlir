module {
  ...
  ^bb1(%0: index):  // 2 preds: ^bb0, ^bb3
    ...
    %1 = memref.load %arg1[%0] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load0"} : memref<1000xi32>
    %2 = arith.index_cast %1 {handshake.name = "index_cast0"} : i32 to index
    %3 = memref.load %arg0[%2] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load1"} : memref<1000xf32>
  ...
  ^bb3(%11: f32):  // 2 preds: ^bb1, ^bb2
    ...
    memref.store %11, %arg0[%2] {handshake.deps = #handshake<deps[["load1", 0], ["store0", 0]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store0"} : memref<1000xf32>
