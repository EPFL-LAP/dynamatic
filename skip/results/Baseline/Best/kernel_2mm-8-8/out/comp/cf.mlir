module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb4
    ...
    memref.store %c0_i32, %arg2[%3] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load4", 1]]>, handshake.name = "store0"} : memref<100xi32>
  ...
  ^bb3(%4: index):  // 2 preds: ^bb2, ^bb3
    ...
    %7 = memref.load %arg3[%6] {handshake.name = "load0"} : memref<100xi32>
    ...
    %11 = memref.load %arg4[%10] {handshake.name = "load1"} : memref<100xi32>
    ...
    %15 = memref.load %arg2[%14] {handshake.deps = #handshake<deps[["store1", 3], ["store1", 4]]>, handshake.name = "load2"} : memref<100xi32>
    ...
    memref.store %16, %arg2[%18] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load4", 1]]>, handshake.name = "store1"} : memref<100xi32>
  ...
  ^bb8(%26: index):  // 2 preds: ^bb7, ^bb10
    ...
    %29 = memref.load %arg6[%28] {handshake.deps = #handshake<deps[["store2", 3], ["store3", 3]]>, handshake.name = "load3"} : memref<100xi32>
    ...
    memref.store %30, %arg6[%32] {handshake.deps = #handshake<deps[["load6", 3], ["store3", 3]]>, handshake.name = "store2"} : memref<100xi32>
  ...
  ^bb9(%33: index):  // 2 preds: ^bb8, ^bb9
    ...
    %36 = memref.load %arg2[%35] {handshake.name = "load4"} : memref<100xi32>
    %37 = arith.muli %33, %c10 {handshake.name = "muli12"} : index
    %38 = arith.addi %26, %37 {handshake.name = "addi10"} : index
    %39 = memref.load %arg5[%38] {handshake.name = "load5"} : memref<100xi32>
    ...
    %43 = memref.load %arg6[%42] {handshake.deps = #handshake<deps[["store3", 3], ["store3", 4]]>, handshake.name = "load6"} : memref<100xi32>
    ...
    memref.store %44, %arg6[%46] {handshake.deps = #handshake<deps[["load6", 3], ["store3", 3]]>, handshake.name = "store3"} : memref<100xi32>
