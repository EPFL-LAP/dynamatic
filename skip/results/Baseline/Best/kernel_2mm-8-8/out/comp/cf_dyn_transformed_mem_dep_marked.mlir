module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb4
    ...
    memref.store %c0_i32, %arg2[%5] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load4", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store0"} : memref<100xi32>
  ...
  ^bb3(%6: index):  // 2 preds: ^bb2, ^bb3
    ...
    %11 = memref.load %arg3[%10] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load0"} : memref<100xi32>
    ...
    %17 = memref.load %arg4[%16] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load1"} : memref<100xi32>
    ...
    %23 = memref.load %arg2[%22] {handshake.deps = #handshake<deps[["store1", 3], ["store1", 4]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load2"} : memref<100xi32>
    ...
    memref.store %24, %arg2[%28] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load4", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store1"} : memref<100xi32>
  ...
  ^bb7(%36: index):  // 2 preds: ^bb6, ^bb9
    ...
    %41 = memref.load %arg6[%40] {handshake.deps = #handshake<deps[["store2", 3], ["store3", 3]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load3"} : memref<100xi32>
    ...
    memref.store %42, %arg6[%46] {handshake.deps = #handshake<deps[["load6", 3], ["store3", 3]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store2"} : memref<100xi32>
  ...
  ^bb8(%47: index):  // 2 preds: ^bb7, ^bb8
    ...
    %52 = memref.load %arg2[%51] {handshake.mem_interface = #handshake.mem_interface<LSQ: 2>, handshake.name = "load4"} : memref<100xi32>
    ...
    %57 = memref.load %arg5[%56] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load5"} : memref<100xi32>
    ...
    %63 = memref.load %arg6[%62] {handshake.deps = #handshake<deps[["store3", 3], ["store3", 4]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load6"} : memref<100xi32>
    ...
    memref.store %64, %arg6[%68] {handshake.deps = #handshake<deps[["load6", 3], ["store3", 3]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store3"} : memref<100xi32>
