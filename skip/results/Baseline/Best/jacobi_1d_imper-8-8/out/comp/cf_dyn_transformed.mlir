module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb2
    ...
    memref.store %10, %arg1[%1] {handshake.deps = #handshake<deps[["store0", 1], ["load3", 1], ["load3", 2]]>, handshake.name = "store0"} : memref<100xi32>
  ...
  ^bb3(%13: index):  // 2 preds: ^bb2, ^bb3
    ...
    %14 = memref.load %arg1[%13] {handshake.deps = #handshake<deps[["store0", 1]]>, handshake.name = "load3"} : memref<100xi32>
    memref.store %14, %arg0[%13] {handshake.deps = #handshake<deps[["load0", 1], ["load1", 1], ["load2", 1], ["store1", 1]]>, handshake.name = "store1"} : memref<100xi32>
