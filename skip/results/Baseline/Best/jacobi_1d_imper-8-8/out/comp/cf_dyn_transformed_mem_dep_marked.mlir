module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb2
    ...
    %3 = memref.load %arg0[%2] {handshake.deps = #handshake<deps[["store1", 1], ["store1", 2]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load0"} : memref<100xi32>
    %4 = memref.load %arg0[%1] {handshake.deps = #handshake<deps[["store1", 1], ["store1", 2]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load1"} : memref<100xi32>
    %5 = arith.addi %3, %4 {handshake.name = "addi0"} : i32
    %6 = arith.addi %1, %c1_0 {handshake.name = "addi3"} : index
    %7 = memref.load %arg0[%6] {handshake.deps = #handshake<deps[["store1", 1], ["store1", 2]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load2"} : memref<100xi32>
    ...
    memref.store %10, %arg1[%1] {handshake.deps = #handshake<deps[["store0", 1], ["load3", 1], ["load3", 2]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store0"} : memref<100xi32>
  ...
  ^bb3(%13: index):  // 2 preds: ^bb2, ^bb3
    ...
    %14 = memref.load %arg1[%13] {handshake.deps = #handshake<deps[["store0", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load3"} : memref<100xi32>
    memref.store %14, %arg0[%13] {handshake.deps = #handshake<deps[["load0", 1], ["load1", 1], ["load2", 1], ["store1", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store1"} : memref<100xi32>
