module {
  ...
  ^bb2(%4: index):  // 2 preds: ^bb1, ^bb2
    ...
    %20 = memref.load %arg0[%19] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load4"} : memref<400xi32>
    ...
    memref.store %21, %arg0[%25] {handshake.deps = #handshake<deps[["load3", 0], ["load4", 0], ["store0", 0]]>, handshake.name = "store0"} : memref<400xi32>
