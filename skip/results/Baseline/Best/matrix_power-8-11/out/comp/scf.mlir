  ...
  func.func @matrix_power(%arg0: memref<400xi32> {handshake.arg_name = "mat"}, %arg1: memref<20xi32> {handshake.arg_name = "row"}, %arg2: memref<20xi32> {handshake.arg_name = "col"}, %arg3: memref<20xi32> {handshake.arg_name = "a"}) {
    ...
    %0 = scf.while (%arg4 = %c1) : (index) -> index {
      ...
      %4 = scf.while (%arg5 = %c0) : (index) -> index {
        %7 = memref.load %arg1[%arg5] {handshake.name = "load0"} : memref<20xi32>
        %8 = arith.index_cast %7 {handshake.name = "index_cast2"} : i32 to index
        %9 = memref.load %arg3[%arg5] {handshake.name = "load1"} : memref<20xi32>
        %10 = memref.load %arg2[%arg5] {handshake.name = "load2"} : memref<20xi32>
        ...
        %14 = memref.load %arg0[%13] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load3"} : memref<400xi32>
        ...
        %18 = memref.load %arg0[%17] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load4"} : memref<400xi32>
        ...
        memref.store %19, %arg0[%21] {handshake.deps = #handshake<deps[["load3", 0], ["load4", 0], ["store0", 0]]>, handshake.name = "store0"} : memref<400xi32>
