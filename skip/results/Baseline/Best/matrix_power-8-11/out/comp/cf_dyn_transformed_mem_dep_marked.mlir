module {
  ...
  ^bb2(%4: index):  // 2 preds: ^bb1, ^bb2
    ...
    %5 = memref.load %arg1[%4] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load0"} : memref<20xi32>
    %6 = arith.index_cast %5 {handshake.name = "index_cast2"} : i32 to index
    %7 = memref.load %arg3[%4] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load1"} : memref<20xi32>
    %8 = memref.load %arg2[%4] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load2"} : memref<20xi32>
    ...
    %14 = memref.load %arg0[%13] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load3"} : memref<400xi32>
    ...
    %20 = memref.load %arg0[%19] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load4"} : memref<400xi32>
    ...
    memref.store %21, %arg0[%25] {handshake.deps = #handshake<deps[["load3", 0], ["load4", 0], ["store0", 0]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store0"} : memref<400xi32>
