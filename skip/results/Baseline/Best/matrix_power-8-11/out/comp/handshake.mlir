module {
  handshake.func @matrix_power(%arg0: memref<400xi32>, %arg1: memref<20xi32>, %arg2: memref<20xi32>, %arg3: memref<20xi32>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["mat", "row", "col", "a", "mat_start", "row_start", "col_start", "a_start", "start"], resNames = ["mat_end", "row_end", "col_end", "a_end", "end"]} {
    ...
    %0:3 = lsq[%arg0 : memref<400xi32>] (%arg4, %result_4, %addressResult_10, %addressResult_12, %addressResult_14, %dataResult_15, %result_28)  {groupSizes = [3 : i32], handshake.name = "lsq0"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>) -> (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>)
    ...
    %addressResult_10, %dataResult_11 = load[%31] %0#0 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load3"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_12, %dataResult_13 = load[%36] %0#1 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load4"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_14, %dataResult_15 = store[%41] %37 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["load3", 0], ["load4", 0], ["store0", 0]]>, handshake.name = "store0"} : <i32>, <i32>, <i32>, <i32>
    ...
    end {handshake.bb = 4 : ui32, handshake.name = "end0"} %0#2, %memEnd_3, %memEnd_1, %memEnd, %arg8 : <>, <>, <>, <>, <>
  }
}
