module {
  ...
  ^bb2(%4: index):  // 2 preds: ^bb1, ^bb2
    %5 = memref.load %arg1[%4] {handshake.name = "load0"} : memref<20xi32>
    %6 = arith.index_cast %5 {handshake.name = "index_cast2"} : i32 to index
    %7 = memref.load %arg3[%4] {handshake.name = "load1"} : memref<20xi32>
    %8 = memref.load %arg2[%4] {handshake.name = "load2"} : memref<20xi32>
    ...
    %12 = memref.load %arg0[%11] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load3"} : memref<400xi32>
    ...
    %16 = memref.load %arg0[%15] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load4"} : memref<400xi32>
    ...
    memref.store %17, %arg0[%19] {handshake.deps = #handshake<deps[["load3", 0], ["load4", 0], ["store0", 0]]>, handshake.name = "store0"} : memref<400xi32>
