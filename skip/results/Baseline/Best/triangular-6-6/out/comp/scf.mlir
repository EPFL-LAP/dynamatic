  ...
  func.func @triangular(%arg0: memref<10xi32> {handshake.arg_name = "x"}, %arg1: i32 {handshake.arg_name = "n"}, %arg2: memref<100xi32> {handshake.arg_name = "a"}) {
    ...
    scf.for %arg3 = %c0 to %0 step %c1 {
      ...
      scf.for %arg4 = %c0 to %3 step %c1 {
        ...
        %18 = memref.load %arg0[%17] {handshake.name = "load1"} : memref<10xi32>
        ...
        %27 = memref.load %arg2[%26] {handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load2"} : memref<100xi32>
        ...
        memref.store %28, %arg2[%35] {handshake.deps = #handshake<deps[["load2", 1], ["store0", 1]]>, handshake.name = "store0"} : memref<100xi32>
      } {handshake.name = "for2"}
    } {handshake.name = "for3"}
