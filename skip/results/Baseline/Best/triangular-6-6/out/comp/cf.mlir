module {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %18 = memref.load %arg2[%17] {handshake.name = "load0"} : memref<100xi32>
    ...
    %22 = memref.load %arg0[%21] {handshake.name = "load1"} : memref<10xi32>
    ...
    %31 = memref.load %arg2[%30] {handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load2"} : memref<100xi32>
    ...
    memref.store %32, %arg2[%39] {handshake.deps = #handshake<deps[["load2", 1], ["store0", 1]]>, handshake.name = "store0"} : memref<100xi32>
