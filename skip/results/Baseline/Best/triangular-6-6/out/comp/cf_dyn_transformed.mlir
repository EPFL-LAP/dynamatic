module {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %17 = memref.load %arg2[%16] {handshake.name = "load0"} : memref<100xi32>
    %18 = arith.addi %3, %c-1_1 {handshake.name = "addi8"} : index
    %19 = memref.load %arg0[%18] {handshake.name = "load1"} : memref<10xi32>
    ...
    %30 = memref.load %arg2[%29] {handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load2"} : memref<100xi32>
    ...
    memref.store %31, %arg2[%40] {handshake.deps = #handshake<deps[["load2", 1], ["store0", 1]]>, handshake.name = "store0"} : memref<100xi32>
