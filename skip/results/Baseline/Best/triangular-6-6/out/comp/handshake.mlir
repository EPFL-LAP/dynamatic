module {
  handshake.func @triangular(%arg0: memref<10xi32>, %arg1: !handshake.channel<i32>, %arg2: memref<100xi32>, %arg3: !handshake.control<>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["x", "n", "a", "x_start", "a_start", "start"], resNames = ["x_end", "a_end", "end"]} {
    %outputs:2, %memEnd = mem_controller[%arg2 : memref<100xi32>] %arg4 (%28, %addressResult, %0#1, %0#2, %0#3) %result_32 {connectedBlocks = [4 : i32], handshake.name = "mem_controller0"} :    (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.channel<i32>, !handshake.channel<i32>)
    %0:4 = lsq[MC] (%result_22, %addressResult_26, %addressResult_28, %dataResult_29, %outputs#1)  {groupSizes = [2 : i32], handshake.name = "lsq0"} : (!handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>)
    ...
    %addressResult_26, %dataResult_27 = load[%62] %0#0 {handshake.bb = 4 : ui32, handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load2"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_28, %dataResult_29 = store[%72] %63 {handshake.bb = 4 : ui32, handshake.deps = #handshake<deps[["load2", 1], ["store0", 1]]>, handshake.name = "store0"} : <i32>, <i32>, <i32>, <i32>
