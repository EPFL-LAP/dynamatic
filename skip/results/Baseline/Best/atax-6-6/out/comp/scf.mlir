module {
  func.func @atax(%arg0: memref<400xf32> {handshake.arg_name = "A"}, %arg1: memref<20xf32> {handshake.arg_name = "x"}, %arg2: memref<20xf32> {handshake.arg_name = "y"}, %arg3: memref<20xf32> {handshake.arg_name = "tmp"}) {
    ...
    %0 = scf.while (%arg4 = %c0) : (index) -> index {
      %1 = memref.load %arg3[%arg4] {handshake.deps = #handshake<deps[["store1", 2]]>, handshake.name = "load0"} : memref<20xf32>
      %2:2 = scf.while (%arg5 = %c0, %arg6 = %1) : (index, f32) -> (index, f32) {
        ...
        %8 = memref.load %arg0[%7] {handshake.name = "load1"} : memref<400xf32>
        %9 = memref.load %arg1[%arg5] {handshake.name = "load2"} : memref<20xf32>
      ...
      %3 = scf.while (%arg5 = %c0) : (index) -> index {
        %6 = memref.load %arg2[%arg5] {handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load3"} : memref<20xf32>
        %7 = arith.muli %arg4, %c20 {handshake.name = "muli1"} : index
        %8 = arith.addi %arg5, %7 {handshake.name = "addi1"} : index
        %9 = memref.load %arg0[%8] {handshake.name = "load4"} : memref<400xf32>
        %10 = arith.mulf %9, %2#1 {handshake.name = "mulf1"} : f32
        %11 = arith.addf %6, %10 {handshake.name = "addf1"} : f32
        memref.store %11, %arg2[%arg5] {handshake.deps = #handshake<deps[["load3", 1], ["store0", 1]]>, handshake.name = "store0"} : memref<20xf32>
      ...
      memref.store %2#1, %arg3[%arg4] {handshake.name = "store1"} : memref<20xf32>
