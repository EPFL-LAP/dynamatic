module {
  ...
  ^bb4(%7: index, %8: i32, %9: i32, %10: i32, %11: i32, %12: i32, %13: i32):  // 2 preds: ^bb3, ^bb4
    ...
    %17 = memref.load %arg1[%16] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load0"} : memref<400xi32>
    %18 = memref.load %arg0[%1] {handshake.name = "load1"} : memref<20xi32>
    %19 = arith.muli %1, %c20 {handshake.name = "muli2"} : index
    %20 = arith.addi %14, %19 {handshake.name = "addi4"} : index
    %21 = memref.load %arg1[%20] {handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load2"} : memref<400xi32>
    ...
    memref.store %23, %arg1[%25] {handshake.deps = #handshake<deps[["load0", 0], ["load2", 0], ["store0", 0]]>, handshake.name = "store0"} : memref<400xi32>
