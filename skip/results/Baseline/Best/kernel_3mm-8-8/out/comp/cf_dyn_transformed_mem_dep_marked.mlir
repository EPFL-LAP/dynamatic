module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb4
    ...
    memref.store %c0_i32, %arg4[%5] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load6", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store0"} : memref<100xi32>
  ...
  ^bb3(%6: index):  // 2 preds: ^bb2, ^bb3
    ...
    %11 = memref.load %arg0[%10] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load0"} : memref<100xi32>
    ...
    %16 = memref.load %arg1[%15] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load1"} : memref<100xi32>
    ...
    %22 = memref.load %arg4[%21] {handshake.deps = #handshake<deps[["store1", 3], ["store1", 4]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load2"} : memref<100xi32>
    ...
    memref.store %23, %arg4[%27] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load6", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store1"} : memref<100xi32>
  ...
  ^bb7(%35: index):  // 2 preds: ^bb6, ^bb9
    ...
    memref.store %c0_i32_10, %arg5[%39] {handshake.deps = #handshake<deps[["load5", 3], ["store3", 3], ["load7", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store2"} : memref<100xi32>
  ...
  ^bb8(%40: index):  // 2 preds: ^bb7, ^bb8
    ...
    %45 = memref.load %arg2[%44] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load3"} : memref<100xi32>
    ...
    %50 = memref.load %arg3[%49] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load4"} : memref<100xi32>
    ...
    %56 = memref.load %arg5[%55] {handshake.deps = #handshake<deps[["store3", 3], ["store3", 4]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load5"} : memref<100xi32>
    ...
    memref.store %57, %arg5[%61] {handshake.deps = #handshake<deps[["load5", 3], ["store3", 3], ["load7", 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store3"} : memref<100xi32>
  ...
  ^bb12(%69: index):  // 2 preds: ^bb11, ^bb14
    ...
    memref.store %c0_i32_23, %arg6[%73] {handshake.deps = #handshake<deps[["load8", 3], ["store5", 3]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store4"} : memref<100xi32>
  ...
  ^bb13(%74: index):  // 2 preds: ^bb12, ^bb13
    ...
    %79 = memref.load %arg4[%78] {handshake.mem_interface = #handshake.mem_interface<LSQ: 2>, handshake.name = "load6"} : memref<100xi32>
    ...
    %84 = memref.load %arg5[%83] {handshake.mem_interface = #handshake.mem_interface<LSQ: 2>, handshake.name = "load7"} : memref<100xi32>
    ...
    %90 = memref.load %arg6[%89] {handshake.deps = #handshake<deps[["store5", 3], ["store5", 4]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "load8"} : memref<100xi32>
    ...
    memref.store %91, %arg6[%95] {handshake.deps = #handshake<deps[["load8", 3], ["store5", 3]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store5"} : memref<100xi32>
