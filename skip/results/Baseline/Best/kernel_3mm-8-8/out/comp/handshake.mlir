module {
  handshake.func @kernel_3mm(%arg0: memref<100xi32>, %arg1: memref<100xi32>, %arg2: memref<100xi32>, %arg3: memref<100xi32>, %arg4: memref<100xi32>, %arg5: memref<100xi32>, %arg6: memref<100xi32>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, %arg9: !handshake.control<>, %arg10: !handshake.control<>, %arg11: !handshake.control<>, %arg12: !handshake.control<>, %arg13: !handshake.control<>, %arg14: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["A", "B", "C", "D", "E", "F", "G", "A_start", "B_start", "C_start", "D_start", "E_start", "F_start", "G_start", "start"], resNames = ["A_end", "B_end", "C_end", "D_end", "E_end", "F_end", "G_end", "end"]} {
    %0:2 = lsq[%arg6 : memref<100xi32>] (%arg13, %result_82, %addressResult_84, %dataResult_85, %result_86, %addressResult_92, %addressResult_94, %dataResult_95, %result_118)  {groupSizes = [1 : i32, 2 : i32], handshake.name = "lsq0"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>) -> (!handshake.channel<i32>, !handshake.control<>)
    %1:3 = lsq[%arg5 : memref<100xi32>] (%arg12, %result_42, %addressResult_44, %dataResult_45, %result_46, %addressResult_52, %addressResult_54, %dataResult_55, %result_86, %addressResult_90, %result_118)  {groupSizes = [1 : i32, 2 : i32, 1 : i32], handshake.name = "lsq1"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>) -> (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>)
    %2:3 = lsq[%arg4 : memref<100xi32>] (%arg11, %result_6, %addressResult, %dataResult, %result_8, %addressResult_14, %addressResult_16, %dataResult_17, %result_86, %addressResult_88, %result_118)  {groupSizes = [1 : i32, 2 : i32, 1 : i32], handshake.name = "lsq2"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>) -> (!handshake.channel<i32>, !handshake.channel<i32>, !handshake.control<>)
    %outputs, %memEnd = mem_controller[%arg3 : memref<100xi32>] %arg10 (%addressResult_50) %result_118 {connectedBlocks = [8 : i32], handshake.name = "mem_controller0"} :    (!handshake.channel<i32>) -> !handshake.channel<i32>
    %outputs_0, %memEnd_1 = mem_controller[%arg2 : memref<100xi32>] %arg9 (%addressResult_48) %result_118 {connectedBlocks = [8 : i32], handshake.name = "mem_controller1"} :    (!handshake.channel<i32>) -> !handshake.channel<i32>
    %outputs_2, %memEnd_3 = mem_controller[%arg1 : memref<100xi32>] %arg8 (%addressResult_12) %result_118 {connectedBlocks = [3 : i32], handshake.name = "mem_controller2"} :    (!handshake.channel<i32>) -> !handshake.channel<i32>
    %outputs_4, %memEnd_5 = mem_controller[%arg0 : memref<100xi32>] %arg7 (%addressResult_10) %result_118 {connectedBlocks = [3 : i32], handshake.name = "mem_controller3"} :    (!handshake.channel<i32>) -> !handshake.channel<i32>
    ...
    %6 = mux %index [%4, %trueResult_34] {handshake.bb = 1 : ui32, handshake.name = "mux0"} : <i1>, [<i32>, <i32>] to <i32>
    %result, %index = control_merge [%5, %trueResult_36]  {handshake.bb = 1 : ui32, handshake.name = "control_merge0"} : [<>, <>] to <>, <i1>
    ...
    %11 = mux %index_7 [%8, %trueResult_26] {handshake.bb = 2 : ui32, handshake.name = "mux1"} : <i1>, [<i32>, <i32>] to <i32>
    %12 = mux %index_7 [%9, %trueResult_28] {handshake.bb = 2 : ui32, handshake.name = "mux2"} : <i1>, [<i32>, <i32>] to <i32>
    %result_6, %index_7 = control_merge [%10, %trueResult_30]  {handshake.bb = 2 : ui32, handshake.name = "control_merge1"} : [<>, <>] to <>, <i1>
    ...
    %addressResult, %dataResult = store[%22] %13 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load6", 1]]>, handshake.name = "store0"} : <i32>, <i32>, <i32>, <i32>
    ...
    %28 = mux %index_9 [%24, %trueResult_18] {handshake.bb = 3 : ui32, handshake.name = "mux4"} : <i1>, [<i32>, <i32>] to <i32>
    %29 = mux %index_9 [%25, %trueResult_20] {handshake.bb = 3 : ui32, handshake.name = "mux5"} : <i1>, [<i32>, <i32>] to <i32>
    %result_8, %index_9 = control_merge [%26, %trueResult_22]  {handshake.bb = 3 : ui32, handshake.name = "control_merge2"} : [<>, <>] to <>, <i1>
    ...
    %addressResult_14, %dataResult_15 = load[%48] %2#0 {handshake.bb = 3 : ui32, handshake.deps = #handshake<deps[["store1", 3], ["store1", 4]]>, handshake.name = "load2"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_16, %dataResult_17 = store[%53] %49 {handshake.bb = 3 : ui32, handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load6", 1]]>, handshake.name = "store1"} : <i32>, <i32>, <i32>, <i32>
    ...
    %trueResult_18, %falseResult_19 = cond_br %55, %28 {handshake.bb = 3 : ui32, handshake.name = "cond_br10"} : <i1>, <i32>
    %trueResult_20, %falseResult_21 = cond_br %55, %29 {handshake.bb = 3 : ui32, handshake.name = "cond_br11"} : <i1>, <i32>
    %trueResult_22, %falseResult_23 = cond_br %55, %result_8 {handshake.bb = 3 : ui32, handshake.name = "cond_br12"} : <i1>, <>
    %56 = merge %falseResult_19 {handshake.bb = 4 : ui32, handshake.name = "merge0"} : <i32>
    %57 = merge %falseResult_21 {handshake.bb = 4 : ui32, handshake.name = "merge1"} : <i32>
    ...
    %trueResult_26, %falseResult_27 = cond_br %63, %62 {handshake.bb = 4 : ui32, handshake.name = "cond_br13"} : <i1>, <i32>
    %trueResult_28, %falseResult_29 = cond_br %63, %56 {handshake.bb = 4 : ui32, handshake.name = "cond_br14"} : <i1>, <i32>
    %trueResult_30, %falseResult_31 = cond_br %63, %result_24 {handshake.bb = 4 : ui32, handshake.name = "cond_br15"} : <i1>, <>
    %64 = merge %falseResult_29 {handshake.bb = 5 : ui32, handshake.name = "merge2"} : <i32>
    %result_32, %index_33 = control_merge [%falseResult_31]  {handshake.bb = 5 : ui32, handshake.name = "control_merge4"} : [<>] to <>, <i1>
    %65 = constant %result_32 {handshake.bb = 5 : ui32, handshake.name = "constant15", value = 0 : i32} : <>, <i32>
    ...
    %trueResult_34, %falseResult_35 = cond_br %71, %70 {handshake.bb = 5 : ui32, handshake.name = "cond_br16"} : <i1>, <i32>
    %trueResult_36, %falseResult_37 = cond_br %71, %result_32 {handshake.bb = 5 : ui32, handshake.name = "cond_br17"} : <i1>, <>
    %trueResult_38, %falseResult_39 = cond_br %71, %65 {handshake.bb = 5 : ui32, handshake.name = "cond_br18"} : <i1>, <i32>
    %72 = mux %index_41 [%falseResult_39, %trueResult_74] {handshake.bb = 6 : ui32, handshake.name = "mux6"} : <i1>, [<i32>, <i32>] to <i32>
    %result_40, %index_41 = control_merge [%falseResult_37, %trueResult_76]  {handshake.bb = 6 : ui32, handshake.name = "control_merge5"} : [<>, <>] to <>, <i1>
    %73 = constant %result_40 {handshake.bb = 6 : ui32, handshake.name = "constant18", value = 0 : i32} : <>, <i32>
    %74 = br %73 {handshake.bb = 6 : ui32, handshake.name = "br16"} : <i32>
    %75 = br %72 {handshake.bb = 6 : ui32, handshake.name = "br17"} : <i32>
    %76 = br %result_40 {handshake.bb = 6 : ui32, handshake.name = "br18"} : <>
    %77 = mux %index_43 [%74, %trueResult_66] {handshake.bb = 7 : ui32, handshake.name = "mux7"} : <i1>, [<i32>, <i32>] to <i32>
    %78 = mux %index_43 [%75, %trueResult_68] {handshake.bb = 7 : ui32, handshake.name = "mux8"} : <i1>, [<i32>, <i32>] to <i32>
    %result_42, %index_43 = control_merge [%76, %trueResult_70]  {handshake.bb = 7 : ui32, handshake.name = "control_merge6"} : [<>, <>] to <>, <i1>
    %79 = constant %result_42 {handshake.bb = 7 : ui32, handshake.name = "constant19", value = 0 : i32} : <>, <i32>
    %80 = constant %result_42 {handshake.bb = 7 : ui32, handshake.name = "constant20", value = 0 : i32} : <>, <i32>
    ...
    %addressResult_44, %dataResult_45 = store[%88] %79 {handshake.bb = 7 : ui32, handshake.deps = #handshake<deps[["load5", 3], ["store3", 3], ["load7", 1]]>, handshake.name = "store2"} : <i32>, <i32>, <i32>, <i32>
    ...
    %92 = br %result_42 {handshake.bb = 7 : ui32, handshake.name = "br22"} : <>
    %93 = mux %index_47 [%89, %trueResult_56] {handshake.bb = 8 : ui32, handshake.name = "mux9"} : <i1>, [<i32>, <i32>] to <i32>
    %94 = mux %index_47 [%90, %trueResult_58] {handshake.bb = 8 : ui32, handshake.name = "mux10"} : <i1>, [<i32>, <i32>] to <i32>
    %95 = mux %index_47 [%91, %trueResult_60] {handshake.bb = 8 : ui32, handshake.name = "mux11"} : <i1>, [<i32>, <i32>] to <i32>
    %result_46, %index_47 = control_merge [%92, %trueResult_62]  {handshake.bb = 8 : ui32, handshake.name = "control_merge7"} : [<>, <>] to <>, <i1>
    ...
    %addressResult_48, %dataResult_49 = load[%105] %outputs_0 {handshake.bb = 8 : ui32, handshake.name = "load3"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_50, %dataResult_51 = load[%109] %outputs {handshake.bb = 8 : ui32, handshake.name = "load4"} : <i32>, <i32>, <i32>, <i32>
    %110 = muli %dataResult_49, %dataResult_51 {handshake.bb = 8 : ui32, handshake.name = "muli1"} : <i32>
    ...
    %addressResult_52, %dataResult_53 = load[%114] %1#0 {handshake.bb = 8 : ui32, handshake.deps = #handshake<deps[["store3", 3], ["store3", 4]]>, handshake.name = "load5"} : <i32>, <i32>, <i32>, <i32>
    %115 = addi %dataResult_53, %110 {handshake.bb = 8 : ui32, handshake.name = "addi1"} : <i32>
    ...
    %addressResult_54, %dataResult_55 = store[%119] %115 {handshake.bb = 8 : ui32, handshake.deps = #handshake<deps[["load5", 3], ["store3", 3], ["load7", 1]]>, handshake.name = "store3"} : <i32>, <i32>, <i32>, <i32>
    ...
    %trueResult_56, %falseResult_57 = cond_br %121, %120 {handshake.bb = 8 : ui32, handshake.name = "cond_br19"} : <i1>, <i32>
    %trueResult_58, %falseResult_59 = cond_br %121, %94 {handshake.bb = 8 : ui32, handshake.name = "cond_br20"} : <i1>, <i32>
    %trueResult_60, %falseResult_61 = cond_br %121, %95 {handshake.bb = 8 : ui32, handshake.name = "cond_br21"} : <i1>, <i32>
    %trueResult_62, %falseResult_63 = cond_br %121, %result_46 {handshake.bb = 8 : ui32, handshake.name = "cond_br22"} : <i1>, <>
    %122 = merge %falseResult_59 {handshake.bb = 9 : ui32, handshake.name = "merge3"} : <i32>
    %123 = merge %falseResult_61 {handshake.bb = 9 : ui32, handshake.name = "merge4"} : <i32>
    ...
    %trueResult_66, %falseResult_67 = cond_br %129, %128 {handshake.bb = 9 : ui32, handshake.name = "cond_br23"} : <i1>, <i32>
    %trueResult_68, %falseResult_69 = cond_br %129, %122 {handshake.bb = 9 : ui32, handshake.name = "cond_br24"} : <i1>, <i32>
    %trueResult_70, %falseResult_71 = cond_br %129, %result_64 {handshake.bb = 9 : ui32, handshake.name = "cond_br25"} : <i1>, <>
    %130 = merge %falseResult_69 {handshake.bb = 10 : ui32, handshake.name = "merge5"} : <i32>
    %result_72, %index_73 = control_merge [%falseResult_71]  {handshake.bb = 10 : ui32, handshake.name = "control_merge9"} : [<>] to <>, <i1>
    %131 = constant %result_72 {handshake.bb = 10 : ui32, handshake.name = "constant28", value = 0 : i32} : <>, <i32>
    ...
    %trueResult_74, %falseResult_75 = cond_br %137, %136 {handshake.bb = 10 : ui32, handshake.name = "cond_br26"} : <i1>, <i32>
    %trueResult_76, %falseResult_77 = cond_br %137, %result_72 {handshake.bb = 10 : ui32, handshake.name = "cond_br27"} : <i1>, <>
    %trueResult_78, %falseResult_79 = cond_br %137, %131 {handshake.bb = 10 : ui32, handshake.name = "cond_br28"} : <i1>, <i32>
    %138 = mux %index_81 [%falseResult_79, %trueResult_114] {handshake.bb = 11 : ui32, handshake.name = "mux12"} : <i1>, [<i32>, <i32>] to <i32>
    %result_80, %index_81 = control_merge [%falseResult_77, %trueResult_116]  {handshake.bb = 11 : ui32, handshake.name = "control_merge10"} : [<>, <>] to <>, <i1>
    %139 = constant %result_80 {handshake.bb = 11 : ui32, handshake.name = "constant31", value = 0 : i32} : <>, <i32>
    %140 = br %139 {handshake.bb = 11 : ui32, handshake.name = "br23"} : <i32>
    %141 = br %138 {handshake.bb = 11 : ui32, handshake.name = "br24"} : <i32>
    %142 = br %result_80 {handshake.bb = 11 : ui32, handshake.name = "br25"} : <>
    %143 = mux %index_83 [%140, %trueResult_106] {handshake.bb = 12 : ui32, handshake.name = "mux13"} : <i1>, [<i32>, <i32>] to <i32>
    %144 = mux %index_83 [%141, %trueResult_108] {handshake.bb = 12 : ui32, handshake.name = "mux14"} : <i1>, [<i32>, <i32>] to <i32>
    %result_82, %index_83 = control_merge [%142, %trueResult_110]  {handshake.bb = 12 : ui32, handshake.name = "control_merge11"} : [<>, <>] to <>, <i1>
    %145 = constant %result_82 {handshake.bb = 12 : ui32, handshake.name = "constant32", value = 0 : i32} : <>, <i32>
    %146 = constant %result_82 {handshake.bb = 12 : ui32, handshake.name = "constant33", value = 0 : i32} : <>, <i32>
    ...
    %addressResult_84, %dataResult_85 = store[%154] %145 {handshake.bb = 12 : ui32, handshake.deps = #handshake<deps[["load8", 3], ["store5", 3]]>, handshake.name = "store4"} : <i32>, <i32>, <i32>, <i32>
    ...
    %158 = br %result_82 {handshake.bb = 12 : ui32, handshake.name = "br29"} : <>
    %159 = mux %index_87 [%155, %trueResult_96] {handshake.bb = 13 : ui32, handshake.name = "mux15"} : <i1>, [<i32>, <i32>] to <i32>
    %160 = mux %index_87 [%156, %trueResult_98] {handshake.bb = 13 : ui32, handshake.name = "mux16"} : <i1>, [<i32>, <i32>] to <i32>
    %161 = mux %index_87 [%157, %trueResult_100] {handshake.bb = 13 : ui32, handshake.name = "mux17"} : <i1>, [<i32>, <i32>] to <i32>
    %result_86, %index_87 = control_merge [%158, %trueResult_102]  {handshake.bb = 13 : ui32, handshake.name = "control_merge12"} : [<>, <>] to <>, <i1>
    ...
    %addressResult_88, %dataResult_89 = load[%171] %2#1 {handshake.bb = 13 : ui32, handshake.name = "load6"} : <i32>, <i32>, <i32>, <i32>
    ...
    %addressResult_90, %dataResult_91 = load[%175] %1#1 {handshake.bb = 13 : ui32, handshake.name = "load7"} : <i32>, <i32>, <i32>, <i32>
    %176 = muli %dataResult_89, %dataResult_91 {handshake.bb = 13 : ui32, handshake.name = "muli2"} : <i32>
    ...
    %addressResult_92, %dataResult_93 = load[%180] %0#0 {handshake.bb = 13 : ui32, handshake.deps = #handshake<deps[["store5", 3], ["store5", 4]]>, handshake.name = "load8"} : <i32>, <i32>, <i32>, <i32>
    %181 = addi %dataResult_93, %176 {handshake.bb = 13 : ui32, handshake.name = "addi2"} : <i32>
    ...
    %addressResult_94, %dataResult_95 = store[%185] %181 {handshake.bb = 13 : ui32, handshake.deps = #handshake<deps[["load8", 3], ["store5", 3]]>, handshake.name = "store5"} : <i32>, <i32>, <i32>, <i32>
    ...
    %trueResult_96, %falseResult_97 = cond_br %187, %186 {handshake.bb = 13 : ui32, handshake.name = "cond_br29"} : <i1>, <i32>
    %trueResult_98, %falseResult_99 = cond_br %187, %160 {handshake.bb = 13 : ui32, handshake.name = "cond_br30"} : <i1>, <i32>
    %trueResult_100, %falseResult_101 = cond_br %187, %161 {handshake.bb = 13 : ui32, handshake.name = "cond_br31"} : <i1>, <i32>
    %trueResult_102, %falseResult_103 = cond_br %187, %result_86 {handshake.bb = 13 : ui32, handshake.name = "cond_br32"} : <i1>, <>
    %188 = merge %falseResult_99 {handshake.bb = 14 : ui32, handshake.name = "merge6"} : <i32>
    %189 = merge %falseResult_101 {handshake.bb = 14 : ui32, handshake.name = "merge7"} : <i32>
    ...
    %trueResult_106, %falseResult_107 = cond_br %195, %194 {handshake.bb = 14 : ui32, handshake.name = "cond_br33"} : <i1>, <i32>
    %trueResult_108, %falseResult_109 = cond_br %195, %188 {handshake.bb = 14 : ui32, handshake.name = "cond_br34"} : <i1>, <i32>
    %trueResult_110, %falseResult_111 = cond_br %195, %result_104 {handshake.bb = 14 : ui32, handshake.name = "cond_br35"} : <i1>, <>
    %196 = merge %falseResult_109 {handshake.bb = 15 : ui32, handshake.name = "merge8"} : <i32>
    ...
    %trueResult_114, %falseResult_115 = cond_br %202, %201 {handshake.bb = 15 : ui32, handshake.name = "cond_br36"} : <i1>, <i32>
    %trueResult_116, %falseResult_117 = cond_br %202, %result_112 {handshake.bb = 15 : ui32, handshake.name = "cond_br37"} : <i1>, <>
