  ...
  func.func @kernel_3mm(%arg0: memref<100xi32> {handshake.arg_name = "A"}, %arg1: memref<100xi32> {handshake.arg_name = "B"}, %arg2: memref<100xi32> {handshake.arg_name = "C"}, %arg3: memref<100xi32> {handshake.arg_name = "D"}, %arg4: memref<100xi32> {handshake.arg_name = "E"}, %arg5: memref<100xi32> {handshake.arg_name = "F"}, %arg6: memref<100xi32> {handshake.arg_name = "G"}) {
    ...
    %0 = scf.while (%arg7 = %c0) : (index) -> index {
      %3 = scf.while (%arg8 = %c0) : (index) -> index {
        ...
        memref.store %c0_i32, %arg4[%7] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load6", 1]]>, handshake.name = "store0"} : memref<100xi32>
        %8 = scf.while (%arg9 = %c0) : (index) -> index {
          ...
          %13 = memref.load %arg0[%12] {handshake.name = "load0"} : memref<100xi32>
          ...
          %20 = memref.load %arg4[%19] {handshake.deps = #handshake<deps[["store1", 3], ["store1", 4]]>, handshake.name = "load2"} : memref<100xi32>
          ...
          memref.store %21, %arg4[%23] {handshake.deps = #handshake<deps[["load2", 3], ["store1", 3], ["load6", 1]]>, handshake.name = "store1"} : memref<100xi32>
    ...
    %1 = scf.while (%arg7 = %c0) : (index) -> index {
      %3 = scf.while (%arg8 = %c0) : (index) -> index {
        ...
        memref.store %c0_i32, %arg5[%7] {handshake.deps = #handshake<deps[["load5", 3], ["store3", 3], ["load7", 1]]>, handshake.name = "store2"} : memref<100xi32>
        %8 = scf.while (%arg9 = %c0) : (index) -> index {
          %11 = arith.muli %arg7, %c10 {handshake.name = "muli9"} : index
          %12 = arith.addi %arg9, %11 {handshake.name = "addi9"} : index
          %13 = memref.load %arg2[%12] {handshake.name = "load3"} : memref<100xi32>
          %14 = arith.muli %arg9, %c10 {handshake.name = "muli10"} : index
          %15 = arith.addi %arg8, %14 {handshake.name = "addi10"} : index
          %16 = memref.load %arg3[%15] {handshake.name = "load4"} : memref<100xi32>
          ...
          %20 = memref.load %arg5[%19] {handshake.deps = #handshake<deps[["store3", 3], ["store3", 4]]>, handshake.name = "load5"} : memref<100xi32>
          ...
          memref.store %21, %arg5[%23] {handshake.deps = #handshake<deps[["load5", 3], ["store3", 3], ["load7", 1]]>, handshake.name = "store3"} : memref<100xi32>
    ...
    %2 = scf.while (%arg7 = %c0) : (index) -> index {
      %3 = scf.while (%arg8 = %c0) : (index) -> index {
        ...
        memref.store %c0_i32, %arg6[%7] {handshake.deps = #handshake<deps[["load8", 3], ["store5", 3]]>, handshake.name = "store4"} : memref<100xi32>
        %8 = scf.while (%arg9 = %c0) : (index) -> index {
          %11 = arith.muli %arg7, %c10 {handshake.name = "muli14"} : index
          %12 = arith.addi %arg9, %11 {handshake.name = "addi14"} : index
          %13 = memref.load %arg4[%12] {handshake.name = "load6"} : memref<100xi32>
          %14 = arith.muli %arg9, %c10 {handshake.name = "muli15"} : index
          %15 = arith.addi %arg8, %14 {handshake.name = "addi15"} : index
          %16 = memref.load %arg5[%15] {handshake.name = "load7"} : memref<100xi32>
          ...
          %20 = memref.load %arg6[%19] {handshake.deps = #handshake<deps[["store5", 3], ["store5", 4]]>, handshake.name = "load8"} : memref<100xi32>
          ...
          memref.store %21, %arg6[%23] {handshake.deps = #handshake<deps[["load8", 3], ["store5", 3]]>, handshake.name = "store5"} : memref<100xi32>
