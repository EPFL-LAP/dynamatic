module {
  func.func @mvt_float(%arg0: memref<900xf32> {handshake.arg_name = "A"}, %arg1: memref<30xf32> {handshake.arg_name = "x1"}, %arg2: memref<30xf32> {handshake.arg_name = "x2"}, %arg3: memref<30xf32> {handshake.arg_name = "y1"}, %arg4: memref<30xf32> {handshake.arg_name = "y2"}) {
    ...
    %0 = scf.while (%arg5 = %c0) : (index) -> index {
      %2 = memref.load %arg1[%arg5] {handshake.deps = #handshake<deps[["store0", 2]]>, handshake.name = "load0"} : memref<30xf32>
      %3:2 = scf.while (%arg6 = %c0, %arg7 = %2) : (index, f32) -> (index, f32) {
        ...
        %8 = memref.load %arg0[%7] {handshake.name = "load1"} : memref<900xf32>
        %9 = memref.load %arg3[%arg6] {handshake.name = "load2"} : memref<30xf32>
      ...
      memref.store %3#1, %arg1[%arg5] {handshake.name = "store0"} : memref<30xf32>
    ...
    %1 = scf.while (%arg5 = %c0) : (index) -> index {
      %2 = memref.load %arg2[%arg5] {handshake.deps = #handshake<deps[["store1", 2]]>, handshake.name = "load3"} : memref<30xf32>
      %3:2 = scf.while (%arg6 = %c0, %arg7 = %2) : (index, f32) -> (index, f32) {
        %6 = arith.muli %arg6, %c30 {handshake.name = "muli1"} : index
        %7 = arith.addi %arg5, %6 {handshake.name = "addi1"} : index
        %8 = memref.load %arg0[%7] {handshake.name = "load4"} : memref<900xf32>
        %9 = memref.load %arg4[%arg6] {handshake.name = "load5"} : memref<30xf32>
      ...
      memref.store %3#1, %arg2[%arg5] {handshake.name = "store1"} : memref<30xf32>
