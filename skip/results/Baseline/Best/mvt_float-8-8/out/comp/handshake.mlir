module {
  handshake.func @mvt_float(%arg0: memref<900xf32>, %arg1: memref<30xf32>, %arg2: memref<30xf32>, %arg3: memref<30xf32>, %arg4: memref<30xf32>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, %arg7: !handshake.control<>, %arg8: !handshake.control<>, %arg9: !handshake.control<>, %arg10: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["A", "x1", "x2", "y1", "y2", "A_start", "x1_start", "x2_start", "y1_start", "y2_start", "start"], resNames = ["A_end", "x1_end", "x2_end", "y1_end", "y2_end", "end"]} {
    %outputs, %memEnd = mem_controller[%arg4 : memref<30xf32>] %arg9 (%addressResult_34) %result_52 {connectedBlocks = [5 : i32], handshake.name = "mem_controller0"} :    (!handshake.channel<i32>) -> !handshake.channel<f32>
    %outputs_0, %memEnd_1 = mem_controller[%arg3 : memref<30xf32>] %arg8 (%addressResult_8) %result_52 {connectedBlocks = [2 : i32], handshake.name = "mem_controller1"} :    (!handshake.channel<i32>) -> !handshake.channel<f32>
    %0:2 = lsq[%arg2 : memref<30xf32>] (%arg7, %result_26, %addressResult_28, %result_44, %addressResult_46, %dataResult_47, %result_52)  {groupSizes = [1 : i32, 1 : i32], handshake.name = "lsq0"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<f32>, !handshake.control<>) -> (!handshake.channel<f32>, !handshake.control<>)
    %1:2 = lsq[%arg1 : memref<30xf32>] (%arg6, %result, %addressResult, %result_16, %addressResult_18, %dataResult_19, %result_52)  {groupSizes = [1 : i32, 1 : i32], handshake.name = "lsq1"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<f32>, !handshake.control<>) -> (!handshake.channel<f32>, !handshake.control<>)
    %outputs_2:2, %memEnd_3 = mem_controller[%arg0 : memref<900xf32>] %arg5 (%addressResult_6, %addressResult_32) %result_52 {connectedBlocks = [2 : i32, 5 : i32], handshake.name = "mem_controller2"} :    (!handshake.channel<i32>, !handshake.channel<i32>) -> (!handshake.channel<f32>, !handshake.channel<f32>)
    ...
    %addressResult, %dataResult = load[%5] %1#0 {handshake.bb = 1 : ui32, handshake.deps = #handshake<deps[["store0", 2]]>, handshake.name = "load0"} : <i32>, <f32>, <i32>, <f32>
    ...
    %addressResult_18, %dataResult_19 = store[%24] %25 {handshake.bb = 3 : ui32, handshake.name = "store0"} : <i32>, <f32>, <i32>, <f32>
    ...
    %33 = mux %index_27 [%falseResult_25, %trueResult_48] {handshake.bb = 4 : ui32, handshake.name = "mux4"} : <i1>, [<i32>, <i32>] to <i32>
    ...
    %addressResult_28, %dataResult_29 = load[%33] %0#0 {handshake.bb = 4 : ui32, handshake.deps = #handshake<deps[["store1", 2]]>, handshake.name = "load3"} : <i32>, <f32>, <i32>, <f32>
    ...
    %addressResult_46, %dataResult_47 = store[%52] %53 {handshake.bb = 6 : ui32, handshake.name = "store1"} : <i32>, <f32>, <i32>, <f32>
    %58 = addi %52, %57 {handshake.bb = 6 : ui32, handshake.name = "addi5"} : <i32>
    %59 = cmpi ult, %58, %55 {handshake.bb = 6 : ui32, handshake.name = "cmpi3"} : <i32>
    %trueResult_48, %falseResult_49 = cond_br %59, %58 {handshake.bb = 6 : ui32, handshake.name = "cond_br15"} : <i1>, <i32>
    %trueResult_50, %falseResult_51 = cond_br %59, %result_44 {handshake.bb = 6 : ui32, handshake.name = "cond_br16"} : <i1>, <>
    %result_52, %index_53 = control_merge [%falseResult_51]  {handshake.bb = 7 : ui32, handshake.name = "control_merge6"} : [<>] to <>, <i1>
    end {handshake.bb = 7 : ui32, handshake.name = "end0"} %memEnd_3, %1#1, %0#1, %memEnd_1, %memEnd, %arg10 : <>, <>, <>, <>, <>, <>
  }
}
