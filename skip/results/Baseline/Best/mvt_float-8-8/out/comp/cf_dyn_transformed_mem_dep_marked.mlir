module {
  ...
  ^bb1(%0: index):  // 2 preds: ^bb0, ^bb3
    ...
    %1 = memref.load %arg1[%0] {handshake.deps = #handshake<deps[["store0", 2]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load0"} : memref<30xf32>
  ...
  ^bb2(%2: index, %3: f32):  // 2 preds: ^bb1, ^bb2
    ...
    %6 = memref.load %arg0[%5] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load1"} : memref<900xf32>
    %7 = memref.load %arg3[%2] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load2"} : memref<30xf32>
  ...
  ^bb3:  // pred: ^bb2
    ...
    memref.store %9, %arg1[%0] {handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store0"} : memref<30xf32>
  ...
  ^bb4(%14: index):  // 2 preds: ^bb3, ^bb6
    ...
    %15 = memref.load %arg2[%14] {handshake.deps = #handshake<deps[["store1", 2]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load3"} : memref<30xf32>
  ...
  ^bb5(%16: index, %17: f32):  // 2 preds: ^bb4, ^bb5
    ...
    %20 = memref.load %arg0[%19] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load4"} : memref<900xf32>
    %21 = memref.load %arg4[%16] {handshake.mem_interface = #handshake.mem_interface<MC>, handshake.name = "load5"} : memref<30xf32>
  ...
  ^bb6:  // pred: ^bb5
    ...
    memref.store %23, %arg2[%14] {handshake.mem_interface = #handshake.mem_interface<LSQ: 1>, handshake.name = "store1"} : memref<30xf32>
