module {
  ...
  ^bb1(%0: index):  // 2 preds: ^bb0, ^bb3
    %1 = memref.load %arg2[%0] {handshake.deps = #handshake<deps[["store1", 2]]>, handshake.name = "load0"} : memref<30xi32>
  ...
  ^bb2(%2: index, %3: i32):  // 2 preds: ^bb1, ^bb2
    ...
    %6 = memref.load %arg0[%5] {handshake.name = "load1"} : memref<900xi32>
    %7 = memref.load %arg1[%2] {handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load2"} : memref<30xi32>
    %8 = memref.load %arg4[%0] {handshake.name = "load3"} : memref<30xi32>
    %9 = arith.muli %8, %6 {handshake.name = "muli0"} : i32
    %10 = arith.addi %7, %9 {handshake.name = "addi0"} : i32
    memref.store %10, %arg1[%2] {handshake.deps = #handshake<deps[["load2", 1], ["store0", 1]]>, handshake.name = "store0"} : memref<30xi32>
    %11 = memref.load %arg3[%2] {handshake.name = "load4"} : memref<30xi32>
  ...
  ^bb3:  // pred: ^bb2
    memref.store %13, %arg2[%0] {handshake.name = "store1"} : memref<30xi32>
