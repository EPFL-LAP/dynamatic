module {
  func.func @bicg(%arg0: memref<900xi32> {handshake.arg_name = "a"}, %arg1: memref<30xi32> {handshake.arg_name = "s"}, %arg2: memref<30xi32> {handshake.arg_name = "q"}, %arg3: memref<30xi32> {handshake.arg_name = "p"}, %arg4: memref<30xi32> {handshake.arg_name = "r"}) -> i32 {
    ...
    %0:2 = scf.while (%arg5 = %c0, %arg6 = %c0_i32) : (index, i32) -> (index, i32) {
      %1 = memref.load %arg2[%arg5] {handshake.deps = #handshake<deps[["store1", 2]]>, handshake.name = "load0"} : memref<30xi32>
      %2:2 = scf.while (%arg7 = %c0, %arg8 = %1) : (index, i32) -> (index, i32) {
        ...
        %7 = memref.load %arg0[%6] {handshake.name = "load1"} : memref<900xi32>
        %8 = memref.load %arg1[%arg7] {handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load2"} : memref<30xi32>
        %9 = memref.load %arg4[%arg5] {handshake.name = "load3"} : memref<30xi32>
        %10 = arith.muli %9, %7 {handshake.name = "muli0"} : i32
        %11 = arith.addi %8, %10 {handshake.name = "addi0"} : i32
        memref.store %11, %arg1[%arg7] {handshake.deps = #handshake<deps[["load2", 1], ["store0", 1]]>, handshake.name = "store0"} : memref<30xi32>
        %12 = memref.load %arg3[%arg7] {handshake.name = "load4"} : memref<30xi32>
      ...
      memref.store %2#1, %arg2[%arg5] {handshake.name = "store1"} : memref<30xi32>
