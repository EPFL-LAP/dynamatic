module {
  ...
  ^bb1(%0: index, %1: i32):  // 2 preds: ^bb0, ^bb3
    %2 = memref.load %arg2[%0] {handshake.deps = #handshake<deps[["store1", 2]]>, handshake.name = "load0"} : memref<30xi32>
  ...
  ^bb2(%3: index, %4: i32):  // 2 preds: ^bb1, ^bb2
    ...
    %8 = memref.load %arg1[%3] {handshake.deps = #handshake<deps[["store0", 1], ["store0", 3]]>, handshake.name = "load2"} : memref<30xi32>
    %9 = memref.load %arg4[%0] {handshake.name = "load3"} : memref<30xi32>
    %10 = arith.muli %9, %7 {handshake.name = "muli0"} : i32
    %11 = arith.addi %8, %10 {handshake.name = "addi0"} : i32
    memref.store %11, %arg1[%3] {handshake.deps = #handshake<deps[["load2", 1], ["store0", 1]]>, handshake.name = "store0"} : memref<30xi32>
    %12 = memref.load %arg3[%3] {handshake.name = "load4"} : memref<30xi32>
  ...
  ^bb3:  // pred: ^bb2
    memref.store %14, %arg2[%0] {handshake.name = "store1"} : memref<30xi32>
