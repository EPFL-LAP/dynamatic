module {
  handshake.func @histogram(%arg0: memref<1000xi32>, %arg1: memref<1000xf32>, %arg2: memref<1000xf32>, %arg3: !handshake.channel<i32>, %arg4: !handshake.control<>, %arg5: !handshake.control<>, %arg6: !handshake.control<>, %arg7: !handshake.control<>, ...) -> (!handshake.control<>, !handshake.control<>, !handshake.control<>, !handshake.control<>) attributes {argNames = ["feature", "weight", "hist", "n", "feature_start", "weight_start", "hist_start", "start"], resNames = ["feature_end", "weight_end", "hist_end", "end"]} {
    %0:2 = lsq[%arg2 : memref<1000xf32>] (%arg6, %result_6, %addressResult_10, %addressResult_12, %dataResult_13, %result_14)  {groupSizes = [2 : i32], handshake.name = "lsq0"} : (!handshake.control<>, !handshake.control<>, !handshake.channel<i32>, !handshake.channel<i32>, !handshake.channel<f32>, !handshake.control<>) -> (!handshake.channel<f32>, !handshake.control<>)
    ...
    %addressResult_10, %dataResult_11 = load[%13] %0#0 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["store0", 0]]>, handshake.name = "load2"} : <i32>, <f32>, <i32>, <f32>
    %14 = addf %dataResult_11, %dataResult_9 {fastmath = #arith.fastmath<none>, handshake.bb = 2 : ui32, handshake.name = "addf0"} : <f32>
    %addressResult_12, %dataResult_13 = store[%13] %14 {handshake.bb = 2 : ui32, handshake.deps = #handshake<deps[["load2", 0], ["store0", 0]]>, handshake.name = "store0"} : <i32>, <f32>, <i32>, <f32>
    ...
    end {handshake.bb = 3 : ui32, handshake.name = "end0"} %memEnd_1, %memEnd, %0#1, %arg7 : <>, <>, <>, <>
  }
}
